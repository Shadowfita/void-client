...
final class Class239_Sub16 extends Class239 {
    ...
    static final void method1792(int i, int i_12_, int i_13_, int i_14_, byte i_15_, int i_16_) {
        anInt6013++;
        int i_17_ = Class85.method831(Class38.anInt513, i, Class132.anInt1910, -90);
        int i_18_ = Class85.method831(Class38.anInt513, i_13_, Class132.anInt1910, -94);
        int i_19_ = Class85.method831(Class113.anInt1745, i_12_, Class369.anInt4960, 77);
