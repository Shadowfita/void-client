...
final class Js5Archive {
    ...
    private final boolean method394(int i, byte i_8_, int[] is, int i_9_) {
        ...
        if (is == null || (is[0] == 0 && is[1] == 0 && is[2] == 0 && is[3] == 0)) is_14_ = Class50_Sub1.method461(false, anObjectArray656[i_9_], 53146732);
            ...
            Packet.method3367(607818341, is, 5, (Packet.data).length);
        }
        byte[] is_15_;
        try {
    ...
    Js5Archive(Class314 class314, boolean bool, int i) {
        if (i < 0 || i > 2) throw new IllegalArgumentException("js5: Invalid cost " + i + " supplied for discardunpacked");
