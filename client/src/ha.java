...
abstract class ha {
    ...
    static final synchronized ha method3692(int i, int i_168_, int i_169_, Js5Archive Js5Archive, int i_170_, d var_d, Canvas canvas, int i_171_) {
        try {
            ...
            if (i_171_ == 5) return Class93.method862(canvas, var_d, Js5Archive, 25542, i);
            if (i_171_ == 3) return Class96.method870(i, i_170_ ^ 0x4a31, var_d, Js5Archive, canvas);
            throw new IllegalArgumentException("UM");
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("ha.TJ(" + i + ',' + i_168_ + ',' + i_169_ + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + i_170_ + ',' + (var_d != null ? "{...}" : "null") + ',' + (canvas != null ? "{...}" : "null") + ',' + i_171_ + ')'));
        }
    }
