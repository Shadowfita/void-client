...
final class Class112 implements Runnable {
    ...
    final Class348_Sub42_Sub16_Sub2 method1049(byte[] is, Class137 class137, byte i, int i_0_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("aca.G(" + (is != null ? "{...}" : "null") + ',' + (class137 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ')'));
        }
    }
    ...
    final Class348_Sub42_Sub16_Sub2 method1054(Class137 class137, int i, byte i_19_) {
        anInt1729++;
        Class348_Sub42_Sub16_Sub2 class348_sub42_sub16_sub2 = new Class348_Sub42_Sub16_Sub2();
    ...
    final Class348_Sub42_Sub16_Sub2 method1055(Class137 class137, int i, byte i_20_) {
