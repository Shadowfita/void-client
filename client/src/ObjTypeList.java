/* ObjTypeList - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class ObjTypeList {
    static Class114 aClass114_3265;
    static int anInt3266;
    private final Js5Archive aClass45_3267;
    Js5Archive aClass45_3268;
    ...
    private final ReferenceCache aClass60_3278 = new ReferenceCache(64);
    ...
    int anInt3286;
    ReferenceCache aClass60_3287 = new ReferenceCache(50);
    ...
    static final Class74[] method1929(byte i) {
        ...
        anInt3280++;
        return (new Class74[]{Class348_Sub42_Sub8_Sub2.aClass74_10437, Class348_Sub26.aClass74_6891, Class265.aClass74_4689, Class374.aClass74_4537, Class327.aClass74_4098, Class162.aClass74_2157, Class59_Sub1_Sub2.aClass74_8662, Class39.aClass74_515, IntNode.aClass74_6977, Class286_Sub1.aClass74_6201, Class91.aClass74_1519, Class348_Sub16_Sub1.aClass74_8853, Class348_Sub40_Sub38.aClass74_9475, Class186.aClass74_2491});
    }
    ...
    final Class105 method1932(ha var_ha, int i, int i_0_, Class324 class324, Class154 class154, int i_1_, boolean bool, byte i_2_, ha var_ha_3_, int i_4_, boolean bool_5_, int i_6_) {
        try {
            ...
            ObjType ObjType = getItemDefinitions(90, i_4_);
            if (i_0_ > 1 && ObjType.countobj != null) {
                int i_7_ = -1;
                for (int i_8_ = 0; i_8_ < 10; i_8_++) {
                    if ((ObjType.countco[i_8_] <= i_0_) && ObjType.countco[i_8_] != 0) i_7_ = ObjType.countobj[i_8_];
                }
                if (i_7_ != -1) ObjType = getItemDefinitions(127, i_7_);
            }
            if (i_2_ != 83) method1935(-83, -37, null, null, false, -49);
            int[] is = ObjType.renderSprite(i_0_, bool_5_, i, var_ha_3_, var_ha, class324, class154, i_1_, (byte) -102, i_6_);
    ...
    static final void method1933(Js5Archive Js5Archive, ha var_ha, boolean bool) {
        try {
            anInt3279++;
            Class207[] class207s = Class207.method1519(Js5Archive, Class348_Sub22.anInt6862, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class106.anInt1639, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class373_Sub2.anInt7429, 0);
            ...
            class207s = Class207.method1519(Js5Archive, ha.anInt4562, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class82.anInt1435, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class115.anInt1756, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class291.anInt3739, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class86.anInt1481, 0);
            Class25.aClass105Array367 = new Class105[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Class25.aClass105Array367[i] = var_ha.method3691(class207s[i], true);
            class207s = Class207.method1519(Js5Archive, Class239_Sub10.anInt5948, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class113.anInt1742, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class364.anInt4469, 0);
            ...
            class207s = Class207.method1519(Js5Archive, Class348_Sub40_Sub38.anInt9473, 0);
            ...
            NPCType.aClass105_1365 = var_ha.method3691(Class207.method1521(Js5Archive, Class52.anInt4895, 0), bool);
            Class239_Sub24.aClass105_6097 = var_ha.method3691(Class207.method1521(Js5Archive, (Class186_Sub1.anInt5814), 0), true);
            class207s = Class207.method1519(Js5Archive, Class5_Sub3.anInt8370, 0);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ub.N(" + (Js5Archive != null ? "{...}" : "null") + ',' + (var_ha != null ? "{...}" : "null") + ',' + bool + ')'));
        }
    }
    ...
    final ObjType getItemDefinitions(int i, int i_13_) {
        anInt3283++;
        ObjType ObjType;
        synchronized (aClass60_3278) {
            ObjType = (ObjType) aClass60_3278.method583(i_13_, 90);
        }
        ...
        ObjType.loader = this;
        ObjType.id = i_13_;
        ObjType.op = new String[]{null, null, Class274.aClass274_3490.method2063(this.anInt3286, 544), null, null};
        ObjType.iop = (new String[]{null, null, null, null, Class274.aClass274_3491.method2063(this.anInt3286, 544)});
        if (is != null) ObjType.decode(768, new Packet(is));
        ObjType.postDecode((byte) 92);
        int i_14_ = 4 / ((i - 13) / 59);
        if (ObjType.certtemplate != -1) ObjType.generateCertificate(1, getItemDefinitions(90, ObjType.certlink), getItemDefinitions(101, ObjType.certtemplate));
        if (ObjType.lenttemplate != -1) ObjType.generateLend(getItemDefinitions(-58, ObjType.lentlink), (byte) -29, getItemDefinitions(-82, ObjType.lenttemplate));
        if (!aBoolean3269 && ObjType.members) {
            ObjType.name = Class274.aClass274_3488.method2063(this.anInt3286, 544);
            ObjType.team = 0;
            ObjType.op = aStringArray3290;
            ObjType.iop = aStringArray3293;
            ObjType.stockmarket = false;
            ObjType.quests = null;
            if (ObjType.params != null) {
                boolean bool = false;
                for (Node Node = ObjType.params.method3484(0); Node != null; Node = ObjType.params.method3482(0)) {
                    Class254 class254 = aClass326_3292.method2600((int) Node.key, 28364);
                    if (class254.aBoolean3261) Node.method2715((byte) 60);
                    else bool = true;
                }
                if (!bool) ObjType.params = null;
            }
        }
        synchronized (aClass60_3278) {
            aClass60_3278.method582(ObjType, i_13_, (byte) -118);
        }
        return ObjType;
    }
    ...
    ObjTypeList(Class230 class230, int i, boolean bool, Class326 class326, Js5Archive Js5Archive, Js5Archive class45_22_) {
        try {
            aBoolean3269 = bool;
            aClass326_3292 = class326;
            this.aClass45_3268 = class45_22_;
            this.anInt3286 = i;
            aClass45_3267 = Js5Archive;
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ub.<init>(" + (class230 != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + (class326 != null ? "{...}" : "null") + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + (class45_22_ != null ? "{...}" : "null") + ')'));
        }
    }
