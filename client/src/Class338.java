...
final class Class338 {
    ...
    static final Class348_Sub41 method2661(int i, int i_0_, int i_1_, boolean bool, int i_2_) {
    ...
    Class338(int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
