...
final class Class105_Sub2 extends Class105 {
    ...
    final void method962(float f, float f_0_, float f_1_, float f_2_, float f_3_, float f_4_, int i, int i_5_, int i_6_, int i_7_) {
        ...
        OpenGL.glTexCoord2f((aClass258_Sub3_Sub1_8434.aFloat9937), 0.0F);
        OpenGL.glVertex2f(f_22_, f_23_);
        OpenGL.glTexCoord2f((aClass258_Sub3_Sub1_8434.aFloat9937), (aClass258_Sub3_Sub1_8434.aFloat9938));
    ...
    final void method963(int i, int i_31_, aa var_aa, int i_32_, int i_33_) {
        ...
        int i_35_ = (i_31_ - -aClass258_Sub3_Sub1_8434.anInt9939);
        float f = (class258_sub3_sub1.aFloat9937 / (float) class258_sub3_sub1.anInt9940);
        float f_36_ = (class258_sub3_sub1.aFloat9938 / (float) class258_sub3_sub1.anInt9939);
        float f_37_ = f * (float) (-i_32_ + i);
        float f_38_ = f * (float) (i_34_ - i_32_);
        float f_39_ = (class258_sub3_sub1.aFloat9938 - f_36_ * (float) (i_31_ - i_33_));
        float f_40_ = (-((float) (i_35_ + -i_33_) * f_36_) + class258_sub3_sub1.aFloat9938);
        OpenGL.glBegin(7);
        OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
        OpenGL.glMultiTexCoord2f(33984, 0.0F, aClass258_Sub3_Sub1_8434.aFloat9938);
        ...
        OpenGL.glMultiTexCoord2f(33984, aClass258_Sub3_Sub1_8434.aFloat9937, 0.0F);
        OpenGL.glMultiTexCoord2f(33985, f_38_, f_40_);
        OpenGL.glVertex2i(i - -(aClass258_Sub3_Sub1_8434.anInt9940), (aClass258_Sub3_Sub1_8434.anInt9939) + i_31_);
        OpenGL.glMultiTexCoord2f(33984, aClass258_Sub3_Sub1_8434.aFloat9937, aClass258_Sub3_Sub1_8434.aFloat9938);
    ...
    final void method983(float f, float f_44_, float f_45_, float f_46_, float f_47_, float f_48_, int i, aa var_aa, int i_49_, int i_50_) {
        ...
        OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
        OpenGL.glMultiTexCoord2f(33984, 0.0F, aClass258_Sub3_Sub1_8434.aFloat9938);
        OpenGL.glMultiTexCoord2f(33985, f_67_ * (f - (float) i_49_), ((class258_sub3_sub1.aFloat9938) - f_68_ * ((float) -i_50_ + f_44_)));
        OpenGL.glVertex2f(f, f_44_);
        OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
        OpenGL.glMultiTexCoord2f(33985, ((float) -i_49_ + f_47_) * f_67_, (-(f_68_ * (f_48_ - (float) i_50_)) + (class258_sub3_sub1.aFloat9938)));
        OpenGL.glVertex2f(f_47_, f_48_);
        OpenGL.glMultiTexCoord2f(33984, aClass258_Sub3_Sub1_8434.aFloat9937, 0.0F);
        OpenGL.glMultiTexCoord2f(33985, (f_65_ - (float) i_49_) * f_67_, (-(f_68_ * (f_66_ - (float) i_50_)) + (class258_sub3_sub1.aFloat9938)));
    ...
    final void method964(int i, int i_69_, int i_70_, int i_71_, int i_72_) {
        ...
        if (aClass258_Sub3_Sub1_8431 == null) {
            ...
            OpenGL.glTexCoord2f(aClass258_Sub3_Sub1_8434.aFloat9937, 0.0F);
            OpenGL.glVertex2i((aClass258_Sub3_Sub1_8434.anInt9940) + i, (aClass258_Sub3_Sub1_8434.anInt9939) + i_69_);
            OpenGL.glTexCoord2f(aClass258_Sub3_Sub1_8434.aFloat9937, aClass258_Sub3_Sub1_8434.aFloat9938);
            OpenGL.glVertex2i((aClass258_Sub3_Sub1_8434.anInt9940) + i, i_69_);
            OpenGL.glEnd();
        } else {
            method992(i_70_, 3);
            ...
            OpenGL.glTexCoord2f(0.0F, 0.0F);
            OpenGL.glVertex2i(i, i_69_ + aClass258_Sub3_Sub1_8434.anInt9939);
            OpenGL.glMultiTexCoord2f(33985, aClass258_Sub3_Sub1_8434.aFloat9937, 0.0F);
            OpenGL.glTexCoord2f(aClass258_Sub3_Sub1_8434.aFloat9937, 0.0F);
            OpenGL.glVertex2i((aClass258_Sub3_Sub1_8434.anInt9940) + i, (aClass258_Sub3_Sub1_8434.anInt9939) + i_69_);
            OpenGL.glMultiTexCoord2f(33985, aClass258_Sub3_Sub1_8434.aFloat9937, aClass258_Sub3_Sub1_8434.aFloat9938);
            OpenGL.glTexCoord2f(aClass258_Sub3_Sub1_8434.aFloat9937, aClass258_Sub3_Sub1_8434.aFloat9938);
            OpenGL.glVertex2i(i + aClass258_Sub3_Sub1_8434.anInt9940, i_69_);
            OpenGL.glEnd();
            method991((byte) 9);
        }
    }
    ...
    final void method965(int i, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_) {
        ...
        if (aClass258_Sub3_Sub1_8434.aBoolean9941 && !aBoolean8427) {
            ...
            for (/**/; i_85_ <= i_81_; i_85_ += i_84_) {
                int i_87_ = i + (aClass258_Sub3_Sub1_8434.anInt9940);
                int i_88_ = i;
                ...
                if (i_88_ < i_80_) {
                    float f = ((float) (i_80_ + -i_88_) * (aClass258_Sub3_Sub1_8434.aFloat9937) / (float) aClass258_Sub3_Sub1_8434.anInt9940);
                    OpenGL.glTexCoord2f(0.0F, aClass258_Sub3_Sub1_8434.aFloat9938);
                    OpenGL.glVertex2i(i_88_, i_86_);
                    OpenGL.glTexCoord2f(0.0F, 0.0F);
                    OpenGL.glVertex2i(i_88_, i_85_);
                    ...
                    OpenGL.glTexCoord2f(f, aClass258_Sub3_Sub1_8434.aFloat9938);
                    OpenGL.glVertex2i(i_80_, i_86_);
                }
                i_86_ += i_84_;
            }
            if (i_86_ < i_81_) {
                float f = ((aClass258_Sub3_Sub1_8434.aFloat9938) * (float) (aClass258_Sub3_Sub1_8434.anInt9939 + (-i_81_ + i_86_)) / (float) aClass258_Sub3_Sub1_8434.anInt9939);
                int i_89_ = i + (aClass258_Sub3_Sub1_8434.anInt9940);
                int i_90_ = i;
                while (i_80_ >= i_89_) {
                    OpenGL.glTexCoord2f(0.0F, aClass258_Sub3_Sub1_8434.aFloat9938);
                    ...
                    OpenGL.glTexCoord2f(aClass258_Sub3_Sub1_8434.aFloat9937, f);
                ...
                if (i_80_ > i_90_) {
                    float f_91_ = ((float) (i_80_ - i_90_) * (aClass258_Sub3_Sub1_8434.aFloat9937) / (float) aClass258_Sub3_Sub1_8434.anInt9940);
                    OpenGL.glTexCoord2f(0.0F, aClass258_Sub3_Sub1_8434.aFloat9938);
                    OpenGL.glVertex2i(i_90_, i_86_);
                    OpenGL.glTexCoord2f(0.0F, f);
                    OpenGL.glVertex2i(i_90_, i_81_);
                    ...
                    OpenGL.glVertex2i(i_80_, i_81_);
                    OpenGL.glTexCoord2f(f_91_, aClass258_Sub3_Sub1_8434.aFloat9938);
                    OpenGL.glVertex2i(i_80_, i_86_);
                }
            }
            OpenGL.glEnd();
