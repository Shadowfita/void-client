...
final class Class348_Sub40_Sub34 extends Class348_Sub40 {
    ...
    static final void method3141(boolean bool, byte i) {
        ...
        if (bool) Packet.method3379(2, 12);
        else {
            Packet.method3379(i + -9, 3);
            try {
    ...
    final int[][] method3047(int i, int i_7_) {
        ...
        if (this.aClass322_7033.aBoolean4035) {
            int[] is_8_ = this.method3048(-1 + i & Class299_Sub2.anInt6325, 633706337, 0);
            int[] is_9_ = this.method3048(i, i_7_ + -2096661920, 0);
            int[] is_10_ = this.method3048(Class299_Sub2.anInt6325 & 1 + i, 633706337, 0);
            int[] is_11_ = is[0];
            int[] is_12_ = is[1];
            int[] is_13_ = is[2];
