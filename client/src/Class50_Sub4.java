...
final class Class50_Sub4 extends Class50 {
    ...
    static final Class158 method472(int i, Packet Packet) {
        anInt5263++;
        String string = Packet.readString((byte) 90);
        Class221 class221 = Class158.method1248(127)[Packet.readUnsignedByte(i ^ ~0x6c6e)];
        if (i != -27794) return null;
        Class341 class341 = Class62.method596(i + 47794)[Packet.readUnsignedByte(255)];
        int i_15_ = Packet.readShort(13638);
        int i_16_ = Packet.readShort(13638);
        int i_17_ = Packet.readUnsignedByte(255);
        int i_18_ = Packet.readUnsignedByte(255);
        int i_19_ = Packet.readUnsignedByte(255);
        int i_20_ = Packet.readUnsignedShort(i ^ ~0x32359469);
        int i_21_ = Packet.readUnsignedShort(842397944);
        int i_22_ = Packet.readInt((byte) -126);
        int i_23_ = Packet.readInt((byte) -126);
        int i_24_ = Packet.readInt((byte) -126);
