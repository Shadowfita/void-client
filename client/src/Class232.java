...
final class Class232 {
    ...
    static final void method1647(int i, int i_3_) {
        ...
        anInt3012++;
        Class348_Sub42_Sub15 class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(i_3_, (byte) 105, 1);
    ...
    Class232(ha_Sub2 var_ha_Sub2, Class104 class104, s_Sub2 var_s_Sub2, int i, int i_4_, int i_5_, int i_6_, int i_7_) {
        try {
            ...
            if (i_9_ <= 0) aClass258_Sub3_2998 = null;
                ...
                anInterface8_3001 = (aHa_Sub2_3000.method3733(5123, -39, Packet.pos, Packet.data, false));
    ...
    private final void method1648(byte i) {
        ...
        if (this.aBoolean3009) {
            ...
            if (i > 115) {
                ...
                int i_26_ = (anInt3003 - -(anInt3002 * aClass104_2999.anInt1624));
                ...
                if (aClass258_Sub3_2998 != null && i_24_ == anInt3010) this.aBoolean3009 = false;
                    ...
                    for (int i_30_ = -128; i_30_ < 0; i_30_++) {
                        for (int i_31_ = -128; i_31_ < 0; i_31_++) {
                            if (is[i_26_] == 0) {
                                int i_32_ = 0;
                                if (is[i_26_ - 1] != 0) i_32_++;
                                if (is[1 + i_26_] != 0) i_32_++;
                                if (is[-i_25_ + i_26_] != 0) i_32_++;
                                if (is[i_25_ + i_26_] != 0) i_32_++;
