...
final class Class97 {
    ...
    static final void method872(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        ...
        if (i_5_ >= Class369.anInt4960 && Class113.anInt1745 >= i_4_ && Class132.anInt1910 <= i_2_ && Class38.anInt513 >= i_3_) {
            ...
            else Class89.method849(i_1_, i_2_, i_5_, i_4_, i_3_, 100, i);
        } else if (i_1_ != 1) Class58.method535(i_5_, i_3_, i_1_, i_4_, i, i_2_, (byte) -106);
        else Class369_Sub3_Sub1.method3575((byte) 103, i_4_, i, i_3_, i_2_, i_5_);
    ...
    private final void method874(int i) {
        ...
        if (this.aBoolean1562) {
            ...
            int i_10_ = (aClass330_1560.anInt4113 * anInt1559 + anInt1544);
                ...
                if (aHa_Sub3_1561.method3880(Class68.aClass68_1183, (Class348_Sub40_Sub38.aClass304_9471), (byte) 122)) {
                    ...
                    for (int i_15_ = -128; i_15_ < 0; i_15_++) {
                        for (int i_16_ = -128; i_16_ < 0; i_16_++) {
                            if (is[i_10_] == 0) {
                                int i_17_ = 0;
                                if (is[i_10_ + -1] != 0) i_17_++;
                                if (is[1 + i_10_] != 0) i_17_++;
                                if (is[i_10_ + -i_9_] != 0) i_17_++;
                                if (is[i_9_ + i_10_] != 0) i_17_++;
                                is_14_[i_13_++] = (byte) (17 * i_17_);
                            } else is_14_[i_13_++] = (byte) 68;
                            i_10_++;
                        }
                    ...
                    if (Class40.anIntArray543 == null) Class40.anIntArray543 = new int[16384];
                    int[] is_18_ = Class40.anIntArray543;
                    for (int i_19_ = -128; i_19_ < 0; i_19_++) {
                        for (int i_20_ = -128; i_20_ < 0; i_20_++) {
                            if (is[i_10_] == 0) {
                                int i_21_ = 0;
                                if (is[i_10_ + -1] != 0) i_21_++;
                                if (is[i_10_ - -1] != 0) i_21_++;
                                if (is[i_10_ + -i_9_] != 0) i_21_++;
                                if (is[i_9_ + i_10_] != 0) i_21_++;
                                is_18_[i_13_++] = i_21_ * 17 << 24;
