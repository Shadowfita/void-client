...
final class Class14_Sub1 extends Class14 implements Interface18_Impl3 {
    ...
    final void method240(int i, byte i_9_, float[] fs, Class304 class304, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_) {
        try {
    ...
    public final void method70(int i, int i_27_, byte i_28_, int i_29_, int i_30_, int i_31_, int i_32_, byte[] is, Class304 class304) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bm.T(" + i + ',' + i_27_ + ',' + i_28_ + ',' + i_29_ + ',' + i_30_ + ',' + i_31_ + ',' + i_32_ + ',' + (is != null ? "{...}" : "null") + ',' + (class304 != null ? "{...}" : "null") + ')'));
        }
    }
