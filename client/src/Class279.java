...
class Class279 {
    ...
    private final void method2086(int[] is, int i) {
        int i_5_ = i;
        if (Class282.aBoolean3652) i_5_ <<= 1;
        ...
        if (aClass348_Sub16_3604 != null && anInt3615 <= 0) {
            ...
            while (i_7_ != 0) {
                ...
                for (int i_11_ = i_7_ >>> i_9_ & 0x11111111; i_11_ != 0; i_11_ >>>= 4) {
                    if ((i_11_ & 0x1) != 0) {
                        ...
                        Class348_Sub16 class348_sub16_12_ = aClass348_Sub16Array3619[i_9_];
                        while (class348_sub16_12_ != null) {
                            Class348_Sub19 class348_sub19 = (class348_sub16_12_.aClass348_Sub19_6787);
                            if (class348_sub19 != null && (class348_sub19.anInt6824 > i_10_)) {
                                ...
                                Class348_Sub16 class348_sub16_14_ = class348_sub16_12_.method2816();
                                ...
                                Class348_Sub16 class348_sub16_16_ = (class348_sub16_12_.aClass348_Sub16_6785);
            ...
            for (int i_17_ = 0; i_17_ < 8; i_17_++) {
                Class348_Sub16 class348_sub16 = aClass348_Sub16Array3619[i_17_];
    ...
    final synchronized void method2088(boolean bool, Class348_Sub16 class348_sub16) {
    ...
    static final void method2092(int i, int i_25_, int[] is, int i_26_, Object[] objects) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("cba.K(" + i + ',' + i_25_ + ',' + (is != null ? "{...}" : "null") + ',' + i_26_ + ',' + (objects != null ? "{...}" : "null") + ')'));
        }
    }
