...
final class Class348_Sub42_Sub10 extends Class348_Sub42 {
    ...
    final void method3210(byte i, int[] is, Packet Packet) {
        while_221_:
        do {
            try {
                anInt9560++;
                ...
                if (anIntArray9574 != null) {
                    ...
                    for (; ; ) {
                        ...
                        if (i_2_ > 0) Packet.method3357(i_2_, is[i_1_], (byte) 116);
                        i_1_++;
                    }
                }
            } catch (RuntimeException runtimeexception) {
                throw Class348_Sub17.method2929(runtimeexception, ("td.C(" + i + ',' + (is != null ? "{...}" : "null") + ',' + (Packet != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
    ...
    private final void method3214(int i, Packet Packet, int i_6_) {
        if (i_6_ == 60) {
            if (i != 1) {
                if (i == 2) {
                    ...
                    for (int i_8_ = 0; i_8_ < i_7_; i_8_++)
                        this.anIntArray9566[i_8_] = Packet.readUnsignedShort(i_6_ + 842397884);
                } else if (i == 3) {
                    int i_9_ = Packet.readUnsignedByte(i_6_ + 195);
                    ...
                    for (int i_10_ = 0; i_9_ > i_10_; i_10_++) {
                        ...
                        if (class138 != null) {
                            ...
                            for (int i_12_ = 0; (class138.anInt1944 > i_12_); i_12_++)
                                anIntArrayArray9565[i_10_][i_12_] = Packet.readUnsignedShort(i_6_ + 842397884);
                        }
                    }
    ...
    final String method3216(Packet Packet, byte i) {
        anInt9578++;
        ...
        if (anIntArray9574 != null) {
            for (int i_13_ = 0; i_13_ < anIntArray9574.length; i_13_++) {
                ...
                stringbuffer.append(this.aClass355_9567.method3472((Packet.method3368((Class348_Sub5.method2752(anIntArray9574[i_13_], 0).anInt1943), 3060)), anIntArrayArray9565[i_13_], -1, method3212(0, i_13_)));
            }
        }
    ...
    final void method3218(Packet Packet, int i) {
        anInt9568++;
        for (; ; ) {
            int i_14_ = Packet.readUnsignedByte(i ^ 0xff);
            if (i_14_ == 0) break;
            method3214(i_14_, Packet, 60);
        }
