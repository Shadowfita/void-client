...
class Packet extends Node {
    ...
    final int readUnsignedShort(int i) {
        ...
        this.pos += 2;
        anInt7186++;
        return ((0xff & (this.data[-1 + this.pos])) + ((this.data[-2 + this.pos]) << 8 & 0xff00));
    }
    ...
    final void writeString(byte i, String string) {
        anInt7172++;
        if (i != -5) this.data = null;
        int i_5_ = string.indexOf('\0');
        if (i_5_ >= 0) throw new IllegalArgumentException("NUL character at " + i_5_ + " - cannot pjstr");
        this.pos += Class348_Sub42_Sub16.method3255(0, (this.data), string.length(), false, string, (this.pos));
    ...
    final void writeShortAdd(int i, int i_9_) {
        anInt7156++;
        this.data[this.pos++] = (byte) (i_9_ >> 8);
        int i_10_ = -35 % ((-17 - i) / 48);
        this.data[this.pos++] = (byte) (128 + i_9_);
    }

    final void writeIntMiddle(int i, byte i_11_) {
        anInt7162++;
        this.data[this.pos++] = (byte) (i >> 8);
        this.data[this.pos++] = (byte) i;
        this.data[this.pos++] = (byte) (i >> 24);
        this.data[this.pos++] = (byte) (i >> 16);
    ...
    final void writeShort(byte i, int i_12_) {
        ...
        this.data[this.pos++] = (byte) (i_12_ >> 8);
        this.data[this.pos++] = (byte) i_12_;
    }

    final void method3338(int i, int i_13_) {
        this.data[-4 + this.pos - i_13_] = (byte) (i_13_ >> 24);
        anInt7200++;
        this.data[this.pos - i_13_ - 3] = (byte) (i_13_ >> 16);
        this.data[this.pos - (i_13_ - -2)] = (byte) (i_13_ >> 8);
        this.data[i + (this.pos + -i_13_)] = (byte) i_13_;
    }

    final void method3339(int i, int i_14_) {
        if (i > 91) {
            this.data[this.pos - i_14_ + -1] = (byte) i_14_;
            anInt7185++;
        }
    }

    final void method3340(int i, int i_15_) {
        this.data[this.pos++] = (byte) (i_15_ >> 16);
        anInt7148++;
        this.data[this.pos++] = (byte) (i_15_ >> 8);
        if (i == -9912) this.data[this.pos++] = (byte) i_15_;
    }
    ...
    final int readIntMiddleEndian(byte i) {
        ...
        return ((0xff0000 & (this.data[this.pos - 1]) << 16) + (((this.data[this.pos - 2]) << 24 & ~0xffffff) + ((0xff & (this.data[this.pos + -4])) << 8) + (0xff & (this.data[this.pos - 3]))));
    }

    final int method3344(int i, boolean bool) {
        anInt7165++;
        if (bool != false) this.data = null;
        int i_17_ = Class171.method1319(this.pos, true, this.data, i);
    ...
    final int readIntInverseMiddle(int i) {
        ...
        anInt7194++;
        if (i != 255) return 93;
        return (((0xff & (this.data[-1 + this.pos])) << 8) + (((this.data[-3 + this.pos]) & 0xff) << 24) - (-((0xff & (this.data[this.pos - 4])) << 16) + -(0xff & (this.data[this.pos - 2]))));
    }

    final void method3347(byte[] is, int i, int i_18_, byte i_19_) {
        anInt7183++;
        for (int i_20_ = -1 + i_18_ + i; i_20_ >= i; i_20_--)
            is[i_20_] = (this.data[this.pos++]);
        int i_21_ = -53 / ((i_19_ - -72) / 47);
    }

    final void writeIntLittle(int i, int i_22_) {
        this.data[this.pos++] = (byte) i_22_;
        anInt7164++;
        this.data[this.pos++] = (byte) (i_22_ >> 8);
        this.data[this.pos++] = (byte) (i_22_ >> 16);
        this.data[this.pos++] = (byte) (i_22_ >> 24);
    ...
    final void writeShortAddLittle(int i, int i_24_) {
        if (i == 4325) {
            anInt7198++;
            this.data[this.pos++] = (byte) (i_24_ - -128);
    ...
    final int readMedium(int i) {
        ...
        anInt7203++;
        if (i != -1) return -52;
        return ((0xff00 & (this.data[-2 + this.pos]) << 8) + ((((this.data[-3 + this.pos]) & 0xff) << 16) - -((this.data[-1 + this.pos]) & 0xff)));
    }
    ...
    final boolean method3352(int i) {
        ...
        int i_34_ = Class171.method1319(this.pos, true, this.data, 0);
    ...
    final int readShortAdd(int i) {
        ...
        this.pos += 2;
        return (((this.data[-2 + this.pos]) << 8 & 0xff00) - -(0xff & -128 + (this.data[this.pos + -1])));
    }
    ...
    final void method3357(int i, long l, byte i_40_) {
        try {
            ...
            for (int i_42_ = 8 * i; i_42_ >= 0; i_42_ -= 8)
                this.data[this.pos++] = (byte) (int) (l >> i_42_);
    ...
    final int readShortAddLittle(int i) {
        anInt7181++;
        if (i > -105) this.data = null;
        this.pos += 2;
        return (((this.data[this.pos + -2]) - 128 & 0xff) + ((this.data[-1 + this.pos]) << 8 & 0xff00));
    }
    ...
    final int method3359(int i) {
        ...
        anInt7188++;
        this.pos += 4;
        return (((this.data[-3 + this.pos]) << 8 & 0xff00) + ((this.data[this.pos - 1]) << 24 & ~0xffffff) + (((0xff & (this.data[this.pos + -2])) << 16) + ((this.data[-4 + this.pos]) & 0xff)));
    }

    final void method3360(byte i) {
        if (this.data != null) Class37.method357(0, this.data);
        anInt7177++;
        this.data = null;
    ...
    final int method3362(byte i) {
        anInt7155++;
        int i_43_ = ((this.data[this.pos]) & 0xff);
        if (i != 77) readByte(-48);
    ...
    final int method3363(int i) {
        ...
        return (((this.data[this.pos - 3]) & 0xff) + (((this.data[-2 + this.pos]) << 8 & 0xff00) + ((this.data[-1 + this.pos]) << 16 & 0xff0000)));
    }
    ...
    final int readIntLittle(byte i) {
        ...
        this.pos += 4;
        anInt7167++;
        return ((0xff & (this.data[this.pos - 4])) + (((0xff & (this.data[-3 + this.pos])) << 8) + (~0xffffff & ((this.data[this.pos - 1]) << 24)) + (((this.data[this.pos - 2]) & 0xff) << 16)));
    }
    ...
    final int method3366(byte i) {
        anInt7170++;
        int i_45_ = (this.data[this.pos++]);
        int i_46_ = 0;
        if (i < 23) return -99;
        for (/**/; i_45_ < 0; i_45_ = (this.data[this.pos++]))
    ...
    final long method3368(int i, int i_57_) {
        ...
        long l = 0L;
        for (/**/; i_58_ >= 0; i_58_ -= 8)
            l |= ((long) (this.data[this.pos++]) & 0xffL) << i_58_;
        return l;
    }
    ...
    final int method3369(byte i) {
        ...
        anInt7139++;
        this.pos += 3;
        int i_59_ = (((this.data[this.pos - 1]) & 0xff) + ((0xff0000 & ((this.data[this.pos + -3]) << 16)) + ((0xff & (this.data[this.pos + -2])) << 8)));
    ...
    final void writeByteSubtract(byte i, int i_60_) {
        int i_61_ = -4 % ((-35 - i) / 33);
        anInt7142++;
        this.data[this.pos++] = (byte) (-i_60_ + 128);
    }

    final String method3371(int i) {
        anInt7152++;
        byte i_62_ = (this.data[this.pos++]);
        ...
        if (i_64_ == 0) return "";
        return Class367_Sub8.method3546(this.data, 0, i_64_, i_63_);
    }
    ...
    final int readShort(int i) {
        ...
        this.pos += 2;
        int i_65_ = (((this.data[this.pos - 1]) & 0xff) + (((this.data[-2 + this.pos]) & 0xff) << 8));
    ...
    final int readShortLittle(boolean bool) {
        ...
        anInt7171++;
        this.pos += 2;
        return ((0xff00 & (this.data[this.pos - 1]) << 8) + ((this.data[-2 + this.pos]) & 0xff));
    }

    final void writeByteInverse(byte i, int i_66_) {
        this.data[this.pos++] = (byte) -i_66_;
        if (i >= -27) this.data = null;
        anInt7140++;
    }
    ...
    final int method3375(byte i) {
        anInt7187++;
        this.pos += 2;
        int i_67_ = ((0xff & -128 + (this.data[this.pos - 1])) + (((this.data[-2 + this.pos]) & 0xff) << 8));
        if (i != 84) return 85;
    ...
    final String readString(byte i) {
        ...
        if (i_70_ == 0) return "";
        return Class367_Sub8.method3546(this.data, 0, i_70_, i_69_);
    }
    ...
    static final void method3379(int i, int i_71_) {
        ...
        if (i_71_ != Class240.anInt4674) {
            ...
            if (i_71_ != 13 && ObjType.aClass238_2773 != null) {
                ObjType.aClass238_2773.method1700((byte) 36);
                ObjType.aClass238_2773 = null;
            }
    ...
    final int readSmart(int i) {
        if (i > -116) return -4;
        anInt7176++;
        int i_78_ = 0xff & (this.data[this.pos]);
    ...
    final void method3383(int i, int i_79_) {
        anInt7157++;
        this.data[-2 + -i_79_ + this.pos] = (byte) (i_79_ >> 8);
        if (i != 1809639944) method3350(93, true, null, -39);
        this.data[this.pos - i_79_ + -1] = (byte) i_79_;
    }
    ...
    final int readInt(byte i) {
        ...
        return ((0xff & (this.data[this.pos - 1])) + ((((this.data[-4 + this.pos]) & 0xff) << 24) + (0xff0000 & ((this.data[-3 + this.pos]) << 16))) - -(((this.data[-2 + this.pos]) & 0xff) << 8));
    }
    ...
    final void writeInt(byte i, int i_90_) {
        this.data[this.pos++] = (byte) (i_90_ >> 24);
        if (i < 84) writeByteAdd((byte) -122, -112);
        anInt7202++;
        this.data[this.pos++] = (byte) (i_90_ >> 16);
        this.data[this.pos++] = (byte) (i_90_ >> 8);
        this.data[this.pos++] = (byte) i_90_;
    }

    final void writeLong(long l, byte i) {
        try {
            int i_91_ = -16 % ((i - -5) / 52);
            this.data[this.pos++] = (byte) (int) (l >> 56);
            anInt7209++;
            this.data[this.pos++] = (byte) (int) (l >> 48);
            this.data[this.pos++] = (byte) (int) (l >> 40);
            this.data[this.pos++] = (byte) (int) (l >> 32);
            this.data[this.pos++] = (byte) (int) (l >> 24);
            this.data[this.pos++] = (byte) (int) (l >> 16);
            this.data[this.pos++] = (byte) (int) (l >> 8);
            this.data[this.pos++] = (byte) (int) l;
        } catch (RuntimeException runtimeexception) {
    ...
    Packet(int i) {
        this.pos = 0;
        this.data = Class37.method359(i, -1);
    }

    final void method3394(int i, int i_93_) {
        this.data[this.pos++] = (byte) i_93_;
        anInt7141++;
        this.data[this.pos++] = (byte) (i_93_ >> 8);
        if (i == -23892) {
            this.data[this.pos++] = (byte) (i_93_ >> 16);
            this.data[this.pos++] = (byte) (i_93_ >> 24);
        }
    }

    final void writeByteAdd(byte i, int i_94_) {
        anInt7192++;
        this.data[this.pos++] = (byte) (i_94_ + 128);
        int i_95_ = -21 % ((-8 - i) / 57);
    }
    ...
    final void method3397(int i, int i_97_) {
        anInt7189++;
        this.data[this.pos++] = (byte) i_97_;
        this.data[this.pos++] = (byte) (i_97_ >> 8);
