...
final class Class348_Sub3 extends Node {
        ...
        if (buffer != null) {
            ...
            if (Stream.c()) {
                for (int i_5_ = 0; i_1_ > i_5_; i_5_++) {
                    int i_6_ = is[i_5_];
                    short[] is_7_ = aS_Sub3_6566.aShortArrayArray8299[i_6_];
                    int i_8_ = anIntArray6573[i_6_];
                    if (i_8_ != 0 && is_7_ != null) {
                        int i_9_ = 0;
                        int i_10_ = 0;
                        while (i_10_ < is_7_.length) {
                            if ((i_8_ & 1 << i_9_++) == 0) i_10_ += 3;
                            else {
                                i_2_++;
                ...
                for (int i_13_ = 0; i_1_ > i_13_; i_13_++) {
                    int i_14_ = is[i_13_];
                    short[] is_15_ = aS_Sub3_6566.aShortArrayArray8299[i_14_];
    ...
    final void method2741(int i, float f, int i_24_, int i_25_, int i_26_) {
        if (this.anInt6567 != -1) {
            Class12 class12 = aHa_Sub3_6590.aD4579.method3(this.anInt6567, -6662);
            ...
            if (i_27_ != 0 && class12.aByte213 != 4) {
                ...
                if (i_27_ != 256) {
                    int i_29_ = i_27_;
                    int i_30_ = -i_27_ + 256;
                    i_26_ = ((i_30_ * (i_26_ & 0xff00) + i_29_ * (0xff00 & i_28_) & 0xff0000) + (~0xff00ff & (i_29_ * (i_28_ & 0xff00ff) - -((i_26_ & 0xff00ff) * i_30_)))) >> 8;
                } else i_26_ = i_28_;
            }
            int i_31_ = 0xff & class12.aByte216;
            if (i_31_ != 0) {
                i_31_ += 256;
                int i_32_ = (0xff & i_26_ >> 16) * i_31_;
                if (i_32_ > 65535) i_32_ = 65535;
                int i_33_ = ((0xff00 & i_26_) >> 8) * i_31_;
                if (i_33_ > 65535) i_33_ = 65535;
                int i_34_ = i_31_ * (0xff & i_26_);
                if (i_34_ > 65535) i_34_ = 65535;
                i_26_ = (i_34_ >> 8) + ((i_33_ & 0xff00) + ((0x5400ff00 & i_32_) << 8));
            }
        }
        anInt6588++;
        aStream6574.e(i * 4);
        if (f != 1.0F) {
            int i_35_ = i_26_ >> 16 & 0xff;
            int i_36_ = 0xff & i_26_ >> 8;
            i_35_ *= f;
    ...
    final void method2742(int i, int i_38_, int i_39_, byte i_40_) {
        anInt6570++;
        anIntArray6573[i_38_ * aS_Sub3_6566.anInt4587 - -i_39_] = Class273.method2057((anIntArray6573[(i_38_ * aS_Sub3_6566.anInt4587 - -i_39_)]), 1 << i);
    ...
    Class348_Sub3(s_Sub3 var_s_Sub3, int i, int i_43_, int i_44_, int i_45_, int i_46_) {
