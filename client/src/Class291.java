...
final class Class291 {
    ...
    static SceneEntity[] aClass318_Sub1Array3737;
    int[] anIntArray3738;
    ...
    private final void method2200(byte i, byte[] is) {
        ...
        else this.anInt3732 = Packet.readInt((byte) -126);
        int i_3_ = Packet.readUnsignedByte(255);
        boolean bool = (i_3_ & 0x1) != 0;
        boolean bool_4_ = (i_3_ & 0x2) != 0;
        this.anInt3727 = Packet.readUnsignedShort(842397944);
        int i_5_ = 0;
        ...
        for (int i_10_ = 0; i_10_ < this.anInt3727; i_10_++)
            this.anIntArray3729[(this.anIntArray3738[i_10_])] = Packet.readInt((byte) -126);
        if (bool_4_) {
            for (int i_11_ = 0; i_11_ < this.anInt3727; i_11_++) {
                byte[] is_12_ = new byte[64];
                Packet.method3389(2147483647, 0, 64, is_12_);
