...
final class Class377 extends ha_Sub3 {
    ...
    final Class130 method3812(int i, Class58[] class58s) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.KD(" + i + ',' + (class58s != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    static final void method3965(String string, int i, int i_1_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.AA(" + (string != null ? "{...}" : "null") + ',' + i + ',' + i_1_ + ')'));
        }
    }
    ...
    final void method3881(Object object, byte i, Canvas canvas) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.UB(" + (object != null ? "{...}" : "null") + ',' + i + ',' + (canvas != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method3924(boolean bool, boolean bool_2_, int i, Class70 class70, boolean bool_3_) {
        try {
            anInt9852++;
            if (bool_2_ == false) {
                OpenGL.glTexEnvi(8960, i + 34176, Class57.method531((byte) 101, class70));
                if (bool) OpenGL.glTexEnvi(8960, i + 34192, !bool_3_ ? 770 : 771);
                else OpenGL.glTexEnvi(8960, i + 34192, !bool_3_ ? 768 : 769);
            }
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("bga.DD(" + bool + ',' + bool_2_ + ',' + i + ',' + (class70 != null ? "{...}" : "null") + ',' + bool_3_ + ')'));
        }
    }
    ...
    final boolean method3880(Class68 class68, Class304 class304, byte i) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.FB(" + (class68 != null ? "{...}" : "null") + ',' + (class304 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }
    ...
    final void method3935(int i) {
        anInt9861++;
        OpenGL.glTexEnvi(8960, 34162, Class348_Sub32.method3021((byte) 32, (this.aClass229Array8092[(this.anInt8175)])));
        if (i >= -99) method3658(-123, -102, -33, -112);
    }

    final Interface18_Impl1 method3872(int i, int i_6_, Class304 class304, boolean bool, int i_7_, byte[] is) {
        try {
            if (bool != true) aString9916 = null;
            anInt9832++;
            return new Class14_Sub3(this, class304, i_6_, i_7_, i, is);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("bga.ND(" + i + ',' + i_6_ + ',' + (class304 != null ? "{...}" : "null") + ',' + bool + ',' + i_7_ + ',' + (is != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final Interface18_Impl3 method3843(int i, int i_11_, int i_12_, int i_13_, byte[] is, Class304 class304, int i_14_, boolean bool) {
        try {
            anInt9846++;
            ...
            return new Class14_Sub1(this, class304, i_12_, i, bool, is, i_11_, i_13_);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("bga.B(" + i + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ',' + (is != null ? "{...}" : "null") + ',' + (class304 != null ? "{...}" : "null") + ',' + i_14_ + ',' + bool + ')'));
        }
    }
    ...
    final void method3871(Class113 class113, int i) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.CD(" + (class113 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }
    ...
    final void method3940(int i) {
        ...
        anInt9888++;
        if (Class348_Sub42_Sub18.aClass251_9685 != this.aClass251Array8113[this.anInt8175]) OpenGL.glLoadMatrixf(this.aClass101_Sub2Array8131[this.anInt8175].method918(Class233.aFloatArray3015, 0), 0);
    ...
    final void method3925(int i, Interface5_Impl1 interface5_impl1, int i_17_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.WB(" + i + ',' + (interface5_impl1 != null ? "{...}" : "null") + ',' + i_17_ + ')'));
        }
    }
    ...
    final void method3920(int i) {
        ...
        OpenGL.glTexEnvi(8960, 34161, Class348_Sub32.method3021((byte) 32, (this.aClass229Array8086[(this.anInt8175)])));
    }
    ...
    final Interface4 method3634(Interface3 interface3, Interface13 interface13) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.NB(" + (interface3 != null ? "{...}" : "null") + ',' + (interface13 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final Object method3876(int i, Canvas canvas) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.MC(" + i + ',' + (canvas != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final Class299 method3706(Class299 class299, Class299 class299_24_, float f, Class299 class299_25_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.SD(" + (class299 != null ? "{...}" : "null") + ',' + (class299_24_ != null ? "{...}" : "null") + ',' + f + ',' + (class299_25_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method3842(boolean bool) {
        ...
        OpenGL.glLightfv(16384, 4609, RuntimeException_Sub1.aFloatArray4602, 0);
        ...
        if (bool == true) {
            ...
            OpenGL.glLightfv(16385, 4609, RuntimeException_Sub1.aFloatArray4602, 0);
        }
    }
    ...
    private final void method3970(int i) {
        ...
        if (this.aClass196_8184.method1450(-98)) {
            if (!aBoolean9914) {
                OpenGL.glLoadMatrixf(this.aClass101_Sub2_8083.method918(Class233.aFloatArray3015, 0), 0);
                aBoolean9914 = true;
                method3892(0);
                method3823((byte) -104);
            }
            if (!this.aBoolean8069) {
                OpenGL.glPushMatrix();
                OpenGL.glMultMatrixf(this.aClass101_Sub2_8074.method918(Class233.aFloatArray3015, i ^ 0x1), 0);
                aBoolean9911 = true;
            ...
            OpenGL.glLoadMatrixf(this.aClass101_Sub2_8074.method918(Class233.aFloatArray3015, 0), 0);
            aBoolean9911 = false;
        }
    }
    ...
    final void method3851(int i) {
        ...
        RuntimeException_Sub1.aFloatArray4602[2] = ((float) Class139.method1166(this.anInt8144, 255) / 255.0F);
        RuntimeException_Sub1.aFloatArray4602[0] = ((float) Class139.method1166(16711680, this.anInt8144) / 1.671168E7F);
        RuntimeException_Sub1.aFloatArray4602[1] = ((float) Class139.method1166(65280, this.anInt8144) / 65280.0F);
    ...
    Class377(OpenGL opengl, Canvas canvas, long l, d var_d, Js5Archive Js5Archive, int i) {
        ...
        try {
            try {
                ...
                if (anInt9924 < 12) throw new RuntimeException("");
                if (!anOpenGL9856.a("GL_ARB_multitexture")) throw new RuntimeException("");
                if (!anOpenGL9856.a("GL_ARB_texture_env_combine")) throw new RuntimeException("");
                int[] is = new int[1];
                OpenGL.glGetIntegerv(34018, is, 0);
                this.anInt8090 = is[0];
                if (this.anInt8090 < 2) throw new RuntimeException("");
                this.anInt8138 = 8;
                ...
                this.anIntArray9927 = new int[this.anInt8090];
                    ...
                    for (int i_37_ = 0; (i_37_ < strings_36_.length); i_37_++) {
                        ...
                        try {
                            if (string_38_.length() > 0) {
                                if (string_38_.charAt(0) == 'x' && string_38_.length() >= 3 && (Class50_Sub3.method468(string_38_.substring(1, 3), -115))) {
                                    bool_35_ = true;
                                    string_38_ = string_38_.substring(1);
                                }
                                if (string_38_.equals("hd")) bool = true;
                                else {
    ...
    final void method3938(Class21 class21, int i, Interface5_Impl2 interface5_impl2, int i_40_, int i_41_, int i_42_, int i_43_) {
        try {
            ...
            OpenGL.glDrawElements(i_44_, i_45_, Class130.method1128(-20, class68), (class285_sub2.method2122(27819) + (long) (i_41_ * (class68.anInt1178))));
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("bga.JC(" + (class21 != null ? "{...}" : "null") + ',' + i + ',' + (interface5_impl2 != null ? "{...}" : "null") + ',' + i_40_ + ',' + i_41_ + ',' + i_42_ + ',' + i_43_ + ')'));
        }
    }
    ...
    final void method3823(byte i) {
        ...
        for (i_47_ = 0; this.anInt8151 > i_47_; i_47_++) {
            Class348_Sub1 class348_sub1 = this.aClass348_Sub1Array8132[i_47_];
    ...
    final void method3844(int i, Canvas canvas, Object object) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.FC(" + i + ',' + (canvas != null ? "{...}" : "null") + ',' + (object != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final boolean method3931(boolean bool, Class304 class304, Class68 class68) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.RA(" + bool + ',' + (class304 != null ? "{...}" : "null") + ',' + (class68 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method3899(int i, int i_50_, Class21 class21, boolean bool) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.V(" + i + ',' + i_50_ + ',' + (class21 != null ? "{...}" : "null") + ',' + bool + ')'));
        }
    }
    ...
    final Interface18_Impl2 method3900(int[][] is, boolean bool, int i, int i_53_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.HB(" + (is != null ? "{...}" : "null") + ',' + bool + ',' + i + ',' + i_53_ + ')'));
        }
    }

    final Interface18_Impl3 method3855(Class304 class304, int i, int i_54_, float[] fs, boolean bool, int i_55_, int i_56_, int i_57_) {
        try {
            anInt9890++;
            ...
            return new Class14_Sub1(this, class304, i, i_57_, bool, fs, i_54_, i_55_);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("bga.WC(" + (class304 != null ? "{...}" : "null") + ',' + i + ',' + i_54_ + ',' + (fs != null ? "{...}" : "null") + ',' + bool + ',' + i_55_ + ',' + i_56_ + ',' + i_57_ + ')'));
        }
    }
    ...
    final Interface18_Impl3 method3830(int i, int[] is, boolean bool, byte i_60_, int i_61_, int i_62_, int i_63_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.R(" + i + ',' + (is != null ? "{...}" : "null") + ',' + bool + ',' + i_60_ + ',' + i_61_ + ',' + i_62_ + ',' + i_63_ + ')'));
        }
    }
    ...
    final void method3673() {
        ...
        if (this.anInt7931 > 0 || this.anInt7962 > 0) {
            ...
            OpenGL.glCopyPixels(0, 0, this.anInt7931, this.anInt7962, 6144);
            OpenGL.glFlush();
    ...
    final void method3829(Class70 class70, int i, byte i_71_, boolean bool) {
        try {
            if (i_71_ == 80) {
                OpenGL.glTexEnvi(8960, i + 34184, Class57.method531((byte) 123, class70));
                anInt9885++;
                OpenGL.glTexEnvi(8960, 34200 + i, bool ? 771 : 770);
            }
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("bga.AD(" + (class70 != null ? "{...}" : "null") + ',' + i + ',' + i_71_ + ',' + bool + ')'));
        }
    }
    ...
    final void method3707(Rectangle[] rectangles, int i, int i_72_, int i_73_) throws Exception_Sub1 {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.UA(" + (rectangles != null ? "{...}" : "null") + ',' + i + ',' + i_72_ + ',' + i_73_ + ')'));
        }
    }
    ...
    final void method3862(int i, Class130 class130) {
        try {
            anInt9866++;
            Class58[] class58s = ((Class130_Sub1) class130).aClass58Array5801;
            int i_74_ = 0;
            boolean bool = false;
            ...
            if (i_74_ <= anInt9909) {
                ...
                for (int i_82_ = anInt9909; i_82_ < i_74_; i_82_++) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.KC(" + i + ',' + (class130 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method3911(Canvas canvas, int i, Object object) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("bga.QD(" + (canvas != null ? "{...}" : "null") + ',' + i + ',' + (object != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final Interface18_Impl3 method3861(int i, byte i_88_, int i_89_, Class68 class68, Class304 class304) {
        try {
