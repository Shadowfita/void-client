...
final class Class369_Sub2 extends Class369 {
    ...
    static Js5Archive aClass45_8589;
    ...
    public final Class223 method51(byte i) {
        ...
        anInt8586++;
        return Packet.aClass223_7175;
    }

    static final Js5Archive method3571(boolean bool, int i, byte i_0_, int i_1_) {
        anInt8593++;
        ...
        return new Js5Archive(Class13.aClass314_Sub1Array223[i], bool, i_1_);
    }
    ...
    Class369_Sub2(Class221 class221, Class341 class341, int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
        ...
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ou.<init>(" + (class221 != null ? "{...}" : "null") + ',' + (class341 != null ? "{...}" : "null") + ',' + i + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ')'));
        }
    }
