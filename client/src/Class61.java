...
final class Class61 {
    ...
    static final int method592(boolean bool, byte i, boolean bool_0_, int i_1_, int i_2_) {
        anInt1105++;
        if (i != -128) return -20;
        Class348_Sub13 class348_sub13 = Class258_Sub4.method1974((byte) -1, i_1_, bool_0_);
        ...
        for (int i_4_ = 0; (class348_sub13.anIntArray6757.length > i_4_); i_4_++) {
            if (class348_sub13.anIntArray6757[i_4_] >= 0 && (Exception_Sub1.aClass255_112.anInt3271 > class348_sub13.anIntArray6757[i_4_])) {
                ObjType ObjType = (Exception_Sub1.aClass255_112.getItemDefinitions(-127, (class348_sub13.anIntArray6757[i_4_])));
                int i_5_ = ObjType.getIntParam((Class101_Sub3.aClass326_5764.method2600(i_2_, 28364).anInt3256), 107, i_2_);
                if (!bool) i_3_ += i_5_;
