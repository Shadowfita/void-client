    ...
    static final void method2954(byte i) {
        ...
        if (za_Sub1.anInt9775 != -1 && Class292.anInt4803 != -1) {
            ...
            for (int i_2_ = 0; i_2_ < 3; i_2_++) {
                ...
                int i_5_ = 3 * ((Class348_Sub43.anIntArrayArrayArray7079[za_Sub1.anInt9775][2 + i_1_][i_2_]) + ((Class348_Sub43.anIntArrayArrayArray7079[za_Sub1.anInt9775][2 + i_1_][i_2_]) + -(Class348_Sub43.anIntArrayArrayArray7079[za_Sub1.anInt9775][i_1_ - -3][i_2_])));
                int i_6_ = (Class348_Sub43.anIntArrayArrayArray7079[za_Sub1.anInt9775][i_1_][i_2_]);
                int i_7_ = i_4_ - i_3_;
                int i_8_ = -(2 * i_4_) + i_3_ - -i_5_;
                int i_9_ = -i_6_ + ((Class348_Sub43.anIntArrayArrayArray7079[za_Sub1.anInt9775][i_1_ - -2][i_2_]) + i_4_) + -i_5_;
                fs[i_2_] = (float) i_6_ + f * ((float) i_7_ + f * (f * (float) i_9_ + (float) i_8_));
            }
            Class286_Sub4.anInt6246 = (int) fs[0] - 512 * za_Sub2.regionTileX;
            Class305.anInt3855 = -1 * (int) fs[1];
            Class59_Sub2_Sub2.anInt8685 = (int) fs[2] + -(Class90.regionTileY * 512);
            float[] fs_10_ = new float[3];
            int i_11_ = 2 * Class264.anInt3373;
            int i_12_ = -88 % ((-64 - i) / 57);
            for (int i_13_ = 0; i_13_ < 3; i_13_++) {
                int i_14_ = 3 * (Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][i_11_][i_13_]);
                int i_15_ = 3 * (Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][i_11_ + 1][i_13_]);
                int i_16_ = (((Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][2 + i_11_][i_13_]) + (-(Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][3 + i_11_][i_13_]) + (Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][i_11_ - -2][i_13_]))) * 3);
                int i_17_ = (Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][i_11_][i_13_]);
                int i_18_ = -i_14_ + i_15_;
                int i_19_ = -(i_15_ * 2) + i_14_ + i_16_;
                int i_20_ = (-i_16_ + i_15_ + (-i_17_ + (Class348_Sub43.anIntArrayArrayArray7079[Class292.anInt4803][2 + i_11_][i_13_])));
