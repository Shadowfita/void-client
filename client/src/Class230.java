            ...
            try {
                ...
                if (Packet.anInt7207 != -1) {
                    ...
                    if (!Class348_Sub16_Sub2.aBoolean8870) {
                        ...
                        int i_25_ = (int) ((Class247.aDouble3182 * (double) i_22_ + (double) i_23_ * Class319.aDouble3980 + (double) i_24_ * Class357.aDouble4404) * (double) i_20_ / (double) i_14_);
                        ...
                        if ((i_27_ < 0 || i_28_ < 0 || i_29_ > Class348_Sub16_Sub1.anInt8854 || (i_30_ > Class239_Sub16.anInt6008)) && Packet.anInt7207 != 2) {
                            if (i_29_ <= 0 || i_30_ <= 0 || (Class348_Sub16_Sub1.anInt8854 <= i_27_) || (i_28_ >= Class239_Sub16.anInt6008)) Class348_Sub16_Sub2.aBoolean8870 = true;
                                ...
                                if (Packet.anInt7207 == 0) {
                                    ...
                                    d_37_ = ((d + Class348_Sub42_Sub4.aDouble9517) * (double) (i_32_ * i_34_ + i_33_ * i_31_) / (double) (i_32_ * i_32_ + i_31_ * i_31_));
                                }
                                d_37_ = -d_37_;
                                int i_38_ = 0;
                                int i_39_ = 0;
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("sj.D(" + (is != null ? "{...}" : "null") + ',' + i + ',' + (is_0_ != null ? "{...}" : "null") + ',' + i_1_ + ',' + i_2_ + ',' + (is_3_ != null ? "{...}" : "null") + ',' + i_4_ + ',' + i_5_ + ',' + bool + ',' + i_6_ + ',' + i_7_ + ',' + (is_8_ != null ? "{...}" : "null") + ',' + (is_9_ != null ? "{...}" : "null") + ',' + i_10_ + ',' + (is_11_ != null ? "{...}" : "null") + ',' + i_12_ + ',' + bool_13_ + ',' + i_14_ + ')'));
            }
            break;
        } while (false);
    }

    static final void method1635(int i, Class318_Sub1_Sub3_Sub3 class318_sub1_sub3_sub3) {
        try {
            anInt2983++;
            do {
                if ((class318_sub1_sub3_sub3.anInt10268) != -1) {
                    Class17 class17 = (Class10.aClass87_191.method835(class318_sub1_sub3_sub3.anInt10268, 7));
            ...
            do {
                if ((class318_sub1_sub3_sub3.anInt10269) != -1 && (Class367_Sub11.anInt7396 >= (class318_sub1_sub3_sub3.anInt10225))) {
                    Class368 class368 = (Class348_Sub40_Sub18.aClass319_9245.method2543((byte) 90, class318_sub1_sub3_sub3.anInt10269));
                    int i_70_ = class368.anInt4503;
                    if (i_70_ != -1) {
                        Class17 class17 = Class10.aClass87_191.method835(i_70_, 7);
            ...
            do {
                if ((class318_sub1_sub3_sub3.anInt10291) != -1 && (class318_sub1_sub3_sub3.anInt10211 <= Class367_Sub11.anInt7396)) {
                    Class368 class368 = (Class348_Sub40_Sub18.aClass319_9245.method2543((byte) 93, class318_sub1_sub3_sub3.anInt10291));
                    int i_71_ = class368.anInt4503;
                    if (i_71_ != -1) {
                        Class17 class17 = Class10.aClass87_191.method835(i_71_, 7);
                        if (class368.aBoolean4487) {
                            if (class17.anInt262 != 3) {
            ...
            if ((class318_sub1_sub3_sub3.anInt10286 != -1) && (class318_sub1_sub3_sub3.anInt10218) <= 1) {
                Class17 class17 = (Class10.aClass87_191.method835((class318_sub1_sub3_sub3.anInt10286), 7));
                if (class17.anInt262 != 3) {
            ...
            for (int i_73_ = 0; ((class318_sub1_sub3_sub3.aClass182Array10308).length > i_73_); i_73_++) {
                Class182 class182 = (class318_sub1_sub3_sub3.aClass182Array10308[i_73_]);
                if (class182 != null) {
                    if (class182.anInt2448 > 0) class182.anInt2448--;
                    else {
                        Class17 class17 = Class10.aClass87_191.method835((class182.anInt2454), 7);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("sj.A(" + i + ',' + (class318_sub1_sub3_sub3 != null ? "{...}" : "null") + ')'));
        }
    }

    static final Class299 method1636(int i, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_) {
        anInt2988++;
        ...
        class299 = ReferenceCache.aHa1098.method3697(i_75_, i_77_, i_79_, i_74_, i, i_76_);
