...
final class Class64_Sub3 extends Class64 {
    ...
    private final void method677(byte i) {
        ...
        if (anInt5537 != 0 && i > 125) {
            if (aByte5581 != 0) method688(5, true);
            method688(5, false);
    ...
    private final void method678(boolean bool, byte i) {
        if (6 * anInt5537 > (aHa_Sub2_5598.aClass348_Sub49_Sub1_7798.data).length) aHa_Sub2_5598.aClass348_Sub49_Sub1_7798 = new Class348_Sub49_Sub1(6 * (anInt5537 - -100));
        ...
        if (class348_sub49_sub1.pos != 0) {
            if (bool) {
                if (anInterface8_5647 == null) anInterface8_5647 = aHa_Sub2_5598.method3733(5123, -39, (class348_sub49_sub1.pos), (class348_sub49_sub1.data), true);
                else anInterface8_5647.method35(class348_sub49_sub1.data, 5123, i ^ 0x23, class348_sub49_sub1.pos);
                aClass270_5575.anInterface8_3463 = anInterface8_5647;
            } else aClass270_5575.anInterface8_3463 = (aHa_Sub2_5598.method3733(5123, i + -65, class348_sub49_sub1.pos, class348_sub49_sub1.data, false));
    ...
    final boolean method628(int i, int i_14_, Class101 class101, boolean bool, int i_15_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.MA(" + i + ',' + i_14_ + ',' + (class101 != null ? "{...}" : "null") + ',' + bool + ',' + i_15_ + ')'));
        }
    }

    private final boolean method679(int i, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_) {
        anInt5651++;
    ...
    final void method613(Class64 class64, int i, int i_42_, int i_43_, boolean bool) {
        try {
            ...
            if (anInt5632 != 0 && class64_sub3_44_.anInt5632 != 0) {
                ...
                if (!class64_sub3_44_.aBoolean5527) class64_sub3_44_.method692((byte) -123);
                                ...
                                if (i_72_ != -1) {
                                    for (int i_76_ = 0; (i_76_ < i_45_); i_76_++) {
                                        if (is[i_76_] == i_70_ && i_71_ == is_47_[i_76_] && is_46_[i_76_] == i_69_) {
                                            ...
                                            if (i_77_ != -1) {
                                                if (is_55_ == null) {
                                                    aClass139_5572 = new Class139();
                                                    is_55_ = aClass139_5572.aShortArray1954 = (Class50_Sub3.method470(aShortArray5564, (byte) -120));
                                                    is_53_ = aClass139_5572.aShortArray1951 = (Class50_Sub3.method470(aShortArray5583, (byte) -109));
                                                    is_52_ = aClass139_5572.aShortArray1953 = (Class50_Sub3.method470(aShortArray5576, (byte) -107));
                                                    is_54_ = aClass139_5572.aByteArray1948 = (Class309.method2309(-37, aByteArray5594));
                                                }
                                                if (is_58_ == null) {
                                                    Class139 class139 = (class64_sub3_44_.aClass139_5572 = new Class139());
                                                    is_58_ = class139.aShortArray1954 = (Class50_Sub3.method470(is_48_, (byte) -127));
                                                    is_57_ = class139.aShortArray1951 = (Class50_Sub3.method470(is_49_, (byte) -111));
                                                    is_59_ = class139.aShortArray1953 = (Class50_Sub3.method470(is_50_, (byte) -120));
                                                    is_56_ = class139.aByteArray1948 = (Class309.method2309(-91, is_51_));
                                                }
    ...
    final boolean method623(int i, int i_87_, Class101 class101, boolean bool, int i_88_, int i_89_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.OA(" + i + ',' + i_87_ + ',' + (class101 != null ? "{...}" : "null") + ',' + bool + ',' + i_88_ + ',' + i_89_ + ')'));
        }
    }
        ...
        if (aClass118Array5621 != null) {
            ...
            for (int i = 0; i < anInt5536; i++) {
                ...
                if (!class118.aBoolean1791 || !aHa_Sub2_5598.method3666()) {
                    ...
                    float f_92_ = (Class190.aFloat2555 + (f_91_ * Class313.aFloat3935 + (f_90_ * Class299_Sub1_Sub1.aFloat8696 + Class167.aFloat2203 * f)));
                    float f_93_ = (Class156.aFloat2111 + (Class215.aFloat2836 * f_91_ + (f_90_ * Class252.aFloat3242 + Class314.aFloat3943 * f)));
                    float f_94_ = (f * Class318_Sub9_Sub1.aFloat8784 + f_90_ * Class320.aFloat3994 + f_91_ * Class286_Sub8.aFloat6304 + Class49.aFloat4720);
    ...
    private final short method683(int i, int i_97_, long l, int i_98_, Class124 class124, int i_99_, float f, int i_100_, int i_101_, float f_102_) {
        try {
            anInt5599++;
            ...
            for (int i_106_ = i_103_; i_104_ > i_106_; i_106_++) {
                ...
                if (l == Class258_Sub2.aLongArray8530[i_106_]) return (short) (i_107_ - 1);
            }
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.R(" + i + ',' + i_97_ + ',' + l + ',' + i_98_ + ',' + (class124 != null ? "{...}" : "null") + ',' + i_99_ + ',' + f + ',' + i_100_ + ',' + i_101_ + ',' + f_102_ + ')'));
        }
    }
    ...
    private final boolean method684(boolean bool, int i, int i_108_, int i_109_, int i_110_, int i_111_, Class101 class101) {
        try {
            anInt5641++;
            ...
            for (int i_134_ = 0; i_134_ < 8; i_134_++) {
                ...
                float f_139_ = f_113_ + (Class314.aFloat3943 * f_137_ + Class252.aFloat3242 * f_136_ + Class215.aFloat2836 * f_135_);
                float f_140_ = f + (Class299_Sub1_Sub1.aFloat8696 * f_136_ + f_137_ * Class167.aFloat2203 + Class313.aFloat3935 * f_135_);
            ...
            if (bool_115_ && (float) i_111_ > f_116_ && (float) i_111_ < f_117_ && (float) i_109_ > f_118_ && (float) i_109_ < f_119_) {
                ...
                for (int i_144_ = 0; i_144_ < anInt5557; i_144_++) {
                    ...
                    float f_149_ = f + (f_147_ * Class299_Sub1_Sub1.aFloat8696 + f_145_ * Class167.aFloat2203 + Class313.aFloat3935 * f_146_);
                    float f_150_ = f_113_ + (Class252.aFloat3242 * f_147_ + f_145_ * Class314.aFloat3943 + f_146_ * Class215.aFloat2836);
                ...
                for (int i_161_ = 0; i_161_ < anInt5632; i_161_++) {
                    if (is[aShortArray5592[i_161_]] != -999999 && is[aShortArray5579[i_161_]] != -999999 && is[aShortArray5566[i_161_]] != -999999 && method679(i_109_, is[aShortArray5579[i_161_]], is[aShortArray5566[i_161_]], is_143_[aShortArray5579[i_161_]], is[aShortArray5592[i_161_]], is_143_[aShortArray5592[i_161_]], 125, i_111_, is_143_[aShortArray5566[i_161_]]))
                        return true;
                }
            }
            return false;
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("paa.SA(" + bool + ',' + i + ',' + i_108_ + ',' + i_109_ + ',' + i_110_ + ',' + i_111_ + ',' + (class101 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void O(int i, int i_162_, int i_163_) {
        ...
        for (int i_164_ = 0; anInt5557 > i_164_; i_164_++) {
            ...
            if (i_162_ != 128) anIntArray5593[i_164_] = anIntArray5593[i_164_] * i_162_ >> 7;
            if (i_163_ != 128) anIntArray5644[i_164_] = anIntArray5644[i_164_] * i_163_ >> 7;
        }
        if (aClass123_5605 != null) aClass123_5605.anInterface2_1811 = null;
        aBoolean5527 = false;
    }
    ...
    final r ba(r var_r) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, "paa.ba(" + (var_r != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final void method612() {
        ...
        if (anInt5529 > 0 && anInt5537 > 0) {
            method688(5, false);
            if ((aByte5581 & 0x10) == 0 && aClass270_5575.anInterface8_3463 == null) method678(false, (byte) 27);
            method691((byte) 124);
        }
    }
    ...
    private final void method685(byte i, r_Sub2 var_r_Sub2) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.U(" + i + ',' + (var_r_Sub2 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method624(int i, int i_195_, int i_196_, int i_197_) {
        ...
        for (int i_198_ = 0; anInt5632 > i_198_; i_198_++) {
            ...
            aShortArray5580[i_198_] = (short) (Class273.method2057(Class273.method2057(i_201_ << 7, i_200_ << 10), i_202_));
        }
        if (aClass118Array5621 != null) {
    ...
    private final Class64 method686(Class64_Sub3 class64_sub3_211_, int i, int i_212_, boolean bool, Class64_Sub3 class64_sub3_213_, boolean bool_214_) {
        try {
            ...
            if (bool_218_) {
                ...
                else if (class64_sub3_213_.anIntArray5543 != null && (class64_sub3_213_.anIntArray5543.length >= anInt5642)) class64_sub3_211_.anIntArray5543 = class64_sub3_213_.anIntArray5543;
                else class64_sub3_211_.anIntArray5543 = class64_sub3_213_.anIntArray5543 = new int[anInt5642];
                if (bool_216_) {
                    if (class64_sub3_213_.anIntArray5593 != null && (anInt5642 <= class64_sub3_213_.anIntArray5593.length)) class64_sub3_211_.anIntArray5593 = class64_sub3_213_.anIntArray5593;
                    else class64_sub3_211_.anIntArray5593 = class64_sub3_213_.anIntArray5593 = new int[anInt5642];
                } else class64_sub3_211_.anIntArray5593 = anIntArray5593;
                if (bool_217_) {
                    if (class64_sub3_213_.anIntArray5644 == null || (class64_sub3_213_.anIntArray5644.length < anInt5642)) class64_sub3_211_.anIntArray5644 = class64_sub3_213_.anIntArray5644 = new int[anInt5642];
            ...
            if (Class156.method1241(anInt5556, i, -119)) {
                ...
                if (aClass139_5572 == null) {
                    ...
                    if (class64_sub3_213_.aClass139_5572 == null) class64_sub3_213_.aClass139_5572 = new Class139();
                    Class139 class139 = (class64_sub3_211_.aClass139_5572 = class64_sub3_213_.aClass139_5572);
            ...
            } else if (Class137.method1163(anInt5556, (byte) -60, i)) class64_sub3_211_.aClass123_5620 = aClass123_5620;
            ...
            if (Class219.method1599((byte) -113, i, anInt5556)) {
                if (class64_sub3_213_.aClass48Array5596 != null && (class64_sub3_213_.aClass48Array5596.length >= anInt5536)) {
                    ...
                    class64_sub3_211_.aClass48Array5596 = class64_sub3_213_.aClass48Array5596 = new Class48[i_233_];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.K(" + (class64_sub3_211_ != null ? "{...}" : "null") + ',' + i + ',' + i_212_ + ',' + bool + ',' + (class64_sub3_213_ != null ? "{...}" : "null") + ',' + bool_214_ + ')'));
        }
    }
    ...
    final void wa() {
        for (int i = 0; i < anInt5642; i++) {
            ...
            anIntArray5644[i] = anIntArray5644[i] - -7 >> 4;
        }
        anInt5585++;
        if (aClass123_5605 != null) aClass123_5605.anInterface2_1811 = null;
        aBoolean5527 = false;
    ...
    final void method608(Class101 class101, Class318_Sub3 class318_sub3, int i, int i_235_) {
        try {
            ...
            if (anInt5529 != 0) {
                ...
                float f = (Class49.aFloat4720 + Class320.aFloat3994 * (float) aShort5591);
                float f_237_ = (Class320.aFloat3994 * (float) aShort5629 + Class49.aFloat4720);
                float f_238_;
                float f_239_;
                if (f > f_237_) {
                ...
                if (!(f_239_ >= aHa_Sub2_5598.aFloat7875) && !((float) aHa_Sub2_5598.anInt7826 >= f_238_)) {
                    ...
                    float f_241_ = (Class190.aFloat2555 + ((float) aShort5629 * Class299_Sub1_Sub1.aFloat8696));
                    float f_242_;
                    float f_243_;
                    if (f_240_ > f_241_) {
                    ...
                    if (!(aHa_Sub2_5598.aFloat7835 <= f_243_ / (float) i) && !(f_242_ / (float) i <= aHa_Sub2_5598.aFloat7872)) {
                        ...
                        float f_245_ = (Class156.aFloat2111 + (float) aShort5629 * Class252.aFloat3242);
                        float f_246_;
                        float f_247_;
                        if (f_245_ < f_244_) {
                        ...
                        if (!(f_247_ / (float) i >= aHa_Sub2_5598.aFloat7830) && !(aHa_Sub2_5598.aFloat7836 >= f_246_ / (float) i)) {
                            ...
                            if (class318_sub3 != null) {
                                ...
                                int i_250_ = (int) (((float) aShort5591 * Class299_Sub1_Sub1.aFloat8696) + (((float) i_248_ * Class167.aFloat2203) + Class190.aFloat2555) + (Class313.aFloat3935 * (float) i_249_));
                                int i_251_ = (int) (Class156.aFloat2111 + ((float) i_248_ * Class314.aFloat3943) + (Class252.aFloat3242 * (float) aShort5591) + (Class215.aFloat2836 * (float) i_249_));
                                ...
                                int i_253_ = (int) ((Class313.aFloat3935 * (float) i_249_) + ((Class299_Sub1_Sub1.aFloat8696 * (float) aShort5629) + (Class190.aFloat2555 + (Class167.aFloat2203 * (float) i_248_))));
                                int i_254_ = (int) (Class156.aFloat2111 + (Class314.aFloat3943 * (float) i_248_) + (Class252.aFloat3242 * (float) aShort5629) + ((float) i_249_ * Class215.aFloat2836));
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.Q(" + (class101 != null ? "{...}" : "null") + ',' + (class318_sub3 != null ? "{...}" : "null") + ',' + i + ',' + i_235_ + ')'));
        }
    }
    ...
    static final void method687(byte i, int i_282_) {
        ...
        anInt5570++;
        Class348_Sub42_Sub15 class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(i_282_, (byte) 105, 5);
    ...
    private final void method688(int i, boolean bool) {
        ...
        if (i == 5) {
            ...
            if (i_295_ != 0) {
                if (anInt5529 * i_295_ > (aHa_Sub2_5598.aClass348_Sub49_Sub1_7798.data).length) aHa_Sub2_5598.aClass348_Sub49_Sub1_7798 = new Class348_Sub49_Sub1(i_295_ * (100 + anInt5529));
                else aHa_Sub2_5598.aClass348_Sub49_Sub1_7798.pos = 0;
                Class348_Sub49_Sub1 class348_sub49_sub1 = aHa_Sub2_5598.aClass348_Sub49_Sub1_7798;
                if (bool_293_) {
                    if (aHa_Sub2_5598.aBoolean7775) {
                        for (int i_300_ = 0; anInt5557 > i_300_; i_300_++) {
                            ...
                            int i_303_ = (Stream.floatToRawIntBits((float) anIntArray5644[i_300_]));
                            ...
                            for (int i_306_ = i_304_; i_306_ < i_305_; i_306_++) {
                                ...
                                if (i_307_ == -1) break;
                                class348_sub49_sub1.pos = i_295_ * i_307_;
                        ...
                        for (int i_308_ = 0; anInt5557 > i_308_; i_308_++) {
                            int i_309_ = (Stream.floatToRawIntBits((float) anIntArray5543[i_308_]));
                            int i_310_ = (Stream.floatToRawIntBits((float) anIntArray5593[i_308_]));
                            int i_311_ = (Stream.floatToRawIntBits((float) anIntArray5644[i_308_]));
                            ...
                            for (int i_314_ = i_312_; i_314_ < i_313_; i_314_++) {
                                ...
                                if (i_315_ == -1) break;
                                class348_sub49_sub1.pos = i_295_ * i_315_;
                ...
                if (bool_291_) {
                    if (aClass123_5563 == null) {
                        ...
                        for (int i_324_ = 0; anInt5632 > i_324_; i_324_++) {
                            ...
                            class348_sub49_sub1.pos = i_329_ * i_295_ + i_297_;
                            ...
                            class348_sub49_sub1.pos = i_297_ - -(i_329_ * i_295_);
                            if (i_335_ < 0) i_335_ = 0;
                            else if (i_335_ > 255) i_335_ = 255;
                            class348_sub49_sub1.writeByte(false, i_333_);
                            class348_sub49_sub1.writeByte(false, i_334_);
                            ...
                            class348_sub49_sub1.pos = i_295_ * i_329_ + i_297_;
                            class348_sub49_sub1.writeByte(false, i_333_);
                            class348_sub49_sub1.writeByte(false, i_334_);
                            class348_sub49_sub1.writeByte(false, i_335_);
                        ...
                        for (int i_336_ = 0; i_336_ < anInt5632; i_336_++) {
                            ...
                            class348_sub49_sub1.pos = i_297_ + aShortArray5592[i_336_] * i_295_;
                            class348_sub49_sub1.writeInt((byte) 105, i_337_);
                            class348_sub49_sub1.pos = i_297_ - -(aShortArray5579[i_336_] * i_295_);
                            class348_sub49_sub1.writeInt((byte) 87, i_337_);
                            class348_sub49_sub1.pos = i_297_ - -(i_295_ * aShortArray5566[i_336_]);
                ...
                if (bool_292_) {
                    ...
                    if (aHa_Sub2_5598.aBoolean7775) {
                        for (int i_345_ = 0; anInt5529 > i_345_; i_345_++) {
                            ...
                            class348_sub49_sub1.pos += -12 + i_295_;
                        }
                    } else {
                ...
                if (bool_294_) {
                    ...
                    if (aHa_Sub2_5598.aBoolean7775) {
                        for (int i_348_ = 0; i_348_ < anInt5529; i_348_++) {
                            ...
                            class348_sub49_sub1.pos += i_295_ + -8;
                        }
                    } else {
                        for (int i_349_ = 0; i_349_ < anInt5529; i_349_++) {
                            ...
                            class348_sub49_sub1.pos += -8 + i_295_;
                        }
                    }
                }
                class348_sub49_sub1.pos = anInt5529 * i_295_;
                Interface2 interface2;
                if (bool) {
                    if (anInterface2_5554 != null) anInterface2_5554.method11(i_295_, class348_sub49_sub1.pos, (class348_sub49_sub1.data), -9894);
                    else anInterface2_5554 = aHa_Sub2_5598.method3731(2, true, i_295_, (class348_sub49_sub1.data), (class348_sub49_sub1.pos));
                    interface2 = anInterface2_5554;
                    aByte5581 = (byte) 0;
                } else {
                    interface2 = aHa_Sub2_5598.method3731(2, false, i_295_, (class348_sub49_sub1.data), (class348_sub49_sub1.pos));
                    aBoolean5555 = true;
                }
                if (bool_293_) {
    ...
    final void method615(Class101 class101, Class318_Sub3 class318_sub3, int i) {
        try {
            ...
            if (anInt5529 != 0) {
                ...
                float f = (Class49.aFloat4720 + Class320.aFloat3994 * (float) aShort5591);
                float f_351_ = (Class320.aFloat3994 * (float) aShort5629 + Class49.aFloat4720);
                float f_352_;
                float f_353_;
                if (f > f_351_) {
                ...
                if (!(aHa_Sub2_5598.aFloat7874 <= f_352_) && !((float) aHa_Sub2_5598.anInt7826 >= f_353_)) {
                    ...
                    float f_355_ = ((float) aShort5629 * Class299_Sub1_Sub1.aFloat8696 + Class190.aFloat2555);
                    float f_356_;
                    float f_357_;
                    if (f_354_ > f_355_) {
                    ...
                    if (!(aHa_Sub2_5598.aFloat7835 <= f_356_ / f_353_) && !(f_357_ / f_353_ <= aHa_Sub2_5598.aFloat7872)) {
                        ...
                        float f_359_ = (Class156.aFloat2111 + (float) aShort5629 * Class252.aFloat3242);
                        float f_360_;
                        float f_361_;
                        if (f_358_ > f_359_) {
                        ...
                        if (!(f_361_ / f_353_ >= aHa_Sub2_5598.aFloat7830) && !(aHa_Sub2_5598.aFloat7836 >= f_360_ / f_353_)) {
                            ...
                            if (class318_sub3 != null) {
                                ...
                                int i_365_ = (int) (((float) i_364_ * Class313.aFloat3935) + ((Class167.aFloat2203 * (float) i_363_) + Class190.aFloat2555 + ((float) aShort5591 * (Class299_Sub1_Sub1.aFloat8696))));
                                int i_366_ = (int) (Class156.aFloat2111 + ((float) i_363_ * Class314.aFloat3943) + ((float) aShort5591 * Class252.aFloat3242) + ((float) i_364_ * Class215.aFloat2836));
                                ...
                                int i_368_ = (int) (Class190.aFloat2555 + (Class167.aFloat2203 * (float) i_363_) + (Class299_Sub1_Sub1.aFloat8696 * (float) aShort5629) + (Class313.aFloat3935 * (float) i_364_));
                                int i_369_ = (int) (((float) i_364_ * Class215.aFloat2836) + ((Class252.aFloat3242 * (float) aShort5629) + (Class156.aFloat2111 + (Class314.aFloat3943 * (float) i_363_))));
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.KA(" + (class101 != null ? "{...}" : "null") + ',' + (class318_sub3 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }
    ...
    private final void method691(byte i) {
        ...
        if (aBoolean5555) {
            ...
            if (aClass129Array5640 == null && aClass342Array5541 == null && aClass118Array5621 == null) {
                if (anIntArray5543 != null && !Class337.method2659((byte) 123, anInt5648, anInt5556)) {
                    if (aClass123_5605 == null || (aClass123_5605.anInterface2_1811 != null)) {
                        if (!aBoolean5527) method692((byte) -123);
                        anIntArray5543 = null;
            ...
            if (aByteArray5542 != null && !Class239_Sub28.method1846(anInt5556, anInt5648, 74)) {
                if (aClass123_5610 == null || aClass123_5610.anInterface2_1811 != null) aByteArray5542 = null;
                else aBoolean5555 = true;
            }
            if (aFloatArray5552 != null && !Class98.method877(anInt5648, anInt5556, (byte) -127)) {
            ...
            if (anIntArrayArray5553 != null && !Class40.method371(anInt5648, 256, anInt5556)) {
                aShortArray5573 = null;
                anIntArrayArray5553 = null;
            }
            if (anIntArrayArray5539 != null && !Class312.method2332(anInt5556, (byte) 124, anInt5648)) {
            ...
            try {
                ...
                if (aClass129Array5640 != null) {
                    for (int i = 0; i < aClass129Array5640.length; i++) {
                        ...
                        class129_384_.anInt1882 = (int) (class101_sub3.aFloat5747 + (((float) (anIntArray5593[(class129.anInt1881)]) * (class101_sub3.aFloat5750)) + ((class101_sub3.aFloat5770) * (float) (anIntArray5543[(class129.anInt1881)])) + ((float) (anIntArray5644[(class129.anInt1881)]) * (class101_sub3.aFloat5781))));
                        class129_384_.anInt1891 = (int) (class101_sub3.aFloat5772 + (((float) (anIntArray5593[(class129.anInt1881)]) * (class101_sub3.aFloat5769)) + ((class101_sub3.aFloat5761) * (float) (anIntArray5543[(class129.anInt1881)])) + ((float) (anIntArray5644[(class129.anInt1881)]) * (class101_sub3.aFloat5762))));
                        class129_384_.anInt1889 = (int) (class101_sub3.aFloat5751 + (((float) (anIntArray5543[(class129.anInt1881)]) * (class101_sub3.aFloat5756)) + ((class101_sub3.aFloat5754) * (float) (anIntArray5593[(class129.anInt1881)])) + ((float) (anIntArray5644[(class129.anInt1881)]) * (class101_sub3.aFloat5784))));
                        class129_384_.anInt1883 = (int) (class101_sub3.aFloat5747 + (((class101_sub3.aFloat5770) * (float) (anIntArray5543[(class129.anInt1877)])) + ((float) (anIntArray5593[(class129.anInt1877)]) * (class101_sub3.aFloat5750)) + ((float) (anIntArray5644[(class129.anInt1877)]) * (class101_sub3.aFloat5781))));
                        class129_384_.anInt1890 = (int) (class101_sub3.aFloat5772 + (((class101_sub3.aFloat5762) * (float) (anIntArray5644[(class129.anInt1877)])) + (((float) (anIntArray5543[(class129.anInt1877)]) * (class101_sub3.aFloat5761)) + ((float) (anIntArray5593[(class129.anInt1877)]) * class101_sub3.aFloat5769))));
                        class129_384_.anInt1880 = (int) (class101_sub3.aFloat5751 + (((class101_sub3.aFloat5784) * (float) (anIntArray5644[(class129.anInt1877)])) + (((class101_sub3.aFloat5754) * (float) (anIntArray5593[(class129.anInt1877)])) + ((float) (anIntArray5543[(class129.anInt1877)]) * class101_sub3.aFloat5756))));
                        class129_384_.anInt1876 = (int) (class101_sub3.aFloat5747 + (((float) (anIntArray5593[(class129.anInt1892)]) * (class101_sub3.aFloat5750)) + ((float) (anIntArray5543[(class129.anInt1892)]) * (class101_sub3.aFloat5770)) + ((class101_sub3.aFloat5781) * (float) (anIntArray5644[(class129.anInt1892)]))));
                        class129_384_.anInt1874 = (int) (class101_sub3.aFloat5772 + (((float) (anIntArray5644[(class129.anInt1892)]) * (class101_sub3.aFloat5762)) + (((class101_sub3.aFloat5761) * (float) (anIntArray5543[(class129.anInt1892)])) + ((class101_sub3.aFloat5769) * (float) (anIntArray5593[(class129.anInt1892)])))));
                        class129_384_.anInt1884 = (int) (((class101_sub3.aFloat5754) * (float) (anIntArray5593[(class129.anInt1892)])) + ((class101_sub3.aFloat5756) * (float) (anIntArray5543[(class129.anInt1892)])) + ((float) (anIntArray5644[(class129.anInt1892)]) * (class101_sub3.aFloat5784)) + (class101_sub3.aFloat5751));
                    }
                }
                ...
                for (int i = 0; aClass342Array5541.length > i; i++) {
                    ...
                    class342_385_.anInt4238 = (int) (class101_sub3.aFloat5747 + (((float) (anIntArray5644[(class342.anInt4244)]) * (class101_sub3.aFloat5781)) + (((float) (anIntArray5543[(class342.anInt4244)]) * (class101_sub3.aFloat5770)) + ((class101_sub3.aFloat5750) * (float) (anIntArray5593[(class342.anInt4244)])))));
                    class342_385_.anInt4239 = (int) (class101_sub3.aFloat5772 + (((float) (anIntArray5593[(class342.anInt4244)]) * (class101_sub3.aFloat5769)) + ((class101_sub3.aFloat5761) * (float) (anIntArray5543[(class342.anInt4244)])) + ((float) (anIntArray5644[(class342.anInt4244)]) * (class101_sub3.aFloat5762))));
                ...
                throw Class348_Sub17.method2929(runtimeexception, "paa.J(" + (class101 != null ? "{...}" : "null") + ')');
            }
            break;
        } while (false);
    }
    ...
    final void method605(int i, int[] is, int i_386_, int i_387_, int i_388_, int i_389_, boolean bool) {
        try {
                    ...
                    for (int i_457_ = 0; i_390_ > i_457_; i_457_++) {
                        ...
                        if (i_458_ < anIntArrayArray5553.length) {
                            ...
                            for (int i_460_ = 0; i_460_ < is_459_.length; i_460_++) {
                                ...
                                aShortArray5580[i_461_] = (short) (Class273.method2057((Class273.method2057(i_464_ << 7, i_463_ << 10)), i_465_));
                            }
                    ...
                    for (int i_467_ = 0; i_467_ < i_390_; i_467_++) {
                        ...
                        if (i_468_ < anIntArrayArray5627.length) {
                            ...
                            for (int i_470_ = 0; i_470_ < is_469_.length; i_470_++) {
                                Class48 class48 = aClass48Array5596[is_469_[i_470_]];
                    ...
                    for (int i_471_ = 0; i_471_ < i_390_; i_471_++) {
                        ...
                        if (i_472_ < anIntArrayArray5627.length) {
                            ...
                            for (int i_474_ = 0; (i_474_ < is_473_.length); i_474_++) {
                                Class48 class48 = aClass48Array5596[is_473_[i_474_]];
                    ...
                    for (int i_475_ = 0; i_475_ < i_390_; i_475_++) {
                        ...
                        if (anIntArrayArray5627.length > i_476_) {
                            ...
                            for (int i_478_ = 0; is_477_.length > i_478_; i_478_++) {
                                Class48 class48 = aClass48Array5596[is_477_[i_478_]];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.BB(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_386_ + ',' + i_387_ + ',' + i_388_ + ',' + i_389_ + ',' + bool + ')'));
        }
    }
    ...
    final void P(int i, int i_479_, int i_480_, int i_481_) {
        ...
        if (i == 0) {
            ...
            for (int i_499_ = 0; anInt5632 > i_499_; i_499_++) {
                ...
                aShortArray5580[i_499_] = (short) (Class273.method2057(i_503_, Class273.method2057(i_502_ << 7, i_501_ << 10)));
            }
            if (aClass123_5610 != null) aClass123_5610.anInterface2_1811 = null;
            if (aClass118Array5621 != null) {
    ...
    final void method610(Class101 class101, int i, boolean bool) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.za(" + (class101 != null ? "{...}" : "null") + ',' + i + ',' + bool + ')'));
        }
    }
    ...
    final void I(int i, int[] is, int i_510_, int i_511_, int i_512_, boolean bool, int i_513_, int[] is_514_) {
        try {
            ...
            if (i == 0) {
                ...
                if (is_514_ == null) {
                    ...
                    if (Class348_Sub42_Sub16_Sub1.aBoolean10450) {
                        int i_568_ = ((za.anInt7275 * is_514_[0] - -(is_514_[3] * Class221.anInt2880) - -(is_514_[6] * Class181.anInt2398) - -8192) >> 14);
                        int i_569_ = ((is_514_[1] * za.anInt7275 - -(Class221.anInt2880 * is_514_[4]) - (-(is_514_[7] * Class181.anInt2398) - 8192)) >> 14);
                        i_568_ += i_565_;
                        i_569_ += i_566_;
                        int i_570_ = (8192 + (Class181.anInt2398 * is_514_[8] + is_514_[2] * za.anInt7275 + is_514_[5] * Class221.anInt2880) >> 14);
                        i_570_ += i_567_;
                        za.anInt7275 = i_568_;
                    ...
                    int i_580_ = ((is_571_[1] * -Class221.anInt2880 + -za.anInt7275 * is_571_[0] - (-(-Class181.anInt2398 * is_571_[2]) + -8192)) >> 14);
                    int i_581_ = ((-za.anInt7275 * is_571_[3] + is_571_[4] * -Class221.anInt2880 - -(is_571_[5] * -Class181.anInt2398) + 8192) >> 14);
                    int i_582_ = ((-Class181.anInt2398 * is_571_[8] + (is_571_[6] * -za.anInt7275 - -(is_571_[7] * -Class221.anInt2880)) - -8192) >> 14);
                        ...
                        if (i_603_ < anIntArrayArray5539.length) {
                            ...
                            for (int i_605_ = 0; (i_605_ < is_604_.length); i_605_++) {
                                ...
                                if (aShortArray5608 == null || (aShortArray5608[i_606_] & i_513_) != 0) {
                                    int i_607_ = ((8192 + (is_594_[2] * anIntArray5644[i_606_]) + ((is_594_[1] * anIntArray5593[i_606_]) + (is_594_[0] * anIntArray5543[i_606_]))) >> 14);
                                    int i_608_ = ((is_594_[5] * anIntArray5644[i_606_] + ((anIntArray5543[i_606_] * is_594_[3]) + (is_594_[4] * anIntArray5593[i_606_])) + 8192) >> 14);
                                    i_607_ += i_599_;
                                    i_608_ += i_600_;
                                    int i_609_ = ((8192 + (is_594_[8] * anIntArray5644[i_606_]) + ((anIntArray5543[i_606_] * is_594_[6]) + (is_594_[7] * anIntArray5593[i_606_]))) >> 14);
                                    i_609_ += i_601_;
                ...
                if (is_514_ == null) {
                    ...
                    if (Class348_Sub42_Sub16_Sub1.aBoolean10450) {
                        int i_616_ = (8192 + (za.anInt7275 * is_514_[0] - -(Class221.anInt2880 * is_514_[3]) - -(is_514_[6] * Class181.anInt2398)) >> 14);
                        int i_617_ = (8192 + (is_514_[7] * Class181.anInt2398 + (Class221.anInt2880 * is_514_[4] + is_514_[1] * za.anInt7275)) >> 14);
                        i_617_ += i_614_;
                        int i_618_ = ((is_514_[5] * Class221.anInt2880 + za.anInt7275 * is_514_[2] + is_514_[8] * Class181.anInt2398 - -8192) >> 14);
                        i_616_ += i_613_;
                    ...
                    int i_623_ = i_620_ * -Class221.anInt2880 + 8192 >> 14;
                    int i_624_ = -Class181.anInt2398 * i_621_ - -8192 >> 14;
                        ...
                        if (anIntArrayArray5539.length > i_641_) {
                            ...
                            for (int i_643_ = 0; is_642_.length > i_643_; i_643_++) {
                                ...
                                if (aShortArray5608 == null || (aShortArray5608[i_644_] & i_513_) != 0) {
                                    int i_645_ = ((8192 + (is_632_[1] * anIntArray5593[i_644_]) + ((is_632_[0] * anIntArray5543[i_644_]) + (is_632_[2] * anIntArray5644[i_644_]))) >> 14);
                                    int i_646_ = ((is_632_[4] * anIntArray5593[i_644_] + (anIntArray5543[i_644_] * is_632_[3]) - (-(is_632_[5] * anIntArray5644[i_644_]) - 8192)) >> 14);
                                    i_645_ += i_637_;
                                    i_646_ += i_638_;
                                    int i_647_ = ((is_632_[7] * anIntArray5593[i_644_] + (is_632_[6] * anIntArray5543[i_644_]) - -(is_632_[8] * anIntArray5644[i_644_]) - -8192) >> 14);
                        ...
                        if (anIntArrayArray5553.length > i_661_) {
                            ...
                            for (int i_663_ = 0; (is_662_.length > i_663_); i_663_++) {
                                ...
                                if (aShortArray5573 == null || (aShortArray5573[i_664_] & i_513_) != 0) {
                                    ...
                                    aShortArray5580[i_664_] = (short) (Class273.method2057(i_668_, (Class273.method2057(i_666_ << 10, i_667_ << 7))));
                                    if (aClass123_5610 != null) aClass123_5610.anInterface2_1811 = null;
                                }
                            }
                        }
                    ...
                    for (int i_670_ = 0; i_515_ > i_670_; i_670_++) {
                        ...
                        if (i_671_ < anIntArrayArray5627.length) {
                            ...
                            for (int i_673_ = 0; is_672_.length > i_673_; i_673_++) {
                                Class48 class48 = aClass48Array5596[is_672_[i_673_]];
                    ...
                    for (int i_674_ = 0; i_674_ < i_515_; i_674_++) {
                        ...
                        if (i_675_ < anIntArrayArray5627.length) {
                            ...
                            for (int i_677_ = 0; i_677_ < is_676_.length; i_677_++) {
                                Class48 class48 = aClass48Array5596[is_676_[i_677_]];
                    ...
                    for (int i_678_ = 0; i_678_ < i_515_; i_678_++) {
                        ...
                        if (i_679_ < anIntArrayArray5627.length) {
                            ...
                            for (int i_681_ = 0; is_680_.length > i_681_; i_681_++) {
                                Class48 class48 = aClass48Array5596[is_680_[i_681_]];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("paa.I(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_510_ + ',' + i_511_ + ',' + i_512_ + ',' + bool + ',' + i_513_ + ',' + (is_514_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    Class64_Sub3(ha_Sub2 var_ha_Sub2, Class124 class124, int i, int i_695_, int i_696_, int i_697_) {
        aBoolean5527 = false;
        anInt5529 = 0;
        anInt5632 = 0;
        anInt5557 = 0;
            ...
            try {
                ...
                for (int i_698_ = 0; (i_698_ < class124.anInt1817); i_698_++) {
                    if (class124.aByteArray1843 == null || class124.aByteArray1843[i_698_] != 2) {
                        if (class124.aShortArray1822 != null && (class124.aShortArray1822[i_698_] != -1)) {
                            Class12 class12 = var_d.method3(((class124.aShortArray1822[i_698_]) & 0xffff), -6662);
                ...
                for (int i_699_ = 0; anInt5632 > i_699_; i_699_++) {
                    ...
                    if (class124.aClass162Array1832 != null) {
                        ...
                        for (int i_706_ = 0; (class124.aClass162Array1832.length > i_706_); i_706_++) {
                            Class162 class162 = (class124.aClass162Array1832[i_706_]);
                            if (i_700_ == class162.anInt2155) {
                                ...
                                if (class189.anInt2525 != -1) {
                                    Class12 class12_707_ = var_d.method3((class189.anInt2525), -6662);
                ...
                if (class124.aClass162Array1832 != null) {
                    ...
                    for (int i_711_ = 0; anInt5536 > i_711_; i_711_++) {
                        Class162 class162 = class124.aClass162Array1832[i_711_];
                        Class189 class189 = Class73.method742(104, (class162.anInt2153));
                        int i_712_ = -1;
                        ...
                        int i_714_ = ((Class10.anIntArray179[0xffff & (class124.aShortArray1862[class162.anInt2155])]) & 0xffffff);
                        i_714_ = i_714_ | (255 + -((class124.aByteArray1834) == null ? 0 : (class124.aByteArray1834[(class162.anInt2155)])) << 24);
                        aClass118Array5621[i_711_] = new Class118(i_712_, (class124.aShortArray1863[class162.anInt2155]), (class124.aShortArray1835[class162.anInt2155]), (class124.aShortArray1855[class162.anInt2155]), class189.anInt2526, class189.anInt2530, class189.anInt2525, class189.anInt2533, class189.anInt2534, class189.aBoolean2531, class189.aBoolean2522, class162.anInt2158);
                ...
                Class358 class358 = Class59_Sub2_Sub1.method565(255, anInt5632, class124, is);
                Class347[] class347s = new Class347[class124.anInt1817];
                for (int i_719_ = 0; class124.anInt1817 > i_719_; i_719_++) {
                    ...
                    int i_723_ = anIntArray5543[i_721_] + -anIntArray5543[i_720_];
                    int i_724_ = anIntArray5593[i_721_] - anIntArray5593[i_720_];
                    int i_725_ = -anIntArray5644[i_720_] + anIntArray5644[i_721_];
                    int i_726_ = -anIntArray5543[i_720_] + anIntArray5543[i_722_];
                    int i_727_ = anIntArray5593[i_722_] + -anIntArray5593[i_720_];
                    int i_728_ = -anIntArray5644[i_720_] + anIntArray5644[i_722_];
                ...
                for (int i_734_ = 0; anInt5632 > i_734_; i_734_++) {
                    ...
                    if (i_739_ != -1 && (0x40 & anInt5556) != 0) {
                        Class12 class12 = var_d.method3(i_739_ & 0xffff, -6662);
                        ...
                        if (i_737_ == -1) {
                            ...
                            if (i_748_ == 0) {
                                ...
                                if (i_748_ == 1) {
                                    ...
                                    Class246.method1885(i_785_, (class124.anIntArray1852[i_780_]), i_786_, 8, (class124.anIntArray1841[i_780_]), Class152.aFloatArray2075, (class124.anIntArray1847[i_780_]), f_787_, i_784_, i_783_, f_805_, fs);
                                    f = Class152.aFloatArray2075[0];
                                    f_740_ = Class152.aFloatArray2075[1];
                                    Class246.method1885(i_785_, (class124.anIntArray1852[i_781_]), i_786_, 8, (class124.anIntArray1841[i_781_]), Class152.aFloatArray2075, (class124.anIntArray1847[i_781_]), f_787_, i_784_, i_783_, f_805_, fs);
                                    f_741_ = Class152.aFloatArray2075[0];
                                    f_742_ = Class152.aFloatArray2075[1];
                                    Class246.method1885(i_785_, (class124.anIntArray1852[i_782_]), i_786_, 8, (class124.anIntArray1841[i_782_]), Class152.aFloatArray2075, (class124.anIntArray1847[i_782_]), f_787_, i_784_, i_783_, f_805_, fs);
                                    ...
                                    f_740_ = Class152.aFloatArray2075[1];
                                    f = Class152.aFloatArray2075[0];
                                    Class262.method1991(f_789_, f_787_, fs, (class124.anIntArray1852[i_781_]), i_785_, false, i_786_, i_783_, (class124.anIntArray1841[i_781_]), (class124.anIntArray1847[i_781_]), f_788_, Class152.aFloatArray2075, i_784_, i_747_);
                                    f_742_ = Class152.aFloatArray2075[1];
                                    f_741_ = Class152.aFloatArray2075[0];
                                    Class262.method1991(f_789_, f_787_, fs, (class124.anIntArray1852[i_782_]), i_785_, false, i_786_, i_783_, (class124.anIntArray1841[i_782_]), (class124.anIntArray1847[i_782_]), f_788_, Class152.aFloatArray2075, i_784_, i_747_);
                                    f_743_ = Class152.aFloatArray2075[0];
                                    f_744_ = Class152.aFloatArray2075[1];
                                } else if (i_748_ == 3) {
                                    Class181.method1367(i_785_, i_786_, f_787_, (class124.anIntArray1841[i_780_]), Class152.aFloatArray2075, (class124.anIntArray1852[i_780_]), i_783_, (class124.anIntArray1847[i_780_]), i_784_, -4, fs);
                                    f_740_ = Class152.aFloatArray2075[1];
                                    f = Class152.aFloatArray2075[0];
                                    Class181.method1367(i_785_, i_786_, f_787_, (class124.anIntArray1841[i_781_]), Class152.aFloatArray2075, (class124.anIntArray1852[i_781_]), i_783_, (class124.anIntArray1847[i_781_]), i_784_, -4, fs);
                                    f_741_ = Class152.aFloatArray2075[0];
                                    f_742_ = Class152.aFloatArray2075[1];
                                    Class181.method1367(i_785_, i_786_, f_787_, (class124.anIntArray1841[i_782_]), Class152.aFloatArray2075, (class124.anIntArray1852[i_782_]), i_783_, (class124.anIntArray1847[i_782_]), i_784_, -4, fs);
                                    f_744_ = Class152.aFloatArray2075[1];
                                    f_743_ = Class152.aFloatArray2075[0];
                                    if ((0x1 & i_786_) == 0) {
                                        if (-f + f_743_ > 0.5F) {
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("paa.<init>(" + (var_ha_Sub2 != null ? "{...}" : "null") + ',' + (class124 != null ? "{...}" : "null") + ',' + i + ',' + i_695_ + ',' + i_696_ + ',' + i_697_ + ')'));
            }
            break;
        } while (false);
    }
