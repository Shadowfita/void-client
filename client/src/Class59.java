...
abstract class Class59 {
    ...
    final void method542(int i, int i_6_, int i_7_, int i_8_) {
        ...
        for (int i_10_ = 0; i_10_ < i_6_; i_10_++)
            is[i_10_] = (i_10_ << 12) / i_6_;
        int[] is_11_ = new int[i_8_];
        for (int i_12_ = 0; i > i_12_; i_12_++)
            is_9_[i_12_] = (i_12_ << 12) / i;
        for (int i_13_ = i_7_; i_13_ < i_8_; i_13_++)
            is_11_[i_13_] = (i_13_ << 12) / i_8_;
        method543(true);
        for (int i_14_ = 0; i_8_ > i_14_; i_14_++) {
            for (int i_15_ = 0; i > i_15_; i_15_++) {
                for (int i_16_ = 0; i_6_ > i_16_; i_16_++) {
                    for (int i_17_ = 0; (this.anInt1071 > i_17_); i_17_++) {
                        int i_18_ = aShortArray1069[i_17_] << 12;
                        int i_19_ = i_18_ * is_11_[i_14_] >> 12;
                        int i_20_ = anInt1074 * i_18_ >> 12;
                        int i_21_ = anInt1078 * i_18_ >> 12;
                        int i_22_ = is[i_16_] * i_18_ >> 12;
                        int i_23_ = i_18_ * anInt1079 >> 12;
                        int i_24_ = i_18_ * is_9_[i_15_] >> 12;
                        i_22_ *= anInt1079;
                        i_24_ *= anInt1078;
                        i_19_ *= anInt1074;
                        int i_25_ = i_22_ >> 12;
                        ...
                        int i_43_ = Class301.method2279(true, (aShortArray1082[i_25_ - -i_42_]), i_19_, i_24_, i_22_);
                        int i_44_ = Class301.method2279(true, (aShortArray1082[i_26_ + i_42_]), i_19_, i_24_, i_33_);
                        int i_45_ = i_43_ - -((i_44_ - i_43_) * i_35_ >> 12);
                        i_43_ = Class301.method2279(true, (aShortArray1082[i_39_ + i_25_]), i_19_, i_31_, i_22_);
                        i_44_ = Class301.method2279(true, (aShortArray1082[i_26_ + i_39_]), i_19_, i_31_, i_33_);
                        int i_46_ = i_43_ + ((i_44_ + -i_43_) * i_35_ >> 12);
                        i_43_ = Class301.method2279(true, (aShortArray1082[i_40_ + i_25_]), i_37_, i_24_, i_22_);
                        int i_47_ = ((i_46_ + -i_45_) * i_36_ >> 12) + i_45_;
                        i_44_ = Class301.method2279(true, (aShortArray1082[i_40_ + i_26_]), i_37_, i_24_, i_33_);
                        i_45_ = i_43_ + (i_35_ * (i_44_ - i_43_) >> 12);
                        i_43_ = Class301.method2279(true, (aShortArray1082[i_25_ - -i_41_]), i_37_, i_31_, i_22_);
                        i_44_ = Class301.method2279(true, (aShortArray1082[i_26_ - -i_41_]), i_37_, i_31_, i_33_);
                        i_46_ = (((-i_43_ + i_44_) * i_35_ >> 12) + i_43_);
                        int i_48_ = ((i_46_ - i_45_) * i_36_ >> 12) + i_45_;
                        method546(i_47_ + ((-i_47_ + i_48_) * i_34_ >> 12), i_17_, i_7_ ^ ~0x1);
                    }
    ...
    static final int method547(String string, int i) {
        ...
        if (!Class167.aClass45_2208.method413(i ^ 0x1d48, string_53_)) return Class167.aClass45_2208.method397(string_53_, 0);
