...
final class Class101_Sub2 extends Class101 {
    ...
    final void method902(int i) {
        ...
        anInt5712++;
        this.aFloat5711 = this.aFloat5722 = Class239_Sub4.aFloatArray5876[0x3fff & i];
        this.aFloat5708 = Class239_Sub4.aFloatArray5874[i & 0x3fff];
    ...
    final void method894(int i, int i_2_, int i_3_) {
        ...
        this.aFloat5711 = this.aFloat5722 = this.aFloat5716 = 1.0F;
        this.aFloat5710 = (float) i_2_;
        this.aFloat5729 = (float) i;
        anInt5706++;
        this.aFloat5708 = this.aFloat5736 = this.aFloat5700 = this.aFloat5691 = this.aFloat5704 = this.aFloat5732 = 0.0F;
    }

    final void method910() {
        this.aFloat5711 = this.aFloat5722 = this.aFloat5716 = 1.0F;
        this.aFloat5708 = this.aFloat5736 = this.aFloat5700 = this.aFloat5691 = this.aFloat5704 = this.aFloat5732 = this.aFloat5729 = this.aFloat5710 = this.aFloat5724 = 0.0F;
        anInt5696++;
    }
    ...
    final void method903(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        ...
        this.aFloat5729 = (-(this.aFloat5704 * (float) i_5_) + (-((float) i_4_ * this.aFloat5700) + this.aFloat5711 * (float) -i));
        this.aFloat5710 = ((float) -i * this.aFloat5708 - this.aFloat5722 * (float) i_4_ - (float) i_5_ * this.aFloat5732);
        this.aFloat5724 = (-(this.aFloat5716 * (float) i_5_) + (this.aFloat5736 * (float) -i - this.aFloat5691 * (float) i_4_));
    }

    final void method895(int i) {
        this.aFloat5722 = 1.0F;
        anInt5738++;
        this.aFloat5711 = this.aFloat5716 = Class239_Sub4.aFloatArray5876[0x3fff & i];
        this.aFloat5704 = Class239_Sub4.aFloatArray5874[i & 0x3fff];
    ...
    final void method899(int i) {
        ...
        anInt5721++;
        this.aFloat5722 = this.aFloat5716 = Class239_Sub4.aFloatArray5876[0x3fff & i];
        this.aFloat5691 = Class239_Sub4.aFloatArray5874[0x3fff & i];
    ...
    final void method892(int i, int i_16_, int i_17_, int[] is) {
        ...
        is[2] = (int) ((float) i_17_ * this.aFloat5716 + ((float) i_16_ * this.aFloat5732 + (float) i * this.aFloat5704));
        is[0] = (int) ((float) i * this.aFloat5711 + (float) i_16_ * this.aFloat5708 + this.aFloat5736 * (float) i_17_);
        is[1] = (int) (this.aFloat5700 * (float) i + this.aFloat5722 * (float) i_16_ + this.aFloat5691 * (float) i_17_);
    }
    ...
    final void method919(float f, float[] fs, float f_30_, float f_31_, float f_32_, byte i) {
        anInt5727++;
        if (i != -120) method921((byte) -93, false);
    ...
    final void method920(float f, boolean bool, float f_44_, float f_45_) {
        ...
        this.aFloat5710 += f;
        if (bool != false) method915(null, 69);
    }

    static final void method921(byte i, boolean bool) {
        if (i == 99) {
            for (Class348_Sub9 class348_sub9 = (Class348_Sub9) Class218.aClass262_2859.method1995(4); class348_sub9 != null; class348_sub9 = (Class348_Sub9) Class218.aClass262_2859.method1990((byte) 120)) {
    ...
    final void method923(float f, float f_48_, byte i, float f_49_, float[] fs) {
        fs[2] = (f_49_ * this.aFloat5716 + (this.aFloat5691 * f_48_ + this.aFloat5736 * f));
        if (i > -23) method897(30, -104, -112, null);
        anInt5697++;
    ...
    final float method929(float f, float f_55_, byte i, float f_56_) {
        anInt5720++;
        if (i != 45) this.aFloat5722 = 0.64777815F;
    ...
    final void method890(int[] is) {
        ...
        is[2] = (int) (f_63_ * this.aFloat5716 + (this.aFloat5704 * f + f_62_ * this.aFloat5732));
        is[1] = (int) (this.aFloat5691 * f_63_ + (this.aFloat5722 * f_62_ + f * this.aFloat5700));
        is[0] = (int) (this.aFloat5708 * f_62_ + this.aFloat5711 * f + f_63_ * this.aFloat5736);
    }

    final void method897(int i, int i_64_, int i_65_, int[] is) {
        is[2] = (int) ((float) i_64_ * this.aFloat5691 + this.aFloat5736 * (float) i + this.aFloat5716 * (float) i_65_ + this.aFloat5724);
        anInt5723++;
        is[1] = (int) (this.aFloat5732 * (float) i_65_ + (this.aFloat5722 * (float) i_64_ + (float) i * this.aFloat5708) + this.aFloat5710);
        is[0] = (int) (this.aFloat5729 + (this.aFloat5704 * (float) i_65_ + ((float) i * this.aFloat5711 + (this.aFloat5700 * (float) i_64_))));
    }

    final void method905(int i, int i_66_, int i_67_, int[] is) {
        is[0] = (int) ((float) i * this.aFloat5711 + this.aFloat5700 * (float) i_66_ + (float) i_67_ * this.aFloat5704);
        is[1] = (int) ((float) i_66_ * this.aFloat5722 + this.aFloat5708 * (float) i + this.aFloat5732 * (float) i_67_);
        anInt5741++;
        is[2] = (int) ((float) i * this.aFloat5736 + this.aFloat5691 * (float) i_66_ + (float) i_67_ * this.aFloat5716);
    }
    ...
    final float method933(byte i, float f, float f_76_, float f_77_) {
        if (i != -105) this.aFloat5724 = -0.26493254F;
        anInt5740++;
    ...
    final void method935(float f, float f_79_, float f_80_, float f_81_, float f_82_, float f_83_, float f_84_, float f_85_, float f_86_, int i) {
        anInt5718++;
    ...
    final void method936(int i, int i_87_, int i_88_, float f, float f_89_, float f_90_, int i_91_) {
        anInt5703++;
        if (i == i_87_) {
            this.aFloat5708 = this.aFloat5736 = this.aFloat5700 = this.aFloat5691 = this.aFloat5704 = this.aFloat5732 = 0.0F;
            ...
            this.aFloat5736 = this.aFloat5691 = this.aFloat5704 = this.aFloat5732 = 0.0F;
            this.aFloat5724 = f_89_;
            this.aFloat5708 = (float) i_91_ * (f_93_ * 2.0F);
            this.aFloat5729 = f + (float) (2 * i_91_) * (0.5F * f_93_ - f_92_ * 0.5F);
        }
    }
