...
final class Class16 {
    ...
    static int anInt232;
    static Js5Archive aClass45_233;
    static int anInt234;

    static final void method258(int i, int i_0_) {
        Class357 class357 = ChatMessage.aClass357ArrayArrayArray2029[0][i][i_0_];
        for (int i_1_ = 0; i_1_ < 3; i_1_++) {
            Class357 class357_2_ = (ChatMessage.aClass357ArrayArrayArray2029[i_1_][i][i_0_] = ChatMessage.aClass357ArrayArrayArray2029[i_1_ + 1][i][i_0_]);
            if (class357_2_ != null) {
        ...
        if (ChatMessage.aClass357ArrayArrayArray2029[0][i][i_0_] == null) {
            ChatMessage.aClass357ArrayArrayArray2029[0][i][i_0_] = new Class357(0);
            ChatMessage.aClass357ArrayArrayArray2029[0][i][i_0_].aByte4399 = (byte) 1;
        }
        ChatMessage.aClass357ArrayArrayArray2029[0][i][i_0_].aClass357_4400 = class357;
        ChatMessage.aClass357ArrayArrayArray2029[3][i][i_0_] = null;
    }
