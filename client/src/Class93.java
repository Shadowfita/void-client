...
final class Class93 {
    ...
    static final ha method862(Canvas canvas, d var_d, Js5Archive Js5Archive, int i, int i_1_) {
        try {
            anInt1532++;
            ...
            Class377 class377 = new Class377(opengl, canvas, l, var_d, Js5Archive, i_1_);
            class377.method3930((byte) 26);
            return class377;
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("lt.D(" + (canvas != null ? "{...}" : "null") + ',' + (var_d != null ? "{...}" : "null") + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + i + ',' + i_1_ + ')'));
        }
    }
