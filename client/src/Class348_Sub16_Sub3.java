...
final class Class348_Sub16_Sub3 extends Class348_Sub16 {
    ...
    int[] anIntArray8895;
    private final int[] anIntArray8896;
    static int anInt8897;
    static int anInt8898;
    private final int[] anIntArray8899;
    static int anInt8900;
    static int anInt8901;
    private int[] anIntArray8902;
    static int anInt8903;
    private final int[] anIntArray8904;
    static int anInt8905;
    int[] anIntArray8906;
    static int anInt8907;
    static int anInt8908;
    static int anInt8909;
    static int[][] anIntArrayArray8910 = {{0, 1, 2, 3}, {1, 2, 3, 0}, {1, 2, -1, 0}, {2, 0, -1, 1}, {0, 1, -1, 2}, {1, 2, -1, 0}, {-1, 4, -1, 1}, {-1, 1, 3, -1}, {-1, 0, 2, -1}, {3, 5, 2, 0}, {0, 2, 5, 3}, {0, 2, 3, 5}, {0, 1, 2, 3}};
    static int anInt8911;
    static int anInt8912;
    static int anInt8913;
    int[] anIntArray8914;
    private final Class348_Sub43[][] aClass348_Sub43ArrayArray8915;
    ...
    private final int[] anIntArray8939;
    static int anInt8940;
    static int anInt8941;
    private int[] anIntArray8942;
    static int anInt8943;
    private Class204 aClass204_8944;
    private final int[] anIntArray8945;
    ...
    private final int[] anIntArray8953;
    ...
    private Class348_Sub2 aClass348_Sub2_8963;
    ...
    private final void method2842(int i, int i_4_) {
        ...
        if (i_5_ == 128) {
            ...
            int i_17_ = 0x7f & i_4_ >> 16;
            if (i_16_ == 0) anIntArray8947[i_15_] = ((i_17_ << 14) + Class139.method1166(anIntArray8947[i_15_], -2080769));
            if (i_16_ == 32) anIntArray8947[i_15_] = ((i_17_ << 7) + Class139.method1166(anIntArray8947[i_15_], -16257));
            if (i_16_ == 1) anIntArray8899[i_15_] = (Class139.method1166(-16257, anIntArray8899[i_15_]) + (i_17_ << 7));
            if (i_16_ == 33) anIntArray8899[i_15_] = (Class139.method1166(anIntArray8899[i_15_], -128) - -i_17_);
            if (i_16_ == 5) anIntArray8939[i_15_] = (Class139.method1166(anIntArray8939[i_15_], -16257) - -(i_17_ << 7));
            if (i_16_ == 37) anIntArray8939[i_15_] = i_17_ + Class139.method1166(-128, anIntArray8939[i_15_]);
            if (i_16_ == 7) anIntArray8953[i_15_] = ((i_17_ << 7) + Class139.method1166(-16257, anIntArray8953[i_15_]));
            if (i_16_ == 39) anIntArray8953[i_15_] = i_17_ + Class139.method1166(anIntArray8953[i_15_], -128);
            if (i_16_ == 10) anIntArray8894[i_15_] = ((i_17_ << 7) + Class139.method1166(anIntArray8894[i_15_], -16257));
            if (i_16_ == 42) anIntArray8894[i_15_] = i_17_ + Class139.method1166(anIntArray8894[i_15_], -128);
            if (i_16_ == 11) anIntArray8896[i_15_] = ((i_17_ << 7) + Class139.method1166(-16257, anIntArray8896[i_15_]));
            ...
            if (i_16_ == 99) anIntArray8904[i_15_] = ((i_17_ << 7) + Class139.method1166(127, anIntArray8904[i_15_]));
            if (i_16_ == 98) anIntArray8904[i_15_] = (Class139.method1166(16256, anIntArray8904[i_15_]) + i_17_);
            if (i_16_ == 101) anIntArray8904[i_15_] = (16384 - -Class139.method1166(anIntArray8904[i_15_], 127) + (i_17_ << 7));
            ...
            if (i_16_ == 6) {
                ...
                if (i_18_ == 16384) anIntArray8902[i_15_] = ((i_17_ << 7) + Class139.method1166(anIntArray8902[i_15_], -16257));
            }
            if (i_16_ == 38) {
                int i_19_ = anIntArray8904[i_15_];
                if (i_19_ == 16384) anIntArray8902[i_15_] = i_17_ + Class139.method1166(-128, anIntArray8902[i_15_]);
            }
            if (i_16_ == 16) this.anIntArray8914[i_15_] = (Class139.method1166(-16257, (this.anIntArray8914[i_15_])) + (i_17_ << 7));
            ...
            if (i_5_ == 224) {
                int i_24_ = 0xf & i_4_;
                int i_25_ = ((0x7f & i_4_ >> 8) + ((0x7f0064 & i_4_) >> 9));
    ...
    private final int method2845(int i, Class348_Sub43 class348_sub43) {
        try {
            if (i != 0) anInt8956 = 53;
            anInt8934++;
            int i_30_ = (class348_sub43.anInt7080 - -((class348_sub43.anInt7072 * class348_sub43.anInt7089) >> 12));
            i_30_ += (((anIntArray8937[class348_sub43.anInt7067]) - 8192) * anIntArray8902[(class348_sub43.anInt7067)]) >> 12;
            Class23 class23 = class348_sub43.aClass23_7075;
            if (class23.anInt352 > 0 && (class23.anInt353 > 0 || (anIntArray8899[class348_sub43.anInt7067]) > 0)) {
                int i_31_ = class23.anInt353 << 2;
                int i_32_ = class23.anInt346 << 1;
                if (i_32_ > class348_sub43.anInt7083) i_31_ = (i_31_ * class348_sub43.anInt7083 / i_32_);
                i_31_ += anIntArray8899[(class348_sub43.anInt7067)] >> 7;
                double d = Math.sin((double) ((class348_sub43.anInt7076) & 0x1ff) * 0.01227184630308513);
                i_30_ += (int) (d * (double) i_31_);
            }
            int i_33_ = (int) (((double) (class348_sub43.aClass348_Sub19_Sub1_7077.anInt8988 * 256) * Math.pow(2.0, 3.255208333333333E-4 * (double) i_30_) / (double) Class22.anInt339) + 0.5);
            return Math.max(i_33_, 1);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("ma.JA(" + i + ',' + (class348_sub43 != null ? "{...}" : "null") + ')'));
        }
    }

    private final synchronized void method2846(boolean bool, boolean bool_34_, Class348_Sub2 class348_sub2, boolean bool_35_) {
        do {
            try {
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("ma.T(" + bool + ',' + bool_34_ + ',' + (class348_sub2 != null ? "{...}" : "null") + ',' + bool_35_ + ')'));
            }
            break;
        } while (false);
    }
    ...
    final boolean method2847(int i, Class348_Sub43 class348_sub43) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.W(" + i + ',' + (class348_sub43 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    private final int method2848(Class348_Sub43 class348_sub43, byte i) {
        try {
            ...
            anInt8936++;
            int i_38_ = anIntArray8894[class348_sub43.anInt7067];
            if (i_38_ >= 8192) return 16384 - ((-class348_sub43.anInt7074 + 128) * (16384 - i_38_) - -32 >> 6);
            return (class348_sub43.anInt7074 * i_38_ - -32 >> 6);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("ma.GA(" + (class348_sub43 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }

    private final void method2849(int i, int i_39_, byte i_40_, int i_41_) {
        anInt8941++;
        Class348_Sub43 class348_sub43 = aClass348_Sub43ArrayArray8928[i_41_][i_39_];
        if (class348_sub43 != null) {
            ...
            if ((this.anIntArray8895[i_41_] & 0x2) != 0) {
                for (Class348_Sub43 class348_sub43_43_ = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1995(4)); class348_sub43_43_ != null; class348_sub43_43_ = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1990((byte) 36))) {
    ...
    private final void method2850(int i, int i_44_) {
        if ((0x4 & this.anIntArray8895[i]) != 0) {
            for (Class348_Sub43 class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1995(4)); class348_sub43 != null; class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1990((byte) 65))) {
    ...
    final boolean method2852(int[] is, int i, Class348_Sub43 class348_sub43, int i_46_, byte i_47_) {
        try {
            ...
            int i_48_ = class348_sub43.anInt7089;
            if (i_47_ != -4) return false;
            if (i_48_ > 0) {
                i_48_ -= (int) (0.5 + (16.0 * Math.pow(2.0, (4.921259842519685E-4 * (double) (anIntArray8939[(class348_sub43.anInt7067)])))));
                if (i_48_ < 0) i_48_ = 0;
            ...
            double d = (double) ((class348_sub43.anInt7071 - 60 << 8) - -((class348_sub43.anInt7072 * class348_sub43.anInt7089) >> 12)) * 5.086263020833333E-6;
            if (class23.anInt347 > 0) {
                if (class23.anInt350 <= 0) class348_sub43.anInt7090 += 128;
                else class348_sub43.anInt7090 += (int) ((128.0 * Math.pow(2.0, (double) (class23.anInt350) * d)) + 0.5);
                if ((class23.anInt347 * class348_sub43.anInt7090) >= 819200) bool = true;
            }
            if (class23.aByteArray348 != null) {
                if (class23.anInt345 > 0) class348_sub43.anInt7070 += (int) (0.5 + (128.0 * Math.pow(2.0, d * (double) (class23.anInt345))));
                else class348_sub43.anInt7070 += 128;
                for (/**/; ((class348_sub43.anInt7069 < -2 + class23.aByteArray348.length) && (class348_sub43.anInt7070 > (0xff00 & (class23.aByteArray348[2 + (class348_sub43.anInt7069)]) << 8))); class348_sub43.anInt7069 += 2) {
                    /* empty */
                }
                if ((class348_sub43.anInt7069 == -2 + class23.aByteArray348.length) && ((class23.aByteArray348[1 + class348_sub43.anInt7069]) == 0)) bool = true;
            }
            if (class348_sub43.anInt7087 >= 0 && class23.aByteArray344 != null && (0x1 & (this.anIntArray8895[class348_sub43.anInt7067])) == 0 && (class348_sub43.anInt7088 < 0 || ((aClass348_Sub43ArrayArray8915[class348_sub43.anInt7067][class348_sub43.anInt7088]) != class348_sub43))) {
                if (class23.anInt349 > 0) class348_sub43.anInt7087 += (int) ((Math.pow(2.0, (double) (class23.anInt349) * d) * 128.0) + 0.5);
                else class348_sub43.anInt7087 += 128;
                for (/**/; ((class348_sub43.anInt7084 < -2 + class23.aByteArray344.length) && (((class23.aByteArray344[(class348_sub43.anInt7084 - -2)]) << 8 & 0xff00) < class348_sub43.anInt7087)); class348_sub43.anInt7084 += 2) {
                    /* empty */
                }
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.U(" + (is != null ? "{...}" : "null") + ',' + i + ',' + (class348_sub43 != null ? "{...}" : "null") + ',' + i_46_ + ',' + i_47_ + ')'));
        }
    }
    ...
    private final void method2853(int i, int i_49_, int i_50_, int i_51_) {
        ...
        if ((0x2 & this.anIntArray8895[i_51_]) != 0) {
            for (Class348_Sub43 class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1993(i ^ ~0x51)); class348_sub43 != null; class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method2003(-50))) {
                if ((class348_sub43.anInt7067 == i_51_) && class348_sub43.anInt7087 < 0) {
                    ...
                    int i_52_ = (((class348_sub43.anInt7089 * class348_sub43.anInt7072) >> 12) + class348_sub43.anInt7080);
                    class348_sub43.anInt7080 += (-class348_sub43.anInt7071 + i_50_) << 8;
        ...
        if (class348_sub17 != null) {
            ...
            if (class348_sub19_sub1 != null) {
                ...
                class348_sub43.anInt7088 = class348_sub17.aByteArray6798[i_50_];
                class348_sub43.anInt7071 = i_50_;
                class348_sub43.anInt7066 = 1024 + ((class348_sub17.aByteArray6799[i_50_]) * (class348_sub17.anInt6797 * (i_49_ * i_49_))) >> 11;
                class348_sub43.anInt7074 = (class348_sub17.aByteArray6792[i_50_] & 0xff);
                class348_sub43.anInt7080 = ((i_50_ << 8) + -((class348_sub17.aShortArray6795[i_50_]) & 0x7fff));
                ...
                if (this.anIntArray8914[i_51_] == 0) class348_sub43.aClass348_Sub16_Sub5_7081 = (Class348_Sub16_Sub5.method2911(class348_sub19_sub1, method2845(0, class348_sub43), method2868(class348_sub43, i + -82), method2848(class348_sub43, (byte) -70)));
                else {
                    class348_sub43.aClass348_Sub16_Sub5_7081 = (Class348_Sub16_Sub5.method2911(class348_sub19_sub1, method2845(0, class348_sub43), 0, method2848(class348_sub43, (byte) -70)));
                ...
                if (class348_sub43.anInt7088 >= 0) {
                    Class348_Sub43 class348_sub43_53_ = (aClass348_Sub43ArrayArray8915[i_51_][class348_sub43.anInt7088]);
    ...
    private final void method2855(int i, byte i_56_) {
        anInt8927++;
        if (i_56_ < -42) {
            for (Class348_Sub43 class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1995(4)); class348_sub43 != null; class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1990((byte) 60))) {
    ...
    private final void method2858(int i, int i_62_) {
        ...
        if ((this.anIntArray8895[i_62_] & 0x2) != 0) {
            for (Class348_Sub43 class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1995(4)); class348_sub43 != null; class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1990((byte) 41))) {
    ...
    final synchronized void method2819(int i) {
        ...
        if (aClass204_8944.method1491()) {
            int i_63_ = (aClass204_8944.anInt2683 * anInt8921 / Class22.anInt339);
            do {
    ...
    final synchronized void method2817(int[] is, int i, int i_67_) {
        try {
            anInt8898++;
            if (aClass204_8944.method1491()) {
                int i_68_ = (anInt8921 * aClass204_8944.anInt2683 / Class22.anInt339);
                do {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.C(" + (is != null ? "{...}" : "null") + ',' + i + ',' + i_67_ + ')'));
        }
    }
    ...
    static final Class144 method2862(Class297 class297, String string, int i, int i_71_) {
        try {
            ...
            if (i_71_ == 1) {
                try {
                    Class224.method1616("openjs", (new Object[]{new URL(Class93.anApplet1530.getCodeBase(), string).toString()}), Class93.anApplet1530, (byte) 38);
            ...
            if (i_71_ == 2) {
                try {
                    Class93.anApplet1530.getAppletContext().showDocument(new URL(Class93.anApplet1530.getCodeBase(), string), "_blank");
                    Class144 class144 = new Class144();
                    class144.anInt1997 = 1;
                    return class144;
            ...
            if (i_71_ == 3) {
                ...
                try {
                    Class93.anApplet1530.getAppletContext().showDocument(new URL(Class93.anApplet1530.getCodeBase(), string), "_top");
                    Class144 class144 = new Class144();
                    class144.anInt1997 = 1;
                    return class144;
                } catch (Exception exception) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.EA(" + (class297 != null ? "{...}" : "null") + ',' + (string != null ? "{...}" : "null") + ',' + i + ',' + i_71_ + ')'));
        }
    }
    ...
    private final int method2868(Class348_Sub43 class348_sub43, int i) {
        try {
            ...
            Class23 class23 = class348_sub43.aClass23_7075;
            int i_79_ = ((anIntArray8953[class348_sub43.anInt7067] * (anIntArray8896[class348_sub43.anInt7067])) + 4096 >> 13);
            i_79_ = 16384 + i_79_ * i_79_ >> 15;
            i_79_ = (16384 + i_79_ * class348_sub43.anInt7066 >> 15);
            i_79_ = i_79_ * anInt8933 + 128 >> 8;
            i_79_ = 128 + anIntArray8925[(class348_sub43.anInt7067)] * i_79_ >> 8;
            if (class23.anInt347 > 0) i_79_ = (int) (0.5 + ((double) i_79_ * Math.pow(0.5, ((double) class348_sub43.anInt7090 * 1.953125E-5 * (double) (class23.anInt347)))));
            if (class23.aByteArray348 != null) {
                int i_80_ = class348_sub43.anInt7070;
                int i_81_ = (class23.aByteArray348[class348_sub43.anInt7069 + 1]);
                if (class348_sub43.anInt7069 < class23.aByteArray348.length + -2) {
                    int i_82_ = 0xff00 & (class23.aByteArray348[(class348_sub43.anInt7069)]) << 8;
                    int i_83_ = ((0xff & (class23.aByteArray348[(class348_sub43.anInt7069) + 2])) << 8);
                    i_81_ += (-i_81_ + (class23.aByteArray348[(class348_sub43.anInt7069 - -3)])) * (i_80_ + -i_82_) / (i_83_ - i_82_);
                }
                i_79_ = i_79_ * i_81_ + 32 >> 6;
            }
            if (class348_sub43.anInt7087 > 0 && class23.aByteArray344 != null) {
                int i_84_ = class348_sub43.anInt7087;
                int i_85_ = (class23.aByteArray344[1 + class348_sub43.anInt7084]);
                if (class23.aByteArray344.length + -2 > class348_sub43.anInt7084) {
                    int i_86_ = 0xff00 & (class23.aByteArray344[(class348_sub43.anInt7084)]) << 8;
                    int i_87_ = ((class23.aByteArray344[class348_sub43.anInt7084 - -2]) << 8) & 0xff00;
                    i_85_ += ((class23.aByteArray344[3 + class348_sub43.anInt7084]) + -i_85_) * (i_84_ + -i_86_) / (-i_86_ + i_87_);
                }
                i_79_ = i_85_ * i_79_ + 32 >> 6;
            }
            return i_79_;
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("ma.DA(" + (class348_sub43 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }

    final synchronized void method2869(Class348_Sub2 class348_sub2, boolean bool, boolean bool_88_) {
        try {
            anInt8932++;
            method2846(bool_88_, true, class348_sub2, bool);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("ma.L(" + (class348_sub2 != null ? "{...}" : "null") + ',' + bool + ',' + bool_88_ + ')'));
        }
    }

    final synchronized void method2870(Class348_Sub2 class348_sub2, long l, boolean bool, boolean bool_89_, byte i) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.O(" + (class348_sub2 != null ? "{...}" : "null") + ',' + l + ',' + bool + ',' + bool_89_ + ',' + i + ')'));
        }
    }
    ...
    private final void method2872(int i, int i_90_) {
        anInt8918++;
        for (Class348_Sub43 class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1995(i + -2005674596)); class348_sub43 != null; class348_sub43 = ((Class348_Sub43) aClass348_Sub16_Sub1_8958.aClass262_8848.method1990((byte) 68))) {
    ...
    final void method2874(int i, boolean bool, Class348_Sub43 class348_sub43) {
        try {
            anInt8909++;
            int i_94_ = (class348_sub43.aClass348_Sub19_Sub1_7077.aByteArray8984).length;
            int i_95_;
            if (bool && (class348_sub43.aClass348_Sub19_Sub1_7077.aBoolean8987)) {
                int i_96_ = (i_94_ + i_94_ + -class348_sub43.aClass348_Sub19_Sub1_7077.anInt8986);
                i_95_ = (int) ((long) (this.anIntArray8914[(class348_sub43.anInt7067)]) * (long) i_96_ >> 6);
                i_94_ <<= 8;
                if (i_94_ <= i_95_) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.WA(" + i + ',' + bool + ',' + (class348_sub43 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    Class348_Sub16_Sub3(Class348_Sub16_Sub3 class348_sub16_sub3_107_) {
        ...
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ma.<init>(" + ((class348_sub16_sub3_107_ != null) ? "{...}" : "null") + ')'));
        }
    }
}
