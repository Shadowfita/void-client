...
final class Class226 {
    static IterableHashTable aClass356_2959 = new IterableHashTable(512);
    private final ReferenceCache aClass60_2960 = new ReferenceCache(64);
    private final Js5Archive aClass45_2961;
    static int anInt2962;
    static int anInt2963;
    static int anInt2964 = 64;
    private Js5Archive aClass45_2965;
    ...
    Class226(int i, Js5Archive Js5Archive, Js5Archive class45_3_) {
        do {
            try {
                aClass45_2961 = Js5Archive;
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("sga.<init>(" + i + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + (class45_3_ != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
