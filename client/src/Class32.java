...
final class Class32 {
    ...
    final Class348_Sub42 method334(long l, byte i) {
        try {
            aLong453 = l;
            anInt449++;
            Class348_Sub42 class348_sub42 = aClass348_Sub42Array452[(int) ((long) (anInt448 - 1) & l)];
    ...
    final void method335(Class348_Sub42 class348_sub42, int i, long l) {
        try {
            ...
            Class348_Sub42 class348_sub42_1_ = aClass348_Sub42Array452[(int) (l & (long) (anInt448 - 1))];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ib.A(" + (class348_sub42 != null ? "{...}" : "null") + ',' + i + ',' + l + ')'));
        }
    }
    ...
    Class32(int i) {
        ...
        for (int i_2_ = 0; i_2_ < i; i_2_++) {
            Class348_Sub42 class348_sub42 = aClass348_Sub42Array452[i_2_] = new Class348_Sub42();
    ...
    final Class348_Sub42 method336(boolean bool) {
        ...
        for (Class348_Sub42 class348_sub42 = aClass348_Sub42Array452[(int) (aLong453 & (long) (-1 + anInt448))]; class348_sub42 != aClass348_Sub42_454; aClass348_Sub42_454 = (aClass348_Sub42_454.aClass348_Sub42_7063)) {
