...
final class Class133 {
    ...
    static final void method1141(BitPacket BitPacket, int i, int i_0_, int i_1_, Player player) {
        do {
            try {
                anInt1912++;
                if (i_1_ >= 41) {
                    byte i_2_ = -1;
                    if ((i_0_ & 0x1) != 0) {
                        int i_3_ = BitPacket.readUnsignedShort(842397944);
                        if (i_3_ == 65535) i_3_ = -1;
                        player.anInt10275 = i_3_;
                    }
                    if ((0x10000 & i_0_) != 0) {
                        int i_4_ = BitPacket.readUnsignedByte(255);
                        int[] is = new int[i_4_];
                        int[] is_5_ = new int[i_4_];
                        for (int i_6_ = 0; i_6_ < i_4_; i_6_++) {
                            int i_7_ = BitPacket.readShortAddLittle(-118);
                            if ((i_7_ & 0xc000) == 49152) {
                                int i_8_ = BitPacket.readShortLittle(false);
                                is[i_6_] = Class273.method2057(i_7_ << 16, i_8_);
                            } else is[i_6_] = i_7_;
                            is_5_[i_6_] = BitPacket.readShortLittle(false);
                        }
                        player.method2430(is_5_, is, -116);
                    }
                    if ((0x400 & i_0_) != 0) {
                        int i_9_ = BitPacket.readShortLittle(false);
                        player.anInt10227 = BitPacket.readUnsignedByteSubtract((byte) -94);
                        player.anInt10271 = BitPacket.readUnsignedByteSubtract((byte) -104);
                    ...
                    if ((0x1000 & i_0_) != 0) {
                        player.aString10292 = BitPacket.readString((byte) 110);
                    ...
                    if ((i_0_ & 0x4) != 0) {
                        int i_10_ = BitPacket.readByteInverse((byte) 21);
                        if (i_10_ > 0) {
                            for (int i_11_ = 0; i_10_ > i_11_; i_11_++) {
                                int i_12_ = -1;
                                int i_13_ = -1;
                                int i_14_ = BitPacket.readSmart(-127);
                                int i_15_ = -1;
                                if (i_14_ == 32767) {
                                    i_14_ = BitPacket.readSmart(-125);
                                    i_13_ = BitPacket.readSmart(-126);
                                    i_12_ = BitPacket.readSmart(-128);
                                    i_15_ = BitPacket.readSmart(-122);
                                } else if (i_14_ != 32766) i_13_ = BitPacket.readSmart(-117);
                                else i_14_ = -1;
                                int i_16_ = BitPacket.readSmart(-123);
                                int i_17_ = BitPacket.readByteAdd((byte) -98);
                                player.method2438(i_13_, Class367_Sub11.anInt7396, i_14_, i_15_, i_12_, i_16_, i_17_, (byte) 102);
                            }
                        }
                    }
                    if ((i_0_ & 0x2) != 0) {
                        player.anInt10524 = BitPacket.readUnsignedShort(842397944);
                    ...
                    if ((0x8000 & i_0_) != 0) {
                        player.aBoolean10554 = BitPacket.readByteAdd((byte) -94) == 1;
                    }
                    if ((i_0_ & 0x100) != 0) {
                        int i_18_ = BitPacket.readByteInverse((byte) 21);
                        int[] is = new int[i_18_];
                        int[] is_19_ = new int[i_18_];
                        int[] is_20_ = new int[i_18_];
                        for (int i_21_ = 0; i_21_ < i_18_; i_21_++) {
                            int i_22_ = BitPacket.readUnsignedShort(842397944);
                            if (i_22_ == 65535) i_22_ = -1;
                            is[i_21_] = i_22_;
                            is_19_[i_21_] = BitPacket.readByteInverse((byte) 21);
                            is_20_[i_21_] = BitPacket.readUnsignedShort(842397944);
                        }
                        Class167.method1297((byte) -116, player, is_20_, is, is_19_);
                    }
                    if ((0x2000 & i_0_) != 0) {
                        player.anInt10293 = BitPacket.readByte(-121);
                        player.anInt10314 = BitPacket.readByteSubtract(-27697);
                        player.anInt10241 = BitPacket.readByteInverse(-622951480);
                        player.anInt10288 = BitPacket.readByteInverse(-622951480);
                        player.anInt10239 = (BitPacket.readShortAddLittle(-118) - -Class367_Sub11.anInt7396);
                        player.anInt10300 = (BitPacket.readShortAdd(19) - -Class367_Sub11.anInt7396);
                        player.anInt10231 = BitPacket.readUnsignedByte(255);
                        player.anInt10322 = 0;
                    ...
                    if ((0x200 & i_0_) != 0) {
                        int i_23_ = BitPacket.readShortAddLittle(-107);
                        if (i_23_ == 65535) i_23_ = -1;
                        int i_24_ = BitPacket.readIntLittle((byte) -121);
                        int i_25_ = BitPacket.readUnsignedByteSubtract((byte) 54);
                        int i_26_ = i_25_ & 0x7;
                    ...
                    if ((i_0_ & 0x40000) != 0) {
                        player.aByte10255 = BitPacket.readByteInverse(-622951480);
                        player.aByte10206 = BitPacket.readByte(-99);
                        player.aByte10270 = BitPacket.readByte(-87);
                        player.aByte10279 = (byte) BitPacket.readUnsignedByte(255);
                        player.anInt10248 = (Class367_Sub11.anInt7396 + BitPacket.readShortAddLittle(-120));
                        player.anInt10250 = (Class367_Sub11.anInt7396 + BitPacket.readShortAdd(125));
                    }
                    if ((i_0_ & 0x80) != 0) {
                        Class259.aByteArray3300[i] = BitPacket.readByteSubtract(-27697);
                    }
                    if ((i_0_ & 0x20) != 0) {
                        int i_28_ = BitPacket.readShortAddLittle(-126);
                        if (i_28_ == 65535) i_28_ = -1;
                        int i_29_ = BitPacket.readIntInverseMiddle(255);
                        int i_30_ = BitPacket.readByteAdd((byte) -125);
                        int i_31_ = i_30_ & 0x7;
                    ...
                    if ((0x8 & i_0_) != 0) {
                        ...
                        for (int i_33_ = 0; i_33_ < 4; i_33_++) {
                            is[i_33_] = BitPacket.readShortAdd(123);
                            if (is[i_33_] == 65535) is[i_33_] = -1;
                        }
                        int i_34_ = BitPacket.readByteAdd((byte) -101);
                        Class239_Sub16.method1791(23946, is, i_34_, player);
                    }
                    if ((i_0_ & 0x10) != 0) {
                        int i_35_ = BitPacket.readUnsignedByte(255);
                        byte[] is = new byte[i_35_];
                        Packet Packet = new Packet(is);
                        BitPacket.method3347(is, 0, i_35_, (byte) -124);
                        Class154.aClass348_Sub49Array2105[i] = Packet;
                        player.method2452((byte) 84, Packet);
                    }
                    if ((0x800 & i_0_) != 0) i_2_ = BitPacket.readByteInverse(-622951480);
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("ns.A(" + (BitPacket != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + (player != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
