...
final class Class318_Sub1_Sub3_Sub4 extends Class318_Sub1_Sub3 {
    ...
    static final void method2464(byte i, int i_11_, int i_12_, int i_13_, ha var_ha, int i_14_, d var_d) {
        do {
            try {
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("lf.L(" + i + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_14_ + ',' + (var_d != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
    ...
    Class318_Sub1_Sub3_Sub4(int i, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_) {
