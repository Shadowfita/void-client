    ...
    public final String method54(int i, long l, Class138 class138, int[] is) {
        try {
            ...
            if (Class234.aClass138_3044 == class138) {
                Class117 class117 = Class348_Sub7.aClass33_6653.method337(true, is[0]);
                return class117.method1074((int) l, 91);
            }
            if (Class299_Sub1.aClass138_6321 == class138 || za.aClass138_7274 == class138) {
                ObjType ObjType = Exception_Sub1.aClass255_112.getItemDefinitions(i + -99, (int) l);
                return ObjType.name;
            }
            if (i != 1) method54(85, -41L, null, null);
            if (class138 == Class348_Sub42_Sub5.aClass138_9530 || class138 == Class348_Sub49_Sub1.aClass138_9748 || Class71.aClass138_1213 == class138) return Class348_Sub7.aClass33_6653.method337(true, is[0]).method1074((int) l, i ^ 0x48);
            return null;
