...
final class t extends s implements Interface19 {
    ...
    final void method3978(int i, int i_13_, int[] is, int[] is_14_, int[] is_15_, int[] is_16_, int[] is_17_, int[] is_18_, int[] is_19_, int[] is_20_, int[] is_21_, int[] is_22_, int[] is_23_, int i_24_, int i_25_, int i_26_, boolean bool) {
    ...
    private final native void V(int i, int i_58_, int i_59_, int i_60_, int i_61_, int i_62_, int[] is);
