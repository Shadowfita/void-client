...
final class Class277 {
    ...
    private final void method2069(int i, Packet Packet, int i_1_) {
        anInt3567++;
        if (i == -1) {
            if (i_1_ != 1) {
                if (i_1_ == 2) this.anInt3575 = Packet.readUnsignedByte(255);
                else if (i_1_ == 3) {
                    this.anInt3575 = Packet.readUnsignedShort(842397944);
                    if (this.anInt3575 == 65535) this.anInt3575 = -1;
                } else if (i_1_ != 5) {
                    if (i_1_ != 7) {
                        if (i_1_ == 8) this.aClass268_3562.anInt3447 = this.anInt3573;
                        else if (i_1_ == 9) this.anInt3570 = (Packet.readUnsignedShort(842397944) << 2);
                        else if (i_1_ == 10) this.aBoolean3566 = false;
                        else if (i_1_ == 11) this.anInt3564 = Packet.readUnsignedByte(255);
                        else if (i_1_ != 12) {
                            if (i_1_ != 13) {
                                if (i_1_ != 14) {
                                    if (i_1_ == 16) this.anInt3574 = Packet.readUnsignedByte(255);
    ...
    final void method2070(boolean bool, Packet Packet) {
        if (bool != true) this.aBoolean3561 = false;
        for (; ; ) {
            int i = Packet.readUnsignedByte(255);
            if (i == 0) break;
            method2069(-1, Packet, i);
        }
        anInt3565++;
    }
