...
final class Class186_Sub1 extends Class186 {
    ...
    Class186_Sub1(int i) {
        ...
        for (int i_42_ = 0; i_42_ < 256; i_42_++) {
            ...
            anIntArray5804[i_43_] = anIntArray5804[256 + i_43_] = anIntArray5804[i_42_];
    ...
    static final void method1403(int i, int i_45_, byte[] is, boolean bool, int i_46_, int i_47_, int i_48_) {
        ...
        for (; ; ) {
            OpenGL.glTexImage2Dub(i_47_, i_50_, i_48_, i_45_, i, 0, i_46_, 5121, is_54_, 0);
            if (i_51_ <= 1) break;
            ...
            for (int i_58_ = 0; i_49_ > i_58_; i_58_++) {
                ...
                for (int i_62_ = 0; i_62_ < i_53_; i_62_++) {
                    for (int i_63_ = 0; i_63_ < i_52_; i_63_++) {
