...
public class PatchConstants {
  ...
  /**
   * All available compatibility windows. The {@link #patchValue} field specifies the cost for
  ...
  public static enum CompatibilityWindowId {
    ...
    /**
     * Construct a new enumerated constant with the specified cost in patch files.
     */
    ...
    /**
     * Parse a patch cost and return the corresponding enumerated constant.
     * @param patchValue the patch cost to parse
  ...
  /**
   * All available delta formats. The {@link #patchValue} field specifies the cost for each
