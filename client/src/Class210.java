...
final class Class210 {
    ...
    final void method1530(float[] fs, int i) {
        ...
        for (int i_2_ = 2; i_2_ < i_0_; i_2_++) {
            ...
            if (i_6_ == 0) {
                ...
                if (i_6_ >= i_9_) anIntArray2728[i_2_] = (i_7_ > i_8_ ? i_6_ - i_8_ + i_5_ : i_5_ - i_6_ + i_7_ - 1);
                else anIntArray2728[i_2_] = ((i_6_ & 0x1) != 0 ? i_5_ - (i_6_ + 1) / 2 : i_5_ + i_6_ / 2);
            }
        }
        method1535(0, i_0_ - 1);
        int i_10_ = 0;
    ...
    private final void method1531(int i, int i_16_, int i_17_, int i_18_, float[] fs, int i_19_) {
    ...
    final boolean method1534() {
        ...
        for (int i_46_ = 0; i_46_ < anIntArray2725.length; i_46_++) {
            ...
            for (int i_52_ = 0; i_52_ < i_48_; i_52_++) {
                ...
                i_51_ >>>= i_49_;
                anIntArray2728[i_45_++] = (i_53_ >= 0 ? Class348_Sub10.aClass370Array6718[i_53_].method3581() : 0);
            }
        }
        return true;
    }
    ...
    Class210() {
        ...
        for (int i_69_ = 0; i_69_ < i_66_; i_69_++) {
            ...
            if (i_70_ != 0) anIntArray2723[i_69_] = Class348_Sub10.method2789(8);
            i_70_ = 1 << i_70_;
