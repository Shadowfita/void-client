...
final class Class51 {
    ...
    private IterableHashTable aClass356_881;
    ...
    final String method475(String string, int i, int i_3_) {
        ...
        StringNode StringNode = (StringNode) aClass356_881.method3480(i, -6008);
    ...
    private final void method482(Packet Packet, int i, byte i_38_) {
        anInt960++;
        if (i == 1 || i == 5) {
            if (i == 5 && this.aClass263_933.aBoolean3355) method484(Packet, -528);
                                                                                                            ...
                                                                                                            if (i != 170) {
                                                                                                                if (i == 171) this.anInt953 = Packet.readSmart(-121);
                                                                                                                    ...
                                                                                                                    if (aClass356_881 == null) {
                                                                                                                        ...
                                                                                                                        aClass356_881 = new IterableHashTable(i_43_);
                                                                                                                    }
                                                                                                                    for (int i_44_ = 0; i_44_ < i_42_; i_44_++) {
                                                                                                                        ...
                                                                                                                        else Node = new StringNode(Packet.readString((byte) -87));
    ...
    final int method487(int i, int i_79_, int i_80_) {
        ...
        IntNode IntNode = (IntNode) aClass356_881.method3480(i, -6008);
        if (IntNode == null) return i_79_;
