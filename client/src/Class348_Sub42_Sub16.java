...
abstract class Class348_Sub42_Sub16 extends Class348_Sub42 {
    ...
    static final void method3253(int i, int i_0_, int i_1_, Class var_class) {
        Class357 class357 = ChatMessage.aClass357ArrayArrayArray2029[i][i_0_][i_1_];
        if (class357 != null) {
    ...
    static final void method3254(int i, int i_2_, int i_3_, Class318_Sub1_Sub4 class318_sub1_sub4, Class318_Sub1_Sub4 class318_sub1_sub4_4_) {
    ...
    static final int method3255(int i, byte[] is, int i_6_, boolean bool, String string, int i_7_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ffa.E(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_6_ + ',' + bool + ',' + (string != null ? "{...}" : "null") + ',' + i_7_ + ')'));
        }
    }
