...
final class Class239_Sub3 extends Class239 {
    ...
    static final void method1728(int i, int i_2_, int i_3_, boolean bool, int i_4_) {
        ...
        if (Class320.method2547(i_3_, (byte) 84)) {
            MobileNativeHud.prepareGroup(i_3_,i_4_,i,Class348_Sub40_Sub33.aClass46ArrayArray9427[i_3_]);
            Class367_Sub1.method3534(false, i_2_, i_4_, bool, i, Class348_Sub40_Sub33.aClass46ArrayArray9427[i_3_]);
        }
    }
    ...
    static final boolean method1732(byte i, int i_21_) {
        ...
        return i_21_ < (~i_22_) || i_22_ >= 160 || Class44.aCharArray625[i_22_ + -128] != 0;
    }

    final void method1716(boolean bool) {
        anInt5864++;
        if (method1735(bool)) {
            if (this.aClass348_Sub51_3136.aClass239_Sub25_7271.method1830((byte) -97) && !Class151.method1210((byte) -94, this.aClass348_Sub51_3136.aClass239_Sub25_7271.method1829(-32350))) this.anInt3138 = 1;
    ...
    static final void method1733(byte i, int i_23_) {
        ...
        Class348_Sub42_Sub15 class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(i_23_, (byte) 105, 11);
    ...
    static final Class352 method1734(int i, ha var_ha, byte i_25_, boolean bool) {
        try {
            ...
            if (Class348_Sub1.anIntArray6547 != null) {
                for (int i_26_ = 0; i_26_ < Class348_Sub1.anIntArray6547.length; i_26_++) {
            ...
            if (class352 != null) {
                if (bool && class352.aClass143_4333 == null) {
                    Class143 class143 = Class239_Sub10.method1766((byte) -76, i, s.aClass45_4585);
            ...
            Class143 class143 = Class239_Sub10.method1766((byte) -39, i, s.aClass45_4585);
            if (class143 == null) return null;
            if (!bool) class352 = new Class352(var_ha.method3686(class143, class207s, true));
            else class352 = new Class352(var_ha.method3686(class143, class207s, true), class143);
