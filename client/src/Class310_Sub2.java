...
final class Class310_Sub2 extends Class310 implements Interface18_Impl3 {
    ...
    Class310_Sub2(Class378 class378, int i, int i_0_, boolean bool, int[] is, int i_1_, int i_2_) {
        ...
        int i_3_ = anIDirect3DTexture6332.LockRect(0, 0, 0, i, i_0_, 0, pixelbuffer);
        if (ue.a(i_3_, false)) {
            if (0 == i_2_) i_2_ = i;
    ...
    public final void method65(int i, int[] is, int i_8_, int i_9_, int i_10_, byte i_11_, int i_12_) {
        if (Class108.aClass304_1662 != this.aClass304_3896 || this.aClass68_3895 != Class68.aClass68_1183) throw new RuntimeException();
        if (i_11_ != 112) this.aBoolean6334 = false;
        PixelBuffer pixelbuffer = (this.aClass378_3893.aPixelBuffer9803);
        int i_13_ = anIDirect3DTexture6332.LockRect(0, i, i_9_, i_8_, i_10_, 16, pixelbuffer);
        if (ue.a(i_13_, false)) {
            int i_14_ = pixelbuffer.getRowPitch();
            if (i_14_ != 4 * i_8_) {
                for (int i_15_ = 0; i_15_ < i_10_; i_15_++)
                    pixelbuffer.b(is, i_12_ - -(i_8_ * i_15_), i_15_ * i_14_, i_8_);
            } else pixelbuffer.b(is, i_12_, 0, is.length);
            anIDirect3DTexture6332.UnlockRect(0);
        }
    }
    ...
    public final void method68(int i, int i_22_, int[] is, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
        if (this.aClass304_3896 != Class108.aClass304_1662 || this.aClass68_3895 != Class68.aClass68_1183) throw new RuntimeException();
        PixelBuffer pixelbuffer = (this.aClass378_3893.aPixelBuffer9803);
        int i_28_ = anIDirect3DTexture6332.LockRect(0, i_23_, i_26_, i_25_, i_27_, 0, pixelbuffer);
        if (ue.a(i_28_, false)) {
            int i_29_ = pixelbuffer.getRowPitch();
            if (i_29_ != i_25_ * 4 || i_25_ != i) {
                for (int i_30_ = 0; i_27_ > i_30_; i_30_++)
    ...
    public final void method70(int i, int i_31_, byte i_32_, int i_33_, int i_34_, int i_35_, int i_36_, byte[] is, Class304 class304) {
        if (this.aClass304_3896 != class304 || this.aClass68_3895 != Class68.aClass68_1183) throw new RuntimeException();
        if (i_32_ < -4) {
            PixelBuffer pixelbuffer = (this.aClass378_3893.aPixelBuffer9803);
            int i_37_ = anIDirect3DTexture6332.LockRect(0, i_36_, i, i_35_, i_34_, 0, pixelbuffer);
            if (ue.a(i_37_, false)) {
