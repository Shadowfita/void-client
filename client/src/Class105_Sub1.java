...
final class Class105_Sub1 extends Class105 {
    ...
    private final void method986(int i, int i_3_, int i_4_, int i_5_, int[] is, int i_6_, int i_7_) {
        anInt8394++;
        ...
        if (i_78_ == 0) {
            ...
            for (int i_86_ = 0; anInt8417 > i_86_; i_86_++) {
                ...
                for (int i_88_ = 0; i_88_ < anInt8411; i_88_++)
                    is_79_[i_88_ + i_87_] = (Class273.method2057(is[i_88_ + i_87_] != 0 ? -16777216 : 0, Class139.method1166(16777215, is_79_[i_88_ + i_87_])));
            }
        }
    ...
    static final boolean method989(int i, int i_92_, int i_93_) {
        anInt8401++;
        if (Class156.method1241(i_93_, i, i_92_ ^ 0x1fe) | (0x10000 & i) != 0 || Class348_Sub47.method3325(i, i_93_, true)) return true;
