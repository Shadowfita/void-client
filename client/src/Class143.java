...
final class Class143 {
    ...
    final String method1181(Class105[] class105s, int i, String string, byte i_0_) {
        try {
            anInt1989++;
            ...
            for (int i_6_ = 0; i_4_ > i_6_; i_6_++) {
                ...
                if (c == 60) i_1_ = i_6_;
                    ...
                    if (i_1_ == -1) {
                        i_3_ += 0xff & (aByteArray1986[Class354.method3464(c, false) & 0xff]);
                        if (aByteArrayArray1979 != null && i_2_ != -1) i_3_ += aByteArrayArray1979[i_2_][c];
                        i_2_ = c;
                        int i_9_ = i_3_;
                        if (aByteArrayArray1979 != null) i_9_ += aByteArrayArray1979[c][46];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("oea.I(" + (class105s != null ? "{...}" : "null") + ',' + i + ',' + (string != null ? "{...}" : "null") + ',' + i_0_ + ')'));
        }
    }
    ...
    final int method1185(Class105[] class105s, int i, int i_12_, int i_13_, String string) {
        try {
            anInt1990++;
            if (i_12_ == i) i_12_ = this.anInt1992;
            int i_14_ = method1188(string, new int[]{i_13_}, Class186.aStringArray2494, (byte) 87, class105s);
            int i_15_ = (-1 + i_14_) * i_12_;
            return (this.anInt1988 + (i_15_ + this.anInt1993));
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("oea.A(" + (class105s != null ? "{...}" : "null") + ',' + i + ',' + i_12_ + ',' + i_13_ + ',' + (string != null ? "{...}" : "null") + ')'));
        }
    }
        ...
        try {
            ...
            for (int i_19_ = 0; i_19_ < i_18_; i_19_++) {
                ...
                if (c == 60) i = i_19_;
                    ...
                    if (i == -1) {
                        i_17_ += 0xff & (aByteArray1986[Class354.method3464(c, false) & 0xff]);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("oea.F(" + (string != null ? "{...}" : "null") + ',' + (class105s != null ? "{...}" : "null") + ',' + bool + ')'));
        }
    }

    final int method1187(String string, boolean bool, int i, Class105[] class105s) {
        try {
            anInt1984++;
            int i_22_ = method1188(string, new int[]{i}, Class186.aStringArray2494, (byte) 87, class105s);
            int i_23_ = 0;
            if (bool != false) this.anInt1988 = -58;
            for (int i_24_ = 0; i_22_ > i_24_; i_24_++) {
                int i_25_ = method1186(Class186.aStringArray2494[i_24_], class105s, false);
                if (i_25_ > i_23_) i_23_ = i_25_;
            }
            return i_23_;
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("oea.K(" + (string != null ? "{...}" : "null") + ',' + bool + ',' + i + ',' + (class105s != null ? "{...}" : "null") + ')'));
        }
    }

    final int method1188(String string, int[] is, String[] strings, byte i, Class105[] class105s) {
        try {
            anInt1978++;
            ...
            for (int i_35_ = 0; i_34_ > i_35_; i_35_++) {
                int i_36_ = Class354.method3464(string.charAt(i_35_), false) & 0xff;
                int i_37_ = 0;
                if (i_36_ == 60) i_31_ = i_35_;
                    ...
                    if (i_31_ == -1) {
                        ...
                        if (string_39_.equals("br")) {
                            ...
                            i_33_++;
                            if (strings.length <= i_33_) return 0;
                            i_27_ = 1 + i_35_;
                            i_32_ = -1;
                            i_26_ = 0;
                            i_28_ = -1;
                        ...
                        if (string_39_.equals("lt")) {
                            ...
                            try {
                                int i_40_ = (Class348_Sub41.method3156(true, (string_39_.substring(4))));
                                i_32_ = -1;
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("oea.J(" + (string != null ? "{...}" : "null") + ',' + (is != null ? "{...}" : "null") + ',' + (strings != null ? "{...}" : "null") + ',' + i + ',' + (class105s != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final int method1190(Class105[] class105s, int i, String string, int i_42_) {
        try {
            anInt1983++;
            if (i != 1) this.anInt1992 = -13;
            return method1188(string, new int[]{i_42_}, Class186.aStringArray2494, (byte) 87, class105s);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("oea.B(" + (class105s != null ? "{...}" : "null") + ',' + i + ',' + (string != null ? "{...}" : "null") + ',' + i_42_ + ')'));
        }
    }
            ...
            for (int i_55_ = 0; i_55_ < 256; i_55_++) {
                if (i_55_ != 32 && i_55_ != 160) {
                    for (int i_56_ = 0; i_56_ < 256; i_56_++) {
                        if (i_56_ != 32 && i_56_ != 160) aByteArrayArray1979[i_55_][i_56_] = (byte) (Class239_Sub8.method1756(aByteArray1986, -34, i_56_, i_55_, is_47_, is_51_, is_44_, is_43_));
                    }
                }
            }
