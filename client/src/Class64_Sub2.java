...
final class Class64_Sub2 extends Class64 {
    ...
    private final void method659(int i) {
        if (aClass353Array5524 != null) {
            ...
            aHa_Sub3_5419.method3849((byte) 47, 1, Class348_Sub40_Sub39.aClass70_9485);
            ...
            aHa_Sub3_5419.method3849((byte) 47, 1, Class318_Sub1_Sub2.aClass70_8737);
    ...
    final boolean method628(int i, int i_22_, Class101 class101, boolean bool, int i_23_) {
        try {
            anInt5414++;
            return method662(i, i_23_, -1, 127, i_22_, bool, class101);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("nca.MA(" + i + ',' + i_22_ + ',' + (class101 != null ? "{...}" : "null") + ',' + bool + ',' + i_23_ + ')'));
        }
    }
    ...
    final r ba(r var_r) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, "nca.ba(" + (var_r != null ? "{...}" : "null") + ')');
        }
    }
    ...
    private final boolean method662(int i, int i_30_, int i_31_, int i_32_, int i_33_, boolean bool, Class101 class101) {
        try {
            anInt5450++;
            Class101_Sub2 class101_sub2 = (Class101_Sub2) class101;
            Class101_Sub2 class101_sub2_34_ = aHa_Sub3_5419.aClass101_Sub2_8080;
            ...
            if (bool_37_ && f_38_ < (float) i && f_39_ > (float) i && f_40_ < (float) i_33_ && f_41_ > (float) i_33_) {
                ...
                for (int i_82_ = 0; anInt5478 > i_82_; i_82_++) {
                    if ((Class318_Sub1_Sub1_Sub1.anIntArray9949[aShortArray5508[i_82_]]) != -999999 && (Class318_Sub1_Sub1_Sub1.anIntArray9949[aShortArray5495[i_82_]]) != -999999 && (Class318_Sub1_Sub1_Sub1.anIntArray9949[aShortArray5512[i_82_]]) != -999999 && method671(i, (Class318_Sub1_Sub1_Sub1.anIntArray9949[aShortArray5512[i_82_]]), (Class318_Sub1_Sub1_Sub1.anIntArray9949[aShortArray5495[i_82_]]), (Class101.anIntArray1593[aShortArray5512[i_82_]]), (Class101.anIntArray1593[aShortArray5508[i_82_]]), i_33_, 0, (Class318_Sub1_Sub1_Sub1.anIntArray9949[aShortArray5508[i_82_]]), (Class101.anIntArray1593[aShortArray5495[i_82_]])))
                        return true;
                }
            }
            return false;
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("nca.AB(" + i + ',' + i_30_ + ',' + i_31_ + ',' + i_32_ + ',' + i_33_ + ',' + bool + ',' + (class101 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    private final void method663(int i) {
        ...
        if (aBoolean5402) {
            ...
            if (aClass129Array5457 == null && aClass342Array5474 == null && aClass353Array5524 == null) {
                ...
                if (anIntArray5519 != null && !Class246.method1887(0, anInt5472, anInt5463)) {
            ...
            if (aShortArray5423 != null && !Class10.method219(anInt5463, false, anInt5472)) {
    ...
    final void FA(int i) {
        anInt5488++;
        int i_87_ = Class70.anIntArray1207[i];
        int i_88_ = Class70.anIntArray1204[i];
    ...
    final void P(int i, int i_91_, int i_92_, int i_93_) {
        ...
        if (i == 0) {
            ...
            for (int i_97_ = 0; anInt5433 > i_97_; i_97_++) {
                ...
                if (i_93_ != 0) {
                    int i_98_ = Class70.anIntArray1207[i_93_];
                    int i_99_ = Class70.anIntArray1204[i_93_];
                ...
                if (i_91_ != 0) {
                    int i_101_ = Class70.anIntArray1207[i_91_];
                    int i_102_ = Class70.anIntArray1204[i_91_];
                ...
                if (i_92_ != 0) {
                    int i_104_ = Class70.anIntArray1207[i_92_];
                    int i_105_ = Class70.anIntArray1204[i_92_];
            ...
            for (int i_111_ = 0; i_111_ < anInt5478; i_111_++) {
                ...
                aShortArray5486[i_111_] = (short) (Class273.method2057(Class273.method2057(i_114_ << 7, i_113_ << 10), i_115_));
            }
            if (aClass353Array5524 != null) {
                for (int i_116_ = 0; i_116_ < anInt5406; i_116_++) {
                    ...
                    class334.anInt4156 = ((Class10.anIntArray179[(aShortArray5486[class353.anInt4342] & 0xffff)]) & 0xffffff | ~0xffffff & class334.anInt4156);
                }
            }
            method670(-109);
        } else if (i == 8) {
    ...
    private final void method665(int i, r_Sub1 var_r_Sub1) {
        try {
            ...
            if (i >= 0) {
                ...
                for (int i_130_ = 0; anInt5516 > i_130_; i_130_++) {
                    if (aByteArray5515 == null || aByteArray5515[i_130_] <= 128) {
                        ...
                        int i_134_ = Class318_Sub1_Sub1_Sub1.anIntArray9949[i_131_];
                        int i_135_ = Class318_Sub1_Sub1_Sub1.anIntArray9949[i_132_];
                        int i_136_ = Class318_Sub1_Sub1_Sub1.anIntArray9949[i_133_];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.B(" + i + ',' + (var_r_Sub1 != null ? "{...}" : "null") + ')'));
        }
    }

    final void k(int i) {
        anInt5490++;
        int i_140_ = Class70.anIntArray1207[i];
        int i_141_ = Class70.anIntArray1204[i];
    ...
    final void method610(Class101 class101, int i, boolean bool) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.za(" + (class101 != null ? "{...}" : "null") + ',' + i + ',' + bool + ')'));
        }
    }
    ...
    private final Class64 method668(boolean bool, Class64_Sub2 class64_sub2_153_, Class64_Sub2 class64_sub2_154_, int i, boolean bool_155_, int i_156_) {
        try {
            ...
            if (Class348_Sub42_Sub8_Sub2.method3200(i, anInt5472, (byte) -75)) {
            ...
            if (Class274.method2058(i, anInt5472, 116)) {
                ...
                if (aClass151_5503 == null) {
                    ...
                    if (class64_sub2_153_.aClass151_5503 == null) class64_sub2_153_.aClass151_5503 = new Class151();
                    Class151 class151 = (class64_sub2_154_.aClass151_5503 = class64_sub2_153_.aClass151_5503);
            ...
            } else if (!Class188.method1412((byte) -35, anInt5472, i)) class64_sub2_154_.aClass290_5424 = null;
            ...
            if (Class348_Sub40_Sub26.method3119(i, i_156_ ^ 0x6897, anInt5472)) {
                if (class64_sub2_153_.aClass334Array5442 != null && (anInt5406 <= class64_sub2_153_.aClass334Array5442.length)) {
                    ...
                    for (int i_174_ = 0; anInt5406 > i_174_; i_174_++)
                        class64_sub2_154_.aClass334Array5442[i_174_].method2648(aClass334Array5442[i_174_], (byte) 118);
                } else {
                    int i_175_ = anInt5406;
                    class64_sub2_154_.aClass334Array5442 = class64_sub2_153_.aClass334Array5442 = new Class334[i_175_];
                    for (int i_176_ = 0; i_176_ < anInt5406; i_176_++)
                        class64_sub2_154_.aClass334Array5442[i_176_] = (aClass334Array5442[i_176_].method2649(Class348_Sub21.method2955(i_156_, 26792)));
                }
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.U(" + bool + ',' + (class64_sub2_153_ != null ? "{...}" : "null") + ',' + (class64_sub2_154_ != null ? "{...}" : "null") + ',' + i + ',' + bool_155_ + ',' + i_156_ + ')'));
        }
    }
    ...
    final void method608(Class101 class101, Class318_Sub3 class318_sub3, int i, int i_179_) {
        try {
            anInt5487++;
            if (anInt5475 != 0) {
                Class101_Sub2 class101_sub2 = aHa_Sub3_5419.aClass101_Sub2_8080;
                ...
                float f = (Class240.aFloat4673 + (float) anInt5461 * Class353.aFloat4338);
                float f_181_ = (Class353.aFloat4338 * (float) anInt5509 + Class240.aFloat4673);
                float f_182_;
                float f_183_;
                if (f_181_ < f) {
                ...
                if (!(aHa_Sub3_5419.aFloat8089 <= f_182_) && !((float) aHa_Sub3_5419.anInt8095 >= f_183_)) {
                    ...
                    float f_184_ = (((float) anInt5461 * Class318_Sub1_Sub2_Sub1.aFloat10199) + Class345.aFloat4268);
                    float f_185_ = ((Class318_Sub1_Sub2_Sub1.aFloat10199 * (float) anInt5509) + Class345.aFloat4268);
                    float f_186_;
                    float f_187_;
                    if (f_185_ < f_184_) {
                    ...
                    if (!(aHa_Sub3_5419.aFloat8158 <= f_187_ / (float) i) && !(f_186_ / (float) i <= aHa_Sub3_5419.aFloat8126)) {
                        ...
                        float f_188_ = (Class348_Sub12.aFloat6752 + Class290.aFloat3710 * (float) anInt5461);
                        float f_189_ = ((float) anInt5509 * Class290.aFloat3710 + Class348_Sub12.aFloat6752);
                        float f_190_;
                        float f_191_;
                        if (f_189_ < f_188_) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.Q(" + (class101 != null ? "{...}" : "null") + ',' + (class318_sub3 != null ? "{...}" : "null") + ',' + i + ',' + i_179_ + ')'));
        }
    }
    ...
    final void method605(int i, int[] is, int i_212_, int i_213_, int i_214_, int i_215_, boolean bool) {
        try {
                    ...
                    if (anIntArrayArray5413.length > i_229_) {
                        ...
                        if ((0x1 & i_215_) == 0) {
                            for (int i_231_ = 0; (is_230_.length > i_231_); i_231_++) {
                                ...
                                if (i_214_ != 0) {
                                    int i_233_ = Class70.anIntArray1207[i_214_];
                                    int i_234_ = Class70.anIntArray1204[i_214_];
                                ...
                                if (i_212_ != 0) {
                                    int i_236_ = Class70.anIntArray1207[i_212_];
                                    int i_237_ = Class70.anIntArray1204[i_212_];
                                ...
                                if (i_213_ != 0) {
                                    int i_239_ = Class70.anIntArray1207[i_213_];
                                    int i_240_ = Class70.anIntArray1204[i_213_];
                            ...
                            for (int i_242_ = 0; i_242_ < is_230_.length; i_242_++) {
                                ...
                                if (i_212_ != 0) {
                                    int i_244_ = Class70.anIntArray1207[i_212_];
                                    int i_245_ = Class70.anIntArray1204[i_212_];
                                ...
                                if (i_214_ != 0) {
                                    int i_247_ = Class70.anIntArray1207[i_214_];
                                    int i_248_ = Class70.anIntArray1204[i_214_];
                                ...
                                if (i_213_ != 0) {
                                    int i_250_ = Class70.anIntArray1207[i_213_];
                                    int i_251_ = Class70.anIntArray1204[i_213_];
                        ...
                        if (i_254_ < anIntArrayArray5413.length) {
                            ...
                            for (int i_256_ = 0; i_256_ < is_255_.length; i_256_++) {
                                ...
                                for (int i_260_ = i_258_; (i_259_ > i_260_); i_260_++) {
                                    ...
                                    if (i_261_ == -1) break;
                                    if (i_214_ != 0) {
                                        int i_262_ = Class70.anIntArray1207[i_214_];
                                        int i_263_ = Class70.anIntArray1204[i_214_];
                                    ...
                                    if (i_212_ != 0) {
                                        int i_265_ = Class70.anIntArray1207[i_212_];
                                        int i_266_ = Class70.anIntArray1204[i_212_];
                                    ...
                                    if (i_213_ != 0) {
                                        int i_268_ = Class70.anIntArray1207[i_213_];
                                        int i_269_ = Class70.anIntArray1204[i_213_];
                    ...
                    for (int i_285_ = 0; i_216_ > i_285_; i_285_++) {
                        ...
                        if (anIntArrayArray5492.length > i_286_) {
                            ...
                            for (int i_288_ = 0; i_288_ < is_287_.length; i_288_++) {
                                ...
                                aShortArray5486[i_289_] = (short) (Class273.method2057(i_293_, (Class273.method2057(i_291_ << 10, i_292_ << 7))));
                            }
                    ...
                    if (bool_284_) {
                        if (aClass353Array5524 != null) {
                            for (int i_294_ = 0; anInt5406 > i_294_; i_294_++) {
                                ...
                                class334.anInt4156 = (0xffffff & (Class10.anIntArray179[(aShortArray5486[(class353.anInt4342)]) & 0xffff]) | (~0xffffff & class334.anInt4156));
                            }
                        }
                        method670(-100);
                    }
                    ...
                    for (int i_295_ = 0; i_216_ > i_295_; i_295_++) {
                        ...
                        if (anIntArrayArray5412.length > i_296_) {
                            ...
                            for (int i_298_ = 0; (is_297_.length > i_298_); i_298_++) {
                                Class334 class334 = aClass334Array5442[is_297_[i_298_]];
                    ...
                    for (int i_299_ = 0; i_216_ > i_299_; i_299_++) {
                        ...
                        if (i_300_ < anIntArrayArray5412.length) {
                            ...
                            for (int i_302_ = 0; is_301_.length > i_302_; i_302_++) {
                                Class334 class334 = aClass334Array5442[is_301_[i_302_]];
                    ...
                    for (int i_303_ = 0; i_303_ < i_216_; i_303_++) {
                        ...
                        if (anIntArrayArray5412.length > i_304_) {
                            ...
                            for (int i_306_ = 0; (i_306_ < is_305_.length); i_306_++) {
                                Class334 class334 = aClass334Array5442[is_305_[i_306_]];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.BB(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_212_ + ',' + i_213_ + ',' + i_214_ + ',' + i_215_ + ',' + bool + ')'));
        }
    }
    ...
    final void method615(Class101 class101, Class318_Sub3 class318_sub3, int i) {
        try {
            ...
            if (anInt5475 != 0) {
                ...
                float f = (Class353.aFloat4338 * (float) anInt5461 + Class240.aFloat4673);
                float f_308_ = ((float) anInt5509 * Class353.aFloat4338 + Class240.aFloat4673);
                float f_309_;
                float f_310_;
                if (f > f_308_) {
                ...
                if (!(aHa_Sub3_5419.aFloat8169 <= f_310_) && !(f_309_ <= (float) aHa_Sub3_5419.anInt8095)) {
                    ...
                    float f_311_ = (((float) anInt5461 * Class318_Sub1_Sub2_Sub1.aFloat10199) + Class345.aFloat4268);
                    float f_312_ = (Class345.aFloat4268 + (Class318_Sub1_Sub2_Sub1.aFloat10199 * (float) anInt5509));
                    float f_313_;
                    float f_314_;
                    if (f_311_ > f_312_) {
                    ...
                    if (!(aHa_Sub3_5419.aFloat8158 <= f_314_ / f_309_) && !(f_313_ / f_309_ <= aHa_Sub3_5419.aFloat8126)) {
                        ...
                        float f_315_ = ((float) anInt5461 * Class290.aFloat3710 + Class348_Sub12.aFloat6752);
                        float f_316_ = (Class290.aFloat3710 * (float) anInt5509 + Class348_Sub12.aFloat6752);
                        float f_317_;
                        float f_318_;
                        if (f_316_ < f_315_) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.KA(" + (class101 != null ? "{...}" : "null") + ',' + (class318_sub3 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }
    ...
    final void s(int i) {
        ...
        if (aClass290_5482 != null) aClass290_5482.aBoolean3709 = Class348_Sub42_Sub8_Sub2.method3200(i, anInt5472, (byte) 73);
    ...
    Class64_Sub2(ha_Sub3 var_ha_Sub3, Class124 class124, int i, int i_334_, int i_335_, int i_336_) {
        ...
        do {
            try {
                ...
                aShortArray5438 = Class331.method2639((byte) -125, aShortArray5438, anInt5475);
                aShortArray5436 = Class331.method2639((byte) 70, aShortArray5436, anInt5475);
    ...
    private final boolean method671(int i, int i_466_, int i_467_, int i_468_, int i_469_, int i_470_, int i_471_, int i_472_, int i_473_) {
        anInt5518++;
    ...
    final boolean method623(int i, int i_478_, Class101 class101, boolean bool, int i_479_, int i_480_) {
        try {
            anInt5517++;
            return method662(i, i_479_, i_480_, 126, i_478_, bool, class101);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("nca.OA(" + i + ',' + i_478_ + ',' + (class101 != null ? "{...}" : "null") + ',' + bool + ',' + i_479_ + ',' + i_480_ + ')'));
        }
    }
    ...
    final void method613(Class64 class64, int i, int i_483_, int i_484_, boolean bool) {
        try {
            anInt5417++;
                                ...
                                if (i_513_ != -1) {
                                    for (int i_517_ = 0; i_486_ > i_517_; i_517_++) {
                                        if ((is[i_517_] == i_511_) && (is_488_[i_517_] == i_512_) && (i_510_ == is_487_[i_517_])) {
                                            ...
                                            if (i_518_ != -1) {
                                                if (is_494_ == null) {
                                                    aClass151_5503 = new Class151();
                                                    is_494_ = aClass151_5503.aShortArray2067 = (Class50_Sub3.method470(aShortArray5493, (byte) -123));
                                                    is_493_ = aClass151_5503.aShortArray2060 = (Class50_Sub3.method470(aShortArray5438, (byte) -126));
                                                    is_496_ = aClass151_5503.aShortArray2058 = (Class50_Sub3.method470(aShortArray5436, (byte) -111));
                                                    is_495_ = aClass151_5503.aByteArray2069 = (Class309.method2309(-106, aByteArray5499));
                                                }
                                                if (is_500_ == null) {
                                                    Class151 class151 = (class64_sub2_485_.aClass151_5503 = new Class151());
                                                    is_500_ = class151.aShortArray2067 = (Class50_Sub3.method470(is_489_, (byte) -120));
                                                    is_497_ = class151.aShortArray2060 = (Class50_Sub3.method470(is_490_, (byte) -104));
                                                    is_499_ = class151.aShortArray2058 = (Class50_Sub3.method470(is_491_, (byte) -118));
                                                    is_498_ = class151.aByteArray2069 = (Class309.method2309(-114, is_492_));
                                                }
                                                ...
                                                class64_sub2_485_.method673((byte) 80);
                                                method673((byte) -111);
                                            }
                                        }
                                    }
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.PA(" + (class64 != null ? "{...}" : "null") + ',' + i + ',' + i_483_ + ',' + i_484_ + ',' + bool + ')'));
        }
    }
    ...
    final void ia(short i, short i_528_) {
        ...
        if (aClass353Array5524 != null) {
            for (int i_530_ = 0; i_530_ < anInt5406; i_530_++) {
                ...
                class334.anInt4156 = ((Class10.anIntArray179[0xffff & aShortArray5486[(class353.anInt4342)]]) & 0xffffff | class334.anInt4156 & ~0xffffff);
            }
        }
        method670(-119);
    }

    final Class64 method614(byte i, int i_531_, boolean bool) {
        anInt5426++;
        ...
        } else class64_sub2_533_ = class64_sub2_532_ = new Class64_Sub2(aHa_Sub3_5419, 0, 0, true, false);
    ...
    final void method624(int i, int i_560_, int i_561_, int i_562_) {
        ...
        for (int i_563_ = 0; anInt5478 > i_563_; i_563_++) {
            ...
            aShortArray5486[i_563_] = (short) (Class273.method2057(Class273.method2057(i_565_ << 10, i_566_ << 7), i_567_));
        }
        if (aClass353Array5524 != null) {
            for (int i_568_ = 0; anInt5406 > i_568_; i_568_++) {
                ...
                class334.anInt4156 = (class334.anInt4156 & ~0xffffff | (Class10.anIntArray179[(aShortArray5486[class353.anInt4342] & 0xffff)]) & 0xffffff);
            }
        }
        method670(-107);
    }
    ...
    final void I(int i, int[] is, int i_590_, int i_591_, int i_592_, boolean bool, int i_593_, int[] is_594_) {
        try {
            ...
            if (i == 0) {
                ...
                if (is_594_ == null) {
                        ...
                        if (i_659_ < anIntArrayArray5413.length) {
                            ...
                            for (int i_661_ = 0; is_660_.length > i_661_; i_661_++) {
                                ...
                                if (aShortArray5494 == null || ((aShortArray5494[i_662_] & i_593_) != 0)) {
                                    ...
                                    if (i_592_ != 0) {
                                        int i_663_ = Class70.anIntArray1207[i_592_];
                                        int i_664_ = Class70.anIntArray1204[i_592_];
                                    ...
                                    if (i_590_ != 0) {
                                        int i_666_ = Class70.anIntArray1207[i_590_];
                                        int i_667_ = Class70.anIntArray1204[i_590_];
                                    ...
                                    if (i_591_ != 0) {
                                        int i_669_ = Class70.anIntArray1207[i_591_];
                                        int i_670_ = Class70.anIntArray1204[i_591_];
                                ...
                                for (int i_675_ = 0; i_675_ < is_674_.length; i_675_++) {
                                    ...
                                    if (aShortArray5494 == null || ((aShortArray5494[i_676_] & i_593_) != 0)) {
                                        ...
                                        for (int i_679_ = i_677_; (i_679_ < i_678_); i_679_++) {
                                            ...
                                            if (i_680_ == -1) break;
                                            if (i_592_ != 0) {
                                                int i_681_ = (Class70.anIntArray1207[i_592_]);
                                                int i_682_ = (Class70.anIntArray1204[i_592_]);
                                            ...
                                            if (i_590_ != 0) {
                                                int i_684_ = (Class70.anIntArray1207[i_590_]);
                                                int i_685_ = (Class70.anIntArray1204[i_590_]);
                                            ...
                                            if (i_591_ != 0) {
                                                int i_687_ = (Class70.anIntArray1207[i_591_]);
                                                int i_688_ = (Class70.anIntArray1204[i_591_]);
                    ...
                    if (Class64_Sub3.aBoolean5609) {
                        int i_616_ = ((is_594_[6] * Class346.anInt4274 + (Class136.anInt4795 * is_594_[0] - -(Class26.anInt386 * is_594_[3])) + 8192) >> 14);
                        int i_617_ = ((is_594_[7] * Class346.anInt4274 + (is_594_[1] * Class136.anInt4795 - -(is_594_[4] * Class26.anInt386) + 8192)) >> 14);
                        i_616_ += i_613_;
                        int i_618_ = ((8192 + Class346.anInt4274 * is_594_[8] + Class136.anInt4795 * is_594_[2] + Class26.anInt386 * is_594_[5]) >> 14);
                        i_617_ += i_614_;
                        i_618_ += i_615_;
                    ...
                    int i_620_ = Class70.anIntArray1204[i_590_];
                    int i_621_ = Class70.anIntArray1207[i_590_];
                    int i_622_ = Class70.anIntArray1204[i_591_];
                    int i_623_ = Class70.anIntArray1207[i_591_];
                    int i_624_ = Class70.anIntArray1204[i_592_];
                    int i_625_ = Class70.anIntArray1207[i_592_];
                    ...
                    int i_628_ = ((-Class346.anInt4274 * is_619_[2] + is_619_[1] * -Class26.anInt386 + (is_619_[0] * -Class136.anInt4795 + 8192)) >> 14);
                    int i_629_ = ((8192 + -Class346.anInt4274 * is_619_[5] + (-Class136.anInt4795 * is_619_[3] - -(is_619_[4] * -Class26.anInt386))) >> 14);
                    int i_630_ = ((8192 + -Class346.anInt4274 * is_619_[8] + (-Class136.anInt4795 * is_619_[6] + -Class26.anInt386 * is_619_[7])) >> 14);
                    int i_631_ = Class136.anInt4795 + i_628_;
                    int i_632_ = i_629_ + Class26.anInt386;
                    int i_633_ = i_630_ - -Class346.anInt4274;
                ...
                if (is_594_ == null) {
                    ...
                    if (Class64_Sub3.aBoolean5609) {
                        int i_701_ = ((Class346.anInt4274 * is_594_[6] + (Class136.anInt4795 * is_594_[0] + (is_594_[3] * Class26.anInt386 + 8192))) >> 14);
                        int i_702_ = (8192 + (Class136.anInt4795 * is_594_[1] + (Class26.anInt386 * is_594_[4] - -(is_594_[7] * Class346.anInt4274))) >> 14);
                        i_701_ += i_698_;
                        i_702_ += i_699_;
                        int i_703_ = ((8192 + is_594_[2] * Class136.anInt4795 - -(is_594_[5] * Class26.anInt386) - -(Class346.anInt4274 * is_594_[8])) >> 14);
                        i_703_ += i_700_;
                    ...
                    int i_707_ = -Class136.anInt4795 * i_704_ + 8192 >> 14;
                    int i_708_ = 8192 + -Class26.anInt386 * i_705_ >> 14;
                    int i_709_ = 8192 + -Class346.anInt4274 * i_706_ >> 14;
                    int i_710_ = i_707_ + Class136.anInt4795;
                    int i_711_ = i_708_ + Class26.anInt386;
                    int i_712_ = Class346.anInt4274 + i_709_;
                        ...
                        if (anIntArrayArray5492.length > i_743_) {
                            ...
                            for (int i_745_ = 0; is_744_.length > i_745_; i_745_++) {
                                ...
                                if (aShortArray5432 == null || ((aShortArray5432[i_746_] & i_593_) != 0)) {
                                    ...
                                    aShortArray5486[i_746_] = (short) (Class273.method2057((Class273.method2057(i_749_ << 7, i_748_ << 10)), i_750_));
                                }
                            }
                    ...
                    if (bool_741_) {
                        if (aClass353Array5524 != null) {
                            for (int i_751_ = 0; anInt5406 > i_751_; i_751_++) {
                                ...
                                class334.anInt4156 = ((class334.anInt4156 & ~0xffffff) | (0xffffff & (Class10.anIntArray179[0xffff & (aShortArray5486[(class353.anInt4342)])])));
                            }
                        }
                        method670(-90);
                    }
                    ...
                    for (int i_752_ = 0; i_595_ > i_752_; i_752_++) {
                        ...
                        if (i_753_ < anIntArrayArray5412.length) {
                            ...
                            for (int i_755_ = 0; (i_755_ < is_754_.length); i_755_++) {
                                Class334 class334 = aClass334Array5442[is_754_[i_755_]];
                    ...
                    for (int i_756_ = 0; i_595_ > i_756_; i_756_++) {
                        ...
                        if (anIntArrayArray5412.length > i_757_) {
                            ...
                            for (int i_759_ = 0; (i_759_ < is_758_.length); i_759_++) {
                                Class334 class334 = aClass334Array5442[is_758_[i_759_]];
                    ...
                    for (int i_760_ = 0; i_760_ < i_595_; i_760_++) {
                        ...
                        if (anIntArrayArray5412.length > i_761_) {
                            ...
                            for (int i_763_ = 0; (is_762_.length > i_763_); i_763_++) {
                                Class334 class334 = aClass334Array5442[is_762_[i_763_]];
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.I(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_590_ + ',' + i_591_ + ',' + i_592_ + ',' + bool + ',' + i_593_ + ',' + (is_594_ != null ? "{...}" : "null") + ')'));
        }
    }

    Class64_Sub2(ha_Sub3 var_ha_Sub3, int i, int i_764_, boolean bool, boolean bool_765_) {
        aBoolean5428 = false;
        aBoolean5477 = false;
        anInt5478 = 0;
        anInt5475 = 0;
        ...
        try {
            ...
            if (bool || Class239_Sub26.method1837(anInt5472, 102, anInt5463)) aClass290_5460 = new Class290(Class183.method1379(4, anInt5472, anInt5463));
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("nca.<init>(" + (var_ha_Sub3 != null ? "{...}" : "null") + ',' + i + ',' + i_764_ + ',' + bool + ',' + bool_765_ + ')'));
        }
    }
}
