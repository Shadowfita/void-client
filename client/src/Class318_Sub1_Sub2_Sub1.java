...
final class Class318_Sub1_Sub2_Sub1 extends Class318_Sub1_Sub2 {
    ...
    final int method2393(int i) {
        ...
        ObjType ObjType = (Exception_Sub1.aClass255_112.getItemDefinitions(-115, this.anInt10181));
        int i_0_ = ObjType.anInt2784;
        if (this.anInt10189 != -1) {
            ObjType class213_1_ = (Exception_Sub1.aClass255_112.getItemDefinitions(74, this.anInt10189));
            if (class213_1_.anInt2784 > i_0_) i_0_ = class213_1_.anInt2784;
        }
        if (this.anInt10180 != -1) {
            ObjType class213_2_ = (Exception_Sub1.aClass255_112.getItemDefinitions(-88, this.anInt10180));
    ...
    final boolean method2391(ha var_ha, int i, int i_7_, int i_8_) {
        ...
        ObjType ObjType = (Exception_Sub1.aClass255_112.getItemDefinitions(i_8_ ^ 0x6b, this.anInt10181));
        Class64 class64 = ObjType.getModel(null, null, var_ha, 131072, 0, this.anInt10185, 0, (byte) 88, -1);
        if (class64 != null && (Class305.aBoolean3870 ? class64.method623(i_7_, i, class101, true, ObjType.anInt2784, Class132.anInt1906) : class64.method628(i_7_, i, class101, true, ObjType.anInt2784))) return true;
        if ((~this.anInt10189) != i_8_) {
            ObjType class213_9_ = (Exception_Sub1.aClass255_112.getItemDefinitions(-88, this.anInt10189));
            class64 = class213_9_.getModel(null, null, var_ha, 131072, 0, (this.anInt10190), 0, (byte) 88, -1);
            if (class64 != null && (Class305.aBoolean3870 ? class64.method623(i_7_, i, class101, true, class213_9_.anInt2784, Class132.anInt1906) : class64.method628(i_7_, i, class101, true, class213_9_.anInt2784))) return true;
        }
        if (this.anInt10180 != -1) {
            ObjType class213_10_ = (Exception_Sub1.aClass255_112.getItemDefinitions(-99, this.anInt10180));
            class64 = class213_10_.getModel(null, null, var_ha, 131072, 0, (this.anInt10186), 0, (byte) 88, -1);
            return class64 != null && (!Class305.aBoolean3870 ? class64.method628(i_7_, i, class101, true, class213_10_.anInt2784) : class64.method623(i_7_, i, class101, true, class213_10_.anInt2784, Class132.anInt1906));
        }
        return false;
    }
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        anInt10184 = 0;
        if (this.anInt10180 != -1) {
            Class64 class64 = (Exception_Sub1.aClass255_112.getItemDefinitions(i ^ 0x6c, this.anInt10180).getModel(null, null, var_ha, 2048, 0, this.anInt10186, 0, (byte) 88, -1));
            if (class64 != null) {
        ...
        if (this.anInt10189 != -1) {
            Class64 class64 = (Exception_Sub1.aClass255_112.getItemDefinitions(i ^ ~0x3b, this.anInt10189).getModel(null, null, var_ha, 2048, 0, this.anInt10190, 0, (byte) 88, -1));
            if (class64 != null) {
        ...
        Class64 class64 = (Exception_Sub1.aClass255_112.getItemDefinitions(-48, this.anInt10181).getModel(null, null, var_ha, 2048, 0, this.anInt10185, 0, (byte) 88, -1));
        if (class64 != null) {
