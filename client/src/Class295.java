...
final class Class295 {
    ...
    static Class348_Sub42_Sub17[] aClass348_Sub42_Sub17Array3753 = new Class348_Sub42_Sub17[14];
    String aString3754;
    ...
    Class295(String string, String string_4_, String string_5_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("wc.<init>(" + (string != null ? "{...}" : "null") + ',' + (string_4_ != null ? "{...}" : "null") + ',' + (string_5_ != null ? "{...}" : "null") + ')'));
        }
    }
