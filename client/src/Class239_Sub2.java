...
final class Class239_Sub2 extends Class239 {
    ...
    static final void method1725(int i) {
        ...
        if (Class76.aFloat1287 < (float) i_1_) Class76.aFloat1287 = (float) i_1_;
        if (Class76.aFloat1287 > (float) i_2_) Class76.aFloat1287 = (float) i_2_;
        for (/**/; Class314.aFloat3938 >= 16384.0F; Class314.aFloat3938 -= 16384.0F) {
            /* empty */
        }
        ...
        if (IntNode.anInt6979 < i_12_) IntNode.anInt6979 += (i_12_ - IntNode.anInt6979) / 24;
        else if (IntNode.anInt6979 > i_12_) IntNode.anInt6979 += (-IntNode.anInt6979 + i_12_) / 80;
    }
