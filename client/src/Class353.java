        ...
        for (; ; ) {
            ...
            for (int i_16_ = 0; i_16_ < i_9_; i_16_++) {
                for (int i_17_ = 0; i_17_ < i_8_; i_17_++) {
                    ...
                    int i_22_ = (0xff2fb7 & i_18_) >> 16;
                    int i_23_ = 0xff & i_18_ >> 24;
                    int i_24_ = (i_18_ & 0xff43) >> 8;
                    int i_25_ = is_10_[i_14_++];
                    i_23_ += 0xff & i_19_ >> 24;
                    i_22_ += (i_19_ & 0xff6a76) >> 16;
                    i_21_ += 0xff & i_19_;
                    i_24_ += (i_19_ & 0xff5a) >> 8;
                    i_23_ += 0xff & i_20_ >> 24;
                    i_22_ += (i_20_ & 0xff2819) >> 16;
                    i_24_ += (i_20_ & 0xff76) >> 8;
                    i_21_ += i_20_ & 0xff;
                    i_21_ += 0xff & i_25_;
                    i_24_ += i_25_ >> 8 & 0xff;
                    i_23_ += 0xff & i_25_ >> 24;
                    i_22_ += (0xff943a & i_25_) >> 16;
                    is_11_[i_12_++] = (Class273.method2057((Class273.method2057(Class139.method1166(i_24_ << 6, 65280), Class273.method2057((Class139.method1166(1020, i_22_) << 14), (Class139.method1166(i_23_, 1020) << 22)))), Class139.method1166(i_21_, 1020) >> 2));
                }
                i_13_ += i_3_;
                i_14_ += i_3_;
            }
