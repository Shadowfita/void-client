...
final class Class348_Sub47 extends Node {
    BitPacket aClass348_Sub49_Sub2_7116;
        ...
        do {
            try {
                ...
                if (i > 40) {
                    ...
                    System.out.println("Emitters: " + Class122.anInt1803 + " Particles: " + Class313.anInt3936 + ". Time taken: " + (-l_1_ + Class62.method599(-112)) + "ms");
                }
    ...
    static final boolean method3325(int i, int i_2_, boolean bool) {
        ...
        anInt7121++;
        return (((0x2000 & i) != 0 | Class156.method1241(i_2_, i, -118) | Class239_Sub1.method1722(i, i_2_, (byte) 94)) & aa_Sub3.method166((byte) 105, i_2_, i));
    }

    final void method3326(byte i) {
        anInt7117++;
        if (Class176.aClass348_Sub47Array2334.length > Class239_Sub13.anInt5980 && i == -45) Class176.aClass348_Sub47Array2334[Class239_Sub13.anInt5980++] = this;
    }
        ...
        if (i == 1406) {
            if (Class348_Sub8.aHa6654.method3694()) {
                ...
                if (!Class59_Sub1.aBoolean5300) {
                    Class348_Sub8.aHa6654.method3643(Class305.aCanvas3869, Class321.anInt4017, Class348_Sub42_Sub8_Sub2.anInt10432);
