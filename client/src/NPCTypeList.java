/* NPCTypeList - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class NPCTypeList {
    Js5Archive aClass45_3576;
    private ReferenceCache aClass60_3577 = new ReferenceCache(64);
    ...
    private final Js5Archive aClass45_3585;
    static int anInt3586;
    static int anInt3587;
    static int anInt3588;
    static int anInt3589;
    ReferenceCache aClass60_3590 = new ReferenceCache(50);
    static int anInt3591;
    ReferenceCache aClass60_3592 = new ReferenceCache(5);
    int anInt3593;
    ...
    final NPCType method2079(int i, int i_6_) {
        ...
        NPCType NPCType;
        synchronized (aClass60_3577) {
            NPCType = (NPCType) aClass60_3577.method583(i, -104);
        }
        ...
        NPCType.id = i;
        NPCType.loader = this;
        if (is != null) NPCType.method798(111, new Packet(is));
        NPCType.method799(-117);
        synchronized (aClass60_3577) {
            aClass60_3577.method582(NPCType, i, (byte) -102);
    ...
    NPCTypeList(Class230 class230, int i, boolean bool, Js5Archive Js5Archive, Js5Archive class45_7_) {
        do {
            try {
                this.aBoolean3583 = bool;
                aClass45_3585 = Js5Archive;
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("vda.<init>(" + (class230 != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + (class45_7_ != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
