...
final class Class358 {
    ...
    int[] anIntArray4415;
    int[] anIntArray4416;
    static ReferenceCache aClass60_4417 = new ReferenceCache(50);
    ...
    static final void method3489(int i) {
        ReferenceCache.aHa1098.xa(((float) Class316.aClass348_Sub51_3959.aClass239_Sub10_7232.method1764(-32350) * 0.1F + 0.7F) * 1.1523438F);
        anInt4413++;
        ReferenceCache.aHa1098.ZA(Class268.anInt3439, 0.69921875F, 1.2F, -200.0F, -240.0F, -200.0F);
        ReferenceCache.aHa1098.L(Class268.anInt3444, -1, 0);
        int i_0_ = -35 / ((45 - i) / 44);
        ReferenceCache.aHa1098.method3653(Class348_Sub42_Sub10.aClass299_9571);
    }
