...
final class Class348_Sub40_Sub23 extends Class348_Sub40 {
    ...
    static Class348_Sub22[] aClass348_Sub22Array9319 = new Class348_Sub22[1024];
    ...
    private final void method3112(int i, int i_2_, int[][] is, Random random, int i_3_, int i_4_, int i_5_) {
        try {
            ...
            if (i_9_ <= 0) {
                ...
                for (int i_20_ = 0; i_20_ < i_2_; i_20_++) {
                    ...
                    if (i_20_ < i_17_) {
                        ...
                        if (i_17_ > i_28_) {
                            ...
                            if (i_19_ + i_18_ <= Class348_Sub40_Sub6.anInt9139) Class214.method1579(is_21_, i_18_, i_19_, i_29_);
                                ...
                                int i_34_ = -i_18_ + Class348_Sub40_Sub6.anInt9139;
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("cc.C(" + i + ',' + i_2_ + ',' + (is != null ? "{...}" : "null") + ',' + (random != null ? "{...}" : "null") + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ')'));
        }
    }
        ...
        if (this.aClass191_7032.aBoolean2570) {
            ...
            for (; ; ) {
                ...
                if (bool_48_) i_61_ = 0;
                    ...
                    if (i_65_ < 0) i_65_ += Class348_Sub40_Sub6.anInt9139;
                    if (i_65_ > Class348_Sub40_Sub6.anInt9139) i_65_ -= Class348_Sub40_Sub6.anInt9139;
                    for (; ; ) {
                    ...
                    if (i_62_ != i_47_) {
                        ...
                        if (i_67_ < 0) i_67_ += Class348_Sub40_Sub6.anInt9139;
                        if (Class348_Sub40_Sub6.anInt9139 < i_67_) i_67_ -= Class348_Sub40_Sub6.anInt9139;
                ...
                if (i_60_ == Class348_Sub40_Sub6.anInt9139) {
                    ...
                    i_46_ = 0;
                    int i_80_ = i_43_;
                    if (i_80_ < 0) i_80_ += Class348_Sub40_Sub6.anInt9139;
                    i_47_ = 0;
                    if (i_80_ > Class348_Sub40_Sub6.anInt9139) i_80_ -= Class348_Sub40_Sub6.anInt9139;
                    bool_48_ = false;
                    for (; ; ) {
