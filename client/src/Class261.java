...
final class Class261 {
    ...
    static final String method1981(String string, byte i, char c, String string_0_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("uga.H(" + (string != null ? "{...}" : "null") + ',' + i + ',' + c + ',' + (string_0_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    static final void method1987(int i) {
        ...
        MenuEntrySwapperBridge.apply(Class348_Sub40_Sub4.aClass262_9111);
        ...
        if (Class5_Sub1.aBoolean8335) {
            if (i_14_ == -1) {
                ...
                if (!bool) {
                    ...
                    } else Class286_Sub2.method2146((byte) 70);
                }
            }
            if (i_14_ == 0) {
