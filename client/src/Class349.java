...
final class Class349 {
    ...
    final void method3446(Packet Packet, Class197 class197) {
        int i = Packet.readUnsignedByte(255);
        this.anIntArray4299[0] = i >> 4;
        this.anIntArray4299[1] = i & 0xf;
        if (i != 0) {
            anIntArray4304[0] = Packet.readUnsignedShort(842397944);
            anIntArray4304[1] = Packet.readUnsignedShort(842397944);
            int i_0_ = Packet.readUnsignedByte(255);
            for (int i_1_ = 0; i_1_ < 2; i_1_++) {
                for (int i_2_ = 0; i_2_ < this.anIntArray4299[i_1_]; i_2_++) {
                    anIntArrayArrayArray4302[i_1_][0][i_2_] = Packet.readUnsignedShort(842397944);
                    anIntArrayArrayArray4300[i_1_][0][i_2_] = Packet.readUnsignedShort(842397944);
                }
            }
            for (int i_3_ = 0; i_3_ < 2; i_3_++) {
                for (int i_4_ = 0; i_4_ < this.anIntArray4299[i_3_]; i_4_++) {
                    if ((i_0_ & 1 << i_3_ * 4 << i_4_) == 0) {
                        ...
                        anIntArrayArrayArray4302[i_3_][1][i_4_] = Packet.readUnsignedShort(842397944);
                        anIntArrayArrayArray4300[i_3_][1][i_4_] = Packet.readUnsignedShort(842397944);
                    }
                }
            }
            if (i_0_ != 0 || anIntArray4304[1] != anIntArray4304[0]) class197.method1454(Packet);
    ...
    final int method3451(int i, float f) {
        ...
        for (int i_12_ = 1; i_12_ < this.anIntArray4299[i]; i_12_++) {
            ...
            for (int i_15_ = i_12_ * 2 - 1; i_15_ >= 2; i_15_--)
                aFloatArrayArray4306[i][i_15_] += (aFloatArrayArray4306[i][i_15_ - 1] * f_13_ + aFloatArrayArray4306[i][i_15_ - 2] * f_14_);
            aFloatArrayArray4306[i][1] += aFloatArrayArray4306[i][0] * f_13_ + f_14_;
            aFloatArrayArray4306[i][0] += f_13_;
        }
        if (i == 0) {
            for (int i_16_ = 0; i_16_ < this.anIntArray4299[0] * 2; i_16_++)
                aFloatArrayArray4306[0][i_16_] *= aFloat4305;
        }
        for (int i_17_ = 0; i_17_ < this.anIntArray4299[i] * 2; i_17_++)
            anIntArrayArray4301[i][i_17_] = (int) (aFloatArrayArray4306[i][i_17_] * 65536.0F);
