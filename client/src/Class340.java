...
final class Class340 {
    ...
    private Packet aClass348_Sub49_4215;
    ...
    final Class314_Sub1 method2673(Class137 class137, int i, Class137 class137_3_, int i_4_) {
        try {
            anInt4219++;
    ...
    final boolean method2674(int i) {
        ...
        byte[] is = new byte[(Packet.data.length - Packet.pos)];
        ...
        byte[] is_8_ = Class348_Sub1_Sub2.method2730(4567, 5, (Packet.data), (Packet.pos) - (is.length + 5));
        for (int i_9_ = 0; i_9_ < 64; i_9_++) {
            if (is_8_[i_9_] != is_6_[i_9_ + 1]) {
                throw new RuntimeException();
            }
        }
        aClass348_Sub49_4215 = Packet;
        aClass314_Sub1Array4216 = new Class314_Sub1[idxCount];
        return true;
    }

    private final Class314_Sub1 method2675(byte i, boolean bool, int i_10_, Class137 class137, Class137 class137_11_) {
        try {
            anInt4221++;
            ...
            aClass348_Sub49_4215.pos = 6 + i_10_ * 72;
            ...
            Class314_Sub1 class314_sub1 = new Class314_Sub1(i_10_, class137, class137_11_, aClass248_4212, aClass112_4217, i_12_, is, i_13_, bool);
    ...
    Class340(Class248 class248, Class112 class112, BigInteger biginteger, BigInteger biginteger_14_) {
        do {
            try {
