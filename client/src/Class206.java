...
final class Class206 implements Interface11 {
    ...
    final void method1498(int i, int i_0_, int i_1_, Class258_Sub2 class258_sub2) {
                ...
                if (class10.anInt188 >= (!class10.method220((byte) -66) ? -10 : -1500)) {
                    ...
                    if (class10.anInt188 < 0) {
                        ...
                        if (class10.anInt178 == 0) i_6_ = ((class10.anInt184 * (class10.aByte180 == 3 ? Class316.aClass348_Sub51_3959.aClass239_Sub26_7215.method1838(-32350) : Class316.aClass348_Sub51_3959.aClass239_Sub26_7272.method1838(-32350))) >> 2);
                            ...
                            if ((Class132.aPlayer_1907.plane) == i_7_) {
                                ...
                                if ((class10.aClass318_Sub1_172 != null) && (class10.aClass318_Sub1_172 instanceof Class318_Sub1_Sub3)) {
                                    ...
                                    short i_16_ = (class318_sub1_sub3.aShort8750);
                                }
                                if (i_11_ != 0 || i_13_ != 0) {
                                    int i_17_ = (0x3fff & (-4096 + -Class5.anInt4638 + -(int) (2607.5945876176133 * (Math.atan2(i_11_, i_13_)))));
                        ...
                        if (i_6_ > 0) {
                            ...
                            Class348_Sub16_Sub5 class348_sub16_sub5 = (class10.aClass348_Sub16_Sub5_176 = (Class348_Sub16_Sub5.method2911(class348_sub19_sub1, class10.anInt173, i_6_, i_5_)));
    ...
    private final void method1502(int i, byte i_20_, Class258_Sub2 class258_sub2, int i_21_, int i_22_) {
        anInt4876++;
    ...
    private final int method1504(int i) {
        ...
        if ((0x2 & anInt4872) != 0) return 36009;
        if ((0x1 & anInt4872) != 0) return 36008;
        return -1;
    }
    ...
    private final void method1506(int i, Class258_Sub3 class258_sub3, int i_27_, int i_28_) {
        anInt4892++;
        if (anInt4873 == -1) throw new RuntimeException();
        int i_29_ = 1 << i_27_;
    ...
    final void method1508(int i, Class348_Sub42_Sub2 class348_sub42_sub2, int i_32_) {
        anInt4881++;
        if (anInt4873 == -1) throw new RuntimeException();
        int i_33_ = 1 << i;
