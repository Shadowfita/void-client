...
final class Class348_Sub20 extends Node {
    ...
    final void method2945(int i, byte i_0_, int i_1_, int i_2_) {
        ...
        anIntArray6842[i_1_ * aS_Sub2_6839.anInt4587 + i] = Class273.method2057((anIntArray6842[i_1_ * aS_Sub2_6839.anInt4587 + i]), 1 << i_2_);
    }
    ...
    final void method2948(int i, int i_8_, int[] is) {
        ...
        if (aHa_Sub2_6831.aBoolean7775) {
            ...
            for (int i_16_ = 0; i_8_ > i_16_; i_16_++) {
                ...
                short[] is_19_ = aS_Sub2_6839.aShortArrayArray8267[i_17_];
        ...
        if (i == 97) {
            if (this.anInt6841 != -1) {
                ...
                if (i_29_ != 0) {
                    ...
                    int i_31_ = ((i_24_ & 0xff00) >> 8) * i_29_;
                    if (i_31_ > 65535) i_31_ = 65535;
                    int i_32_ = (0xff & i_24_) * i_29_;
                    if (i_32_ > 65535) i_32_ = 65535;
                    i_24_ = (0xff00 & i_31_) + (((~0x5ff00ff & i_30_) << 8) - -(i_32_ >> 8));
                }
            }
            anInt6838++;
            aStream6846.e(i_22_ * 4);
            if (f != 1.0F) {
                int i_33_ = (i_24_ & 0xff1a66) >> 16;
                int i_34_ = (0xff1d & i_24_) >> 8;
                ...
                i_24_ = i_34_ << 8 | i_33_ << 16 | i_35_;
            }
            aStream6846.f((byte) (i_24_ >> 16));
            aStream6846.f((byte) (i_24_ >> 8));
