...
abstract class Class64 {
                    ...
                    if (bool_18_ || bool_19_) {
                        if (bools != null && bool == !bools[i_16_] && (class348_sub33.anIntArray6957[i_16_]) != 0) {
                            ...
                            if ((0x2 & i_25_) != 0 || (i_29_ & 0x1) != 0) {
                                ...
                                i_32_ = i_26_ - -(i_37_ * i_7_ / i_6_) & 0x3fff;
                                i_33_ = i_38_ * i_7_ / i_6_ + i_24_ & 0x3fff;
                                i_34_ = 0x3fff & i_22_ - -(i_7_ * i_39_ / i_6_);
                            } else if (i_21_ == 9) {
                                int i_35_ = i_30_ + -i_26_ & 0x3fff;
                                if (i_35_ >= 8192) i_35_ -= 16384;
                                i_32_ = i_35_ * i_7_ / i_6_ + i_26_ & 0x3fff;
                                i_33_ = i_34_ = 0;
                            } else if (i_21_ == 7) {
                                int i_36_ = 0x3f & i_30_ + -i_26_;
                                if (i_36_ >= 32) i_36_ -= 64;
                                i_32_ = (i_26_ - -(i_36_ * i_7_ / i_6_) & 0x3f);
    ...
    final void method603(byte i, int i_40_, int[] is, int i_41_, int i_42_, int i_43_, Class348_Sub42_Sub17 class348_sub42_sub17, int i_44_, Class348_Sub42_Sub17 class348_sub42_sub17_45_, boolean bool, int i_46_) {
        try {
            anInt1133++;
            if (i_42_ != -1) {
                method622();
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ka.QB(" + i + ',' + i_40_ + ',' + (is != null ? "{...}" : "null") + ',' + i_41_ + ',' + i_42_ + ',' + i_43_ + ',' + (class348_sub42_sub17 != null ? "{...}" : "null") + ',' + i_44_ + ',' + (class348_sub42_sub17_45_ != null ? "{...}" : "null") + ',' + bool + ',' + i_46_ + ')'));
        }
    }
    ...
    static final void method607(int i, String[] strings, short[] is, int i_64_, boolean bool) {
        try {
            ...
            if (i > i_64_) {
                ...
                is[i_65_] = is[i];
                is[i] = i_67_;
                for (int i_68_ = i_64_; i_68_ < i; i_68_++) {
                    if (string == null || (strings[i_68_] != null && (strings[i_68_].compareTo(string) < (i_68_ & 0x1)))) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ka.UB(" + i + ',' + (strings != null ? "{...}" : "null") + ',' + (is != null ? "{...}" : "null") + ',' + i_64_ + ',' + bool + ')'));
        }
    }
    ...
    final void method611(int i, int i_74_, Class348_Sub42_Sub17 class348_sub42_sub17) {
        anInt1126++;
        if (i != -1) {
            method622();
            if (NA()) {
    ...
    final void method617(int i, int i_83_, Class348_Sub42_Sub17 class348_sub42_sub17, int i_84_, Class348_Sub42_Sub17 class348_sub42_sub17_85_, boolean bool, boolean bool_86_, int i_87_, int i_88_) {
        try {
            anInt1125++;
            if (i != -1) {
                method622();
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ka.BC(" + i + ',' + i_83_ + ',' + (class348_sub42_sub17 != null ? "{...}" : "null") + ',' + i_84_ + ',' + ((class348_sub42_sub17_85_ != null) ? "{...}" : "null") + ',' + bool + ',' + bool_86_ + ',' + i_87_ + ',' + i_88_ + ')'));
        }
    }
    ...
    final void method625(Class348_Sub42_Sub17 class348_sub42_sub17, int i, byte i_101_, int i_102_, Class348_Sub42_Sub17 class348_sub42_sub17_103_, int i_104_, int i_105_, int i_106_, Class348_Sub42_Sub17 class348_sub42_sub17_107_, boolean bool, int i_108_, Class348_Sub42_Sub17 class348_sub42_sub17_109_, int i_110_, boolean[] bools, int i_111_) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ka.VB(" + (class348_sub42_sub17 != null ? "{...}" : "null") + ',' + i + ',' + i_101_ + ',' + i_102_ + ',' + (class348_sub42_sub17_103_ != null ? "{...}" : "null") + ',' + i_104_ + ',' + i_105_ + ',' + i_106_ + ',' + (class348_sub42_sub17_107_ != null ? "{...}" : "null") + ',' + bool + ',' + i_108_ + ',' + (class348_sub42_sub17_109_ != null ? "{...}" : "null") + ',' + i_110_ + ',' + (bools != null ? "{...}" : "null") + ',' + i_111_ + ')'));
        }
    }
    ...
    final void method626(int i, int i_116_, int i_117_, int i_118_, int i_119_, int i_120_, int i_121_, s var_s, int i_122_) {
        ...
        if (i_119_ != 0) {
            int i_140_ = 0x3fff & (int) (Math.atan2(i_137_ - i_138_, i_119_) * 2607.5945876176133);
            if (i_140_ != 0) {
                if (i_121_ != 0) {
                    if (i_140_ > 8192) {
        ...
        int i_142_ = Math.min(i_133_, i_127_);
        if (i != 0) {
            int i_143_ = (0x3fff & (int) (Math.atan2(-i_139_ + i_142_, i) * 2607.5945876176133));
            if (i_143_ != 0) {
                if (i_117_ != 0) {
                    if (i_143_ > 8192) {
        ...
        i_145_ = (i_145_ >> 1) - i_120_;
        if (i_145_ != 0) H(0, i_145_, 0);
    }

    private final void method627(int[] is, boolean bool, int i, int i_146_, int i_147_, int i_148_, byte i_149_, int i_150_, int[] is_151_, int i_152_) {
        try {
            anInt1132++;
            if (i_149_ == -93) {
                if (i != 1) {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ka.PB(" + (is != null ? "{...}" : "null") + ',' + bool + ',' + i + ',' + i_146_ + ',' + i_147_ + ',' + i_148_ + ',' + i_149_ + ',' + i_150_ + ',' + (is_151_ != null ? "{...}" : "null") + ',' + i_152_ + ')'));
        }
    }
