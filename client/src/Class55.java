...
abstract class Class55 {
    ...
    final void method514(byte i, boolean bool) {
        anInt985++;
        if (aClass348_Sub23_Sub1_1008 != null) {
            Class348_Sub16_Sub2 class348_sub16_sub2 = aClass348_Sub23_Sub1_1008.method2971(-96);
        ...
        if (i == -2) {
            ...
            if (!aBoolean1006) {
                while (!aBoolean1007) {
                    ...
                    } else if (!(class348_sub23 instanceof Class348_Sub23_Sub4)) {
                        if (class348_sub23 == aClass348_Sub23_Sub2_1001) {
                            ...
                            while (class348_sub23.anOggStreamState6869.packetOut(anOggPacket993) == 1) {
                                if ((class348_sub23.anInt6868) == 1 && (class348_sub23 instanceof Class348_Sub23_Sub4)) method509(-22, aString1009);
    ...
    private final Class348_Sub23 method521(int i) throws IOException {
        ...
        while (anOggSyncState987.pageOut(anOggPage981) <= 0) {
            ...
            if (!anOggSyncState987.write(aByteArray995, i_31_)) throw new RuntimeException("");
        }
        ...
        if (!oggstreamstate.pageIn(anOggPage981)) throw new IllegalStateException();
        if (oggstreamstate.packetPeek(anOggPacket993) != 1) throw new IllegalStateException();
        Class348_Sub23 class348_sub23;
        if (aClass348_Sub23_Sub2_1001 == null && anOggPacket993.isTheora()) {
            aClass348_Sub23_Sub2_1001 = new Class348_Sub23_Sub2(oggstreamstate);
            class348_sub23 = aClass348_Sub23_Sub2_1001;
        } else if (aClass348_Sub23_Sub1_1008 == null && anOggPacket993.isVorbis()) {
            aClass348_Sub23_Sub1_1008 = new Class348_Sub23_Sub1(oggstreamstate);
            class348_sub23 = aClass348_Sub23_Sub1_1008;
        } else {
            byte[] is = anOggPacket993.getData();
            StringBuffer stringbuffer = new StringBuffer();
            for (int i_33_ = 1; is.length > i_33_; i_33_++) {
                if (!Character.isLetterOrDigit((char) is[i_33_])) break;
