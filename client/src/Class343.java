...
final class Class343 {
    ...
    final void method2688(float[] fs, int i, boolean bool) {
        for (int i_0_ = 0; i_0_ < i; i_0_++)
            fs[i_0_] = 0.0F;
        if (!bool) {
            int i_1_ = (Class348_Sub10.aClass370Array6718[anInt4261].anInt4514);
            ...
            for (int i_4_ = 0; i_4_ < 8; i_4_++) {
                ...
                while (i_5_ < i_3_) {
                    if (i_4_ == 0) {
                        int i_6_ = Class348_Sub10.aClass370Array6718[anInt4261].method3581();
                    ...
                    for (int i_8_ = 0; i_8_ < i_1_; i_8_++) {
                        ...
                        if (i_10_ >= 0) {
                            ...
                            Class370 class370 = Class348_Sub10.aClass370Array6718[i_10_];
                            if (anInt4257 == 0) {
    ...
    Class343() {
        ...
        for (int i = 0; i < anInt4255; i++) {
            ...
            if (bool) i_19_ = Class348_Sub10.method2789(5);
            is[i] = i_19_ << 3 | i_20_;
        }
        anIntArray4260 = new int[anInt4255 * 8];
        for (int i = 0; i < anInt4255 * 8; i++)
            anIntArray4260[i] = ((is[i >> 3] & 1 << (i & 0x7)) != 0 ? Class348_Sub10.method2789(8) : -1);
    }
}
