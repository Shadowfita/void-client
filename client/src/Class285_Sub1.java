...
final class Class285_Sub1 extends Class285 implements Interface5_Impl1 {
    ...
    static final String method2127(int i, String string) {
        ...
        for (i_1_ = string.length(); i_1_ > i_0_; i_0_++) {
            if (!Class26.method311((byte) 113, string.charAt(i_0_))) break;
        }
        for (/**/; (i_0_ < i_1_ && Class26.method311((byte) 104, string.charAt(i_1_ + -1))); i_1_--) {
            /* empty */
        }
        int i_2_ = i_1_ + -i_0_;
    ...
    static final Class369_Sub3_Sub1 method2128(int i, Packet Packet) {
        anInt8495++;
        Class369_Sub3 class369_sub3 = Class348_Sub46.method3322(0, Packet);
