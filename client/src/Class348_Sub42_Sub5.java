...
final class Class348_Sub42_Sub5 extends Class348_Sub42 {
    ...
    final int[] method3183(d var_d, int i, int i_0_, boolean bool, double d, Js5Archive Js5Archive, byte i_1_) {
        try {
            anInt9522++;
            Class286_Sub5.aD6247 = var_d;
            Node.aClass45_4286 = Js5Archive;
            ...
            NPCType.method797(i_0_, i, (byte) 114);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("lr.D(" + (var_d != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + bool + ',' + d + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + i_1_ + ')'));
        }
    }

    final boolean method3184(d var_d, Js5Archive Js5Archive, int i) {
        try {
            anInt9529++;
            if (Class101_Sub2.anInt5713 < 0) {
                ...
                for (int i_18_ = 0; (i_18_ < anIntArray9524.length); i_18_++) {
                    if (!Js5Archive.method420(-10499, Class101_Sub2.anInt5713, anIntArray9524[i_18_])) return false;
                }
            }
            int i_19_ = 0;
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("lr.B(" + (var_d != null ? "{...}" : "null") + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }

    final int[] method3185(int i, d var_d, int i_21_, boolean bool, double d, boolean bool_22_, Js5Archive Js5Archive, int i_23_) {
        try {
            Class286_Sub5.aD6247 = var_d;
            Node.aClass45_4286 = Js5Archive;
            anInt9526++;
            ...
            NPCType.method797(i_23_, i, (byte) 122);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("lr.C(" + i + ',' + (var_d != null ? "{...}" : "null") + ',' + i_21_ + ',' + bool + ',' + d + ',' + bool_22_ + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + i_23_ + ')'));
        }
    }

    final float[] method3186(int i, d var_d, boolean bool, int i_41_, Js5Archive Js5Archive, int i_42_) {
        try {
            anInt9525++;
            Node.aClass45_4286 = Js5Archive;
            Class286_Sub5.aD6247 = var_d;
            ...
            NPCType.method797(i_41_, i, (byte) 115);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("lr.A(" + i + ',' + (var_d != null ? "{...}" : "null") + ',' + bool + ',' + i_41_ + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + i_42_ + ')'));
        }
    }
