/* ChatMessage - Decompiled by JODE
...
final class ChatMessage {
    ...
    ChatMessage(int i, int i_0_, String string, String string_1_, String string_2_, String string_3_, int i_4_, String string_5_) {
        try {
            this.anInt2031 = Class318_Sub1_Sub3.method2408((byte) 53);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("og.<init>(" + i + ',' + i_0_ + ',' + (string != null ? "{...}" : "null") + ',' + (string_1_ != null ? "{...}" : "null") + ',' + (string_2_ != null ? "{...}" : "null") + ',' + (string_3_ != null ? "{...}" : "null") + ',' + i_4_ + ',' + (string_5_ != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method1196(int i, int i_6_, String string, String string_7_, String string_8_, int i_9_, int i_10_, String string_11_, String string_12_) {
        try {
            this.anInt2031 = Class318_Sub1_Sub3.method2408((byte) -91);
            anInt2036++;
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("og.A(" + i + ',' + i_6_ + ',' + (string != null ? "{...}" : "null") + ',' + (string_7_ != null ? "{...}" : "null") + ',' + (string_8_ != null ? "{...}" : "null") + ',' + i_9_ + ',' + i_10_ + ',' + (string_11_ != null ? "{...}" : "null") + ',' + (string_12_ != null ? "{...}" : "null") + ')'));
        }
    }
}
