...
final class Class348_Sub22 extends Node {
    ...
    static final int method2958(int i, Js5Archive Js5Archive) {
        anInt6861++;
        int i_2_ = 0;
        if (Js5Archive.method421(false, anInt6862)) i_2_++;
        if (Js5Archive.method421(false, Class106.anInt1639)) i_2_++;
        if (Js5Archive.method421(false, Class373_Sub2.anInt7429)) i_2_++;
        if (Js5Archive.method421(false, ha.anInt4562)) i_2_++;
        if (Js5Archive.method421(false, Class82.anInt1435)) i_2_++;
        if (Js5Archive.method421(false, Class115.anInt1756)) i_2_++;
        if (Js5Archive.method421(false, Class291.anInt3739)) i_2_++;
        if (Js5Archive.method421(false, Class86.anInt1481)) i_2_++;
        if (Js5Archive.method421(false, Class239_Sub10.anInt5948)) i_2_++;
        if (Js5Archive.method421(false, Class113.anInt1742)) i_2_++;
        if (Js5Archive.method421(false, Class364.anInt4469)) i_2_++;
        if (i != 22388) return 8;
        if (Js5Archive.method421(false, Class348_Sub40_Sub38.anInt9473)) i_2_++;
        if (Js5Archive.method421(false, Class187.anInt2510)) i_2_++;
        if (Js5Archive.method421(false, Class52.anInt4895)) i_2_++;
        if (Js5Archive.method421(false, Class186_Sub1.anInt5814)) i_2_++;
    ...
    static final void method2959(int i) {
        ...
        NPCType.aClient1367.method87((byte) -49);
