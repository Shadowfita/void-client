...
final class Class348_Sub42_Sub14 extends Class348_Sub42 {
    ...
    final boolean method3236(int[] is, int i, int i_0_, int i_1_, byte i_2_) {
        anInt9623++;
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1995(4); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1990((byte) 117)) {
    ...
    final boolean method3239(boolean bool, int i, int i_6_, int[] is) {
        ...
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1995(4); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1990((byte) 126)) {
    ...
    final void method3240(byte i) {
        ...
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1995(i + -33); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1990((byte) 52)) {
        ...
        if (!Class348_Sub40_Sub23.aBoolean9307 || !Class23.aBoolean351) Class348_Sub42_Sub10.anInt9577 = 0;
            ...
            if (Class348_Sub42_Sub10.anInt9577 > 0) {
                ...
                for (int i_14_ = 0; (i_14_ < Class348_Sub42_Sub10.anInt9577); i_14_++) {
                    Class338 class338 = Class348_Sub42_Sub19.aClass338Array9700[i_14_];
    ...
    final boolean method3242(int[] is, int i, int i_15_, int i_16_) {
        anInt9624++;
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1995(4); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aClass262_9629.method1990((byte) 115)) {
    ...
    Class348_Sub42_Sub14(int i, String string, String string_20_, int i_21_, int i_22_, boolean bool, int i_23_, int i_24_) {
        ...
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("dfa.<init>(" + i + ',' + (string != null ? "{...}" : "null") + ',' + (string_20_ != null ? "{...}" : "null") + ',' + i_21_ + ',' + i_22_ + ',' + bool + ',' + i_23_ + ',' + i_24_ + ')'));
        }
    }
}
