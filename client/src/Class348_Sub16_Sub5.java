...
final class Class348_Sub16_Sub5 extends Class348_Sub16 {
    ...
    final boolean method2890() {
        return anInt8983 < 0 || anInt8983 >= (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984).length << 8;
    }
    ...
    final int method2820() {
        int i = anInt8976 * 3 >> 6;
        i = (i ^ i >> 31) + (i >>> 31);
        if (anInt8980 == 0) i -= (i * anInt8983 / ((((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984).length << 8));
        else if (anInt8980 >= 0) i -= (i * anInt8975 / (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984).length);
        return Math.min(i, 255);
    }

    private static final int method2893(int i, byte[] is, int[] is_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i_7_ >>= 8;
        i_15_ >>= 8;
        i_9_ <<= 2;
        i_10_ <<= 2;
        i_11_ <<= 2;
        i_12_ <<= 2;
        if ((i_13_ = i_8_ + i_15_ - i_7_) > i_14_) i_13_ = i_14_;
    ...
    private static final int method2894(int i, int i_16_, byte[] is, int[] is_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_25_, int i_26_) {
        ...
        if (i_25_ == 0 || ((i_22_ = (i_19_ >> 1) + (i_24_ - i_18_ + i_25_) / i_25_) > i_23_)) i_22_ = i_23_;
        i_22_ <<= 1;
        i_16_ = i_26_;
        while (i_19_ < i_22_) {
    ...
    private static final int method2897(int i, byte[] is, int[] is_27_, int i_28_, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i_28_ >>= 8;
        i_34_ >>= 8;
        i_30_ <<= 2;
        i_31_ <<= 2;
        if ((i_32_ = i_29_ + i_28_ - (i_34_ - 1)) > i_33_) i_32_ = i_33_;
        i_29_ <<= 1;
        i_32_ <<= 1;
        i_32_ -= 6;
        while (i_29_ < i_32_) {
    ...
    private static final int method2899(int i, int i_37_, byte[] is, int[] is_38_, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_, int i_46_, int i_47_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_48_, int i_49_) {
        ...
        if (i_48_ == 0 || ((i_45_ = (i_40_ >> 1) + (i_47_ - i_39_ + i_48_ - 1) / i_48_) > i_46_)) i_45_ = i_46_;
        i_45_ <<= 1;
        i_37_ = i_49_;
        while (i_40_ < i_45_) {
            i = is[i_39_ >> 8];
    ...
    private static final int method2900(int i, byte[] is, int[] is_50_, int i_51_, int i_52_, int i_53_, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i_51_ >>= 8;
        i_59_ >>= 8;
        i_53_ <<= 2;
        i_54_ <<= 2;
        i_55_ <<= 2;
        i_56_ <<= 2;
        if ((i_57_ = i_52_ + i_51_ - (i_59_ - 1)) > i_58_) i_57_ = i_58_;
    ...
    private static final int method2903(int i, int i_61_, byte[] is, int[] is_62_, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_70_, int i_71_) {
        ...
        while (i_64_ < i_67_) {
            i_61_ = i_63_ >> 8;
            i = is[i_61_];
            is_62_[i_64_++] += (((i << 8) + (is[i_61_ + 1] - i) * (i_63_ & 0xff)) * i_65_ >> 6);
            i_65_ += i_66_;
            i_63_ += i_70_;
        }
        if (i_70_ == 0 || (i_67_ = i_64_ + (i_69_ - i_63_ + i_70_ - 1) / i_70_) > i_68_) i_67_ = i_68_;
        i_61_ = i_71_;
        while (i_64_ < i_67_) {
            i = is[i_63_ >> 8];
            is_62_[i_64_++] += ((i << 8) + (i_61_ - i) * (i_63_ & 0xff)) * i_65_ >> 6;
            i_65_ += i_66_;
            i_63_ += i_70_;
        }
        class348_sub16_sub5.anInt8970 += class348_sub16_sub5.anInt8971 * i_64_;
    ...
    private static final int method2905(byte[] is, int[] is_73_, int i, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i >>= 8;
        i_78_ >>= 8;
        i_75_ <<= 2;
        if ((i_76_ = i_74_ + i_78_ - i) > i_77_) i_76_ = i_77_;
        i_76_ -= 3;
        while (i_74_ < i_76_) {
    ...
    private static final int method2907(int i, int i_79_, byte[] is, int[] is_80_, int i_81_, int i_82_, int i_83_, int i_84_, int i_85_, int i_86_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_87_, int i_88_) {
        if (i_87_ == 0 || (i_84_ = i_82_ + (i_86_ + 256 - i_81_ + i_87_) / i_87_) > i_85_) i_84_ = i_85_;
        while (i_82_ < i_84_) {
            i_79_ = i_81_ >> 8;
            i = is[i_79_ - 1];
            is_80_[i_82_++] += ((i << 8) + (is[i_79_] - i) * (i_81_ & 0xff)) * i_83_ >> 6;
            i_81_ += i_87_;
        }
        if (i_87_ == 0 || (i_84_ = i_82_ + (i_86_ - i_81_ + i_87_) / i_87_) > i_85_) i_84_ = i_85_;
        i = i_88_;
        i_79_ = i_87_;
        while (i_82_ < i_84_) {
            is_80_[i_82_++] += (((i << 8) + (is[i_81_ >> 8] - i) * (i_81_ & 0xff)) * i_83_ >> 6);
            i_81_ += i_79_;
        }
    ...
    private static final int method2908(byte[] is, int[] is_89_, int i, int i_90_, int i_91_, int i_92_, int i_93_, int i_94_, int i_95_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i >>= 8;
        i_95_ >>= 8;
        i_91_ <<= 2;
        i_92_ <<= 2;
        if ((i_93_ = i_90_ + i - (i_95_ - 1)) > i_94_) i_93_ = i_94_;
    ...
    private static final int method2910(int i, byte[] is, int[] is_96_, int i_97_, int i_98_, int i_99_, int i_100_, int i_101_, int i_102_, int i_103_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i_97_ >>= 8;
        i_103_ >>= 8;
        i_99_ <<= 2;
        i_100_ <<= 2;
        if ((i_101_ = i_98_ + i_103_ - i_97_) > i_102_) i_101_ = i_102_;
        i_98_ <<= 1;
        i_101_ <<= 1;
        i_101_ -= 6;
        while (i_98_ < i_101_) {
    ...
    static final Class348_Sub16_Sub5 method2911(Class348_Sub19_Sub1 class348_sub19_sub1, int i, int i_104_, int i_105_) {
    ...
    private static final int method2912(int i, int i_106_, byte[] is, int[] is_107_, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_115_, int i_116_) {
        ...
        while (i_109_ < i_112_) {
            i_106_ = i_108_ >> 8;
            i = is[i_106_ - 1];
            is_107_[i_109_++] += (((i << 8) + (is[i_106_] - i) * (i_108_ & 0xff)) * i_110_ >> 6);
            i_110_ += i_111_;
            i_108_ += i_115_;
        }
        if (i_115_ == 0 || ((i_112_ = i_109_ + (i_114_ - i_108_ + i_115_) / i_115_) > i_113_)) i_112_ = i_113_;
        i = i_116_;
        i_106_ = i_115_;
        while (i_109_ < i_112_) {
            is_107_[i_109_++] += (((i << 8) + (is[i_108_ >> 8] - i) * (i_108_ & 0xff)) * i_110_) >> 6;
            i_110_ += i_111_;
            i_108_ += i_106_;
        }
        class348_sub16_sub5.anInt8970 += class348_sub16_sub5.anInt8971 * i_109_;
    ...
    private static final int method2913(byte[] is, int[] is_117_, int i, int i_118_, int i_119_, int i_120_, int i_121_, int i_122_, int i_123_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i >>= 8;
        i_123_ >>= 8;
        i_119_ <<= 2;
        i_120_ <<= 2;
        if ((i_121_ = i_118_ + i_123_ - i) > i_122_) i_121_ = i_122_;
    ...
    private final int method2919(int[] is, int i, int i_125_, int i_126_, int i_127_) {
        while (anInt8972 > 0) {
            ...
            if (anInt8979 == 256 && (anInt8983 & 0xff) == 0) {
                if (Class282.aBoolean3652) i = method2893(0, ((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984, is, anInt8983, i, anInt8970, anInt8974, anInt8971, anInt8978, 0, i_128_, i_125_, this);
                else i = method2913(((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984, is, anInt8983, i, anInt8976, anInt8973, 0, i_128_, i_125_, this);
            } else if (Class282.aBoolean3652) i = method2899(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8970, anInt8974, anInt8971, anInt8978, 0, i_128_, i_125_, this, anInt8979, i_127_);
            else i = method2903(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8976, anInt8973, 0, i_128_, i_125_, this, anInt8979, i_127_);
            anInt8972 -= i;
            if (anInt8972 != 0) return i;
            if (method2898()) return i_126_;
        }
        if (anInt8979 == 256 && (anInt8983 & 0xff) == 0) {
            if (Class282.aBoolean3652) return method2910(0, ((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984, is, anInt8983, i, anInt8970, anInt8974, 0, i_126_, i_125_, this);
            return method2905((((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8976, 0, i_126_, i_125_, this);
        }
        if (Class282.aBoolean3652) return method2922(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8970, anInt8974, 0, i_126_, i_125_, this, anInt8979, i_127_);
        return method2925(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8976, 0, i_126_, i_125_, this, anInt8979, i_127_);
    }

    private static final int method2920(int i, int i_129_, byte[] is, int[] is_130_, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_, int i_136_, int i_137_, int i_138_, int i_139_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_140_, int i_141_) {
        ...
        if (i_140_ == 0 || ((i_137_ = (i_132_ >> 1) + (i_139_ - i_131_ + i_140_) / i_140_) > i_138_)) i_137_ = i_138_;
        i_137_ <<= 1;
        i_129_ = i_141_;
        while (i_132_ < i_137_) {
    ...
    private static final int method2921(byte[] is, int[] is_142_, int i, int i_143_, int i_144_, int i_145_, int i_146_, int i_147_, Class348_Sub16_Sub5 class348_sub16_sub5) {
        i >>= 8;
        i_147_ >>= 8;
        i_144_ <<= 2;
        if ((i_145_ = i_143_ + i - (i_147_ - 1)) > i_146_) i_145_ = i_146_;
        i_145_ -= 3;
        while (i_143_ < i_145_) {
    ...
    private static final int method2922(int i, int i_148_, byte[] is, int[] is_149_, int i_150_, int i_151_, int i_152_, int i_153_, int i_154_, int i_155_, int i_156_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_157_, int i_158_) {
        ...
        if (i_157_ == 0 || (i_154_ = (i_151_ >> 1) + (i_156_ - i_150_ + i_157_ - 1) / i_157_) > i_155_) i_154_ = i_155_;
        i_154_ <<= 1;
        i_148_ = i_158_;
        while (i_151_ < i_154_) {
            i = is[i_150_ >> 8];
    ...
    final synchronized void method2817(int[] is, int i, int i_159_) {
        if (anInt8969 == 0 && anInt8972 == 0) method2819(i_159_);
            ...
            Class348_Sub19_Sub1 class348_sub19_sub1 = ((Class348_Sub19_Sub1) this.aClass348_Sub19_6787);
            int i_160_ = anInt8975 << 8;
            int i_161_ = anInt8982 << 8;
            int i_162_ = ((class348_sub19_sub1.aByteArray8984).length << 8);
            ...
            if (anInt8980 < 0) {
                if (aBoolean8981) {
                    if (anInt8979 < 0) {
                        i_164_ = method2927(is, i_164_, i_160_, i_159_, (class348_sub19_sub1.aByteArray8984[anInt8975]));
                    ...
                    for (; ; ) {
                        i_164_ = method2927(is, i_164_, i_160_, i_159_, (class348_sub19_sub1.aByteArray8984[anInt8982 - 1]));
                        if (anInt8983 >= i_160_) break;
    ...
    final synchronized void method2924(int i) {
        int i_167_ = ((((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984).length << 8);
        if (i < -1) i = -1;
    ...
    private static final int method2925(int i, int i_168_, byte[] is, int[] is_169_, int i_170_, int i_171_, int i_172_, int i_173_, int i_174_, int i_175_, Class348_Sub16_Sub5 class348_sub16_sub5, int i_176_, int i_177_) {
        if (i_176_ == 0 || ((i_173_ = i_171_ + (i_175_ - i_170_ + i_176_ - 257) / i_176_) > i_174_)) i_173_ = i_174_;
        while (i_171_ < i_173_) {
            i_168_ = i_170_ >> 8;
            i = is[i_168_];
            is_169_[i_171_++] += (((i << 8) + (is[i_168_ + 1] - i) * (i_170_ & 0xff)) * i_172_) >> 6;
            i_170_ += i_176_;
        }
        if (i_176_ == 0 || ((i_173_ = i_171_ + (i_175_ - i_170_ + i_176_ - 1) / i_176_) > i_174_)) i_173_ = i_174_;
        i_168_ = i_177_;
        while (i_171_ < i_173_) {
            i = is[i_170_ >> 8];
            is_169_[i_171_++] += ((i << 8) + (i_168_ - i) * (i_170_ & 0xff)) * i_172_ >> 6;
            i_170_ += i_176_;
        }
    ...
    final synchronized void method2819(int i) {
        ...
        int i_181_ = ((class348_sub19_sub1.aByteArray8984).length << 8);
    ...
    private Class348_Sub16_Sub5(Class348_Sub19_Sub1 class348_sub19_sub1, int i, int i_185_, int i_186_) {
    ...
    private final int method2927(int[] is, int i, int i_187_, int i_188_, int i_189_) {
        while (anInt8972 > 0) {
            ...
            anInt8972 += i;
            if (anInt8979 == -256 && (anInt8983 & 0xff) == 0) {
                if (Class282.aBoolean3652) i = method2900(0, ((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984, is, anInt8983, i, anInt8970, anInt8974, anInt8971, anInt8978, 0, i_190_, i_187_, this);
                else i = method2908(((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984, is, anInt8983, i, anInt8976, anInt8973, 0, i_190_, i_187_, this);
            } else if (Class282.aBoolean3652) i = method2920(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8970, anInt8974, anInt8971, anInt8978, 0, i_190_, i_187_, this, anInt8979, i_189_);
            else i = method2912(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8976, anInt8973, 0, i_190_, i_187_, this, anInt8979, i_189_);
            anInt8972 -= i;
            if (anInt8972 != 0) return i;
            if (method2898()) return i_188_;
        }
        if (anInt8979 == -256 && (anInt8983 & 0xff) == 0) {
            if (Class282.aBoolean3652) return method2897(0, ((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984, is, anInt8983, i, anInt8970, anInt8974, 0, i_188_, i_187_, this);
            return method2921((((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8976, 0, i_188_, i_187_, this);
        }
        if (Class282.aBoolean3652) return method2894(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8970, anInt8974, 0, i_188_, i_187_, this, anInt8979, i_189_);
        return method2907(0, 0, (((Class348_Sub19_Sub1) this.aClass348_Sub19_6787).aByteArray8984), is, anInt8983, i, anInt8976, 0, i_188_, i_187_, this, anInt8979, i_189_);
    }
}
