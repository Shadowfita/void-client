...
class Class75 {
    ...
    private static IterableHashTable aClass356_1271;
    ...
    private static final void method750(ha var_ha, Packet Packet, int i, int i_21_, int i_22_, int i_23_, int[] is, int[] is_24_) {
        ...
        if ((i_25_ & 0x1) == 0) {
            ...
            if (i_26_ != 62) {
                if (i_26_ == 63) i_26_ = Packet.readUnsignedByte(255);
                ...
                if (bool) {
                    ...
                    aByteArray1273[i_22_ + i_23_ * anInt1259] = Packet.readByte(-115);
                }
            }
        } else {
            ...
            for (int i_29_ = 0; i_29_ < i_27_; i_29_++) {
                int i_30_ = Packet.readUnsignedByte(255);
                int i_31_ = 0;
                int i_32_ = 0;
                if (bool) {
                    i_31_ = Packet.readUnsignedByte(255);
                    i_32_ = Packet.readUnsignedByte(255);
                }
                int i_33_ = 0;
                if (bool_28_) i_33_ = Packet.readUnsignedByte(255);
                if (i_29_ == 0) {
                    ...
                    if (i_33_ == 1) {
                        aShortArray1261[i_22_ + i_23_ * anInt1259] = (short) (Packet.readUnsignedShort(842397944) + 1);
                        aByteArray1258[i_22_ + i_23_ * anInt1259] = Packet.readByte(-122);
                    } else if (i_33_ > 1) {
                    ...
                    if (i_33_ > 0) {
                        ...
                        for (int i_39_ = 0; i_39_ < i_33_; i_39_++) {
                            is_37_[i_39_] = (short) Packet.readUnsignedShort(842397944);
                            is_38_[i_39_] = Packet.readByte(-92);
                        }
                    }
    ...
    static final void method752(Js5Archive Js5Archive, Class268 class268, Class183 class183, Class263 class263, Class153 class153, Class141 class141, Interface17 interface17) {
        aClass45_1237 = Js5Archive;
        ...
        for (int i = 0; i < 3; i++) {
            for (int i_53_ = 0; i_53_ < aClass243ArrayArrayArray1269[0].length; i_53_++) {
                for (int i_54_ = 0; i_54_ < aClass243ArrayArrayArray1269[0][0].length; i_54_++) {
                    Class243 class243 = aClass243ArrayArrayArray1269[i][i_53_][i_54_];
                    if (class243 != null) {
    ...
    static final void method756(ha var_ha, int i, int i_75_) {
        Packet Packet = (new Packet(aClass45_1237.method391((aClass348_Sub42_Sub14_1243.aString9625), "area", -29832)));
        int i_76_ = Packet.readUnsignedByte(255);
        int[] is = new int[i_76_];
        for (int i_77_ = 0; i_77_ < i_76_; i_77_++)
            is[i_77_] = Packet.readUnsignedByte(255);
        int i_78_ = Packet.readUnsignedByte(255);
        int[] is_79_ = new int[i_78_];
        for (int i_80_ = 0; i_80_ < i_78_; i_80_++)
            is_79_[i_80_] = Packet.readUnsignedByte(255);
        while (Packet.pos < Packet.data.length) {
            if (Packet.readUnsignedByte(255) == 0) {
                int i_81_ = Packet.readUnsignedByte(255);
                int i_82_ = Packet.readUnsignedByte(255);
                ...
                int i_88_ = Packet.readUnsignedByte(255);
                int i_89_ = Packet.readUnsignedByte(255);
                int i_90_ = Packet.readUnsignedByte(255);
        ...
        for (int i_95_ = 0; i_95_ < 3; i_95_++) {
            ...
            for (int i_97_ = 0; i_97_ < aClass243ArrayArrayArray1269[i_95_].length; i_97_++) {
                for (int i_98_ = 0; i_98_ < aClass243ArrayArrayArray1269[i_95_][0].length; i_98_++) {
                    Class243 class243 = aClass243ArrayArrayArray1269[i_95_][i_97_][i_98_];
                    if (class243 != null) {
                        for (Class318_Sub8 class318_sub8 = (Class318_Sub8) class243.method1872(8); class318_sub8 != null; class318_sub8 = ((Class318_Sub8) class243.method1878((byte) 1)))
            ...
            for (int i_99_ = 0; i_99_ < aClass243ArrayArrayArray1269[i_95_].length; i_99_++) {
                for (int i_100_ = 0; i_100_ < aClass243ArrayArrayArray1269[i_95_][0].length; i_100_++) {
                    Class243 class243 = aClass243ArrayArrayArray1269[i_95_][i_99_][i_100_];
                    if (class243 != null) {
                        for (Class318_Sub8 class318_sub8 = (Class318_Sub8) class243.method1872(8); class318_sub8 != null; class318_sub8 = ((Class318_Sub8) class243.method1878((byte) 122))) {
    ...
    private static final int method759(d var_d, int i, int i_105_, int i_106_) {
        ...
        if (class277.anInt3569 >= 0) {
            ...
            i_108_ = ~0xffffff | (Class126.anIntArray4983[Class25.method303(Class35.method353(96, -119, i_111_), 30) & 0xffff]);
        } else if (i_107_ >= 0) i_108_ = (~0xffffff | (Class126.anIntArray4983[(Class25.method303(Class35.method353(96, -85, (var_d.method3(i_107_, -6662).aShort208)), 30)) & 0xffff]));
            ...
            i_108_ = ~0xffffff | (Class126.anIntArray4983[Class25.method303(Class35.method353(96, -80, i_114_), 30) & 0xffff]);
        }
        return i_108_;
    }
    ...
    static final void method760() {
        ...
        aClass356_1271 = new IterableHashTable(1024);
        ...
        for (int i_170_ = 0; i_170_ < 3; i_170_++) {
            for (int i_171_ = i_166_; i_171_ <= i_168_; i_171_++) {
                for (int i_172_ = i_167_; i_172_ <= i_169_; i_172_++) {
                    Class243 class243 = aClass243ArrayArrayArray1269[i_170_][i_171_][i_172_];
                    if (class243 != null) {
                        int i_173_ = (i_171_ + (anInt1266 >> 6)) * 64;
                        int i_174_ = (i_172_ + (anInt1263 >> 6)) * 64;
                        for (Class318_Sub8 class318_sub8 = (Class318_Sub8) class243.method1872(8); class318_sub8 != null; class318_sub8 = ((Class318_Sub8) class243.method1878((byte) -79))) {
            ...
            for (int i_181_ = i_166_; i_181_ <= i_168_; i_181_++) {
                for (int i_182_ = i_167_; i_182_ <= i_169_; i_182_++) {
                    Class243 class243 = aClass243ArrayArrayArray1269[i_170_][i_181_][i_182_];
                    if (class243 != null) {
                        int i_183_ = (i_181_ + (anInt1266 >> 6)) * 64;
                        int i_184_ = (i_182_ + (anInt1263 >> 6)) * 64;
                        for (Class318_Sub8 class318_sub8 = (Class318_Sub8) class243.method1872(8); class318_sub8 != null; class318_sub8 = ((Class318_Sub8) class243.method1878((byte) -75))) {
        ...
        for (int i_201_ = -5; i_201_ < anInt1259; i_201_++) {
            ...
            for (int i_204_ = 0; i_204_ < anInt1267; i_204_++) {
                if (i_202_ < anInt1259) {
                    ...
                    if (i_205_ > 0) {
                        Class22 class22 = aClass183_1240.method1380(true, i_205_ - 1);
                ...
                if (i_203_ >= 0) {
                    ...
                    if (i_206_ > 0) {
                        Class22 class22 = aClass183_1240.method1380(true, i_206_ - 1);
                        is_196_[i_204_] -= class22.anInt341;
                        is_197_[i_204_] -= class22.anInt332;
                        is_198_[i_204_] -= class22.anInt335;
                        is_199_[i_204_] -= class22.anInt343;
                ...
                for (int i_212_ = -5; i_212_ < anInt1267; i_212_++) {
                    ...
                    if (i_212_ >= 0 && i_211_ > 0) {
                        if ((is[i_201_ + i_212_ * anInt1259] & 0xff) == 0) {
                            ...
                            int i_216_ = (i_210_ == 0 ? 0 : Class247.method1890(i_209_ / i_211_, (byte) 76, i_208_ / i_211_, (i_207_ * 256 / i_210_)));
                            ...
                            int i_220_ = (Class126.anIntArray4983[(Class25.method303(Class348_Sub49_Sub1.method3401(i_218_, 96, (byte) 76), 30)) & 0xffff]);
