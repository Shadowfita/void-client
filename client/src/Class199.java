...
final class Class199 {
    ...
    static final int method1457(int i, int i_8_) {
        if (Class348_Sub1_Sub2.aByteArrayArray8816 != null) return Class348_Sub1_Sub2.aByteArrayArray8816[i][i_8_] & 0xff;
        return 0;
    }
    ...
    static final void method1459(int i, int i_9_) {
        anInt2637++;
        Class348_Sub42_Sub15 class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(i, (byte) 105, 10);
