...
final class Class367_Sub9 extends Class367 {
    ...
    static Js5Archive aClass45_7371;
    ...
    static final String method3551(int i, int i_5_, int i_6_, boolean bool) {
        ...
        for (/**/; i_9_ > 0; i_9_--) {
            ...
            if (i_11_ < 10) cs[i_9_] = (char) (i_11_ + 48);
            else cs[i_9_] = (char) (i_11_ + 87);
        }
    ...
    Class367_Sub9(Class377 class377, Js5Archive Js5Archive, Class269 class269) {
        super(class377);
        try {
            aClass269_7375 = class269;
            if (Js5Archive != null && class377.aBoolean9921 && class377.aBoolean9922) {
                Class39 class39 = (Class328.method2608(class377, Js5Archive.method391("gl", "environment_mapped_water_v", -29832), -108, 35633));
                Class39 class39_13_ = (Class328.method2608(class377, Js5Archive.method391("gl", "environment_mapped_water_f", -29832), -122, 35632));
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ko.<init>(" + (class377 != null ? "{...}" : "null") + ',' + (Js5Archive != null ? "{...}" : "null") + ',' + (class269 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    final void method3525(int i, boolean bool) {
        ...
        if (aBoolean7376 && interface18_impl2 != null) {
            ...
            OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l, "sunDir"), -(this.aHa_Sub3_4479.aFloatArray8170[0]), -(this.aHa_Sub3_4479.aFloatArray8170[1]), -(this.aHa_Sub3_4479.aFloatArray8170[2]));
            OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"), this.aHa_Sub3_4479.aFloat8180, this.aHa_Sub3_4479.aFloat8087, this.aHa_Sub3_4479.aFloat8168, 1.0F);
            OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"), 928.0F * Math.abs(this.aHa_Sub3_4479.aFloatArray8170[1]) + 96.0F);
            aBoolean7373 = true;
        }
    }
}
