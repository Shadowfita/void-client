...
final class Class46 {
    ...
    int anInt709;
    int anInt710;
    private IterableHashTable aClass356_711;
    static int anInt712;
    int anInt713;
    ...
    final int method428(int i, int i_18_, int i_19_) {
        ...
        IntNode IntNode = (IntNode) aClass356_711.method3480(i_18_, -6008);
    ...
    final String method429(int i, String string, int i_20_) {
        ...
        StringNode StringNode = (StringNode) aClass356_711.method3480(i, -6008);
        if (StringNode == null) return string;
        return StringNode.aString7211;
    }

    final Class64 method430(Class150 class150, Class87 class87, int i, ha var_ha, int i_21_, int i_22_, ObjTypeList ObjTypeList, Interface17 interface17, int i_23_, Class154 class154, Class17 class17, Class261 class261, NPCTypeList NPCTypeList, int i_24_) {
        try {
            anInt684++;
            ...
            if (this.anInt770 == 2) {
                Class64 class64 = (NPCTypeList.method2079(this.anInt753, -1).method803(interface17, var_ha, i_22_, i_24_, class17, class87, i_21_, 104, i));
                if (class64 == null) {
                    Class348_Sub42_Sub13.aBoolean9616 = true;
                    return null;
                }
            ...
            if (this.anInt770 == 3) {
                ...
                Class64 class64 = class154.method1230(ObjTypeList, -402058072, class87, class150, interface17, NPCTypeList, i_21_, i_24_, i, class17, i_22_, var_ha);
                if (class64 == null) {
                    Class348_Sub42_Sub13.aBoolean9616 = true;
                    return null;
                }
            ...
            if (this.anInt770 == 4) {
                ObjType ObjType = ObjTypeList.getItemDefinitions(i_23_ + -365, this.anInt753);
                Class64 class64 = ObjType.getModel(class154, class17, var_ha, i, i_22_, 10, i_21_, (byte) 88, i_24_);
                if (class64 == null) {
                    Class348_Sub42_Sub13.aBoolean9616 = true;
                    return null;
                }
            ...
            if (this.anInt770 == 6) {
                Class64 class64 = (NPCTypeList.method2079(this.anInt753, -1).method800(0, null, class87, false, null, 0, class261, i_21_, class17, interface17, var_ha, 0, null, i_24_, 0, i, i_22_));
                if (class64 == null) {
                    Class348_Sub42_Sub13.aBoolean9616 = true;
                    return null;
                }
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("at.G(" + (class150 != null ? "{...}" : "null") + ',' + (class87 != null ? "{...}" : "null") + ',' + i + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_21_ + ',' + i_22_ + ',' + (ObjTypeList != null ? "{...}" : "null") + ',' + (interface17 != null ? "{...}" : "null") + ',' + i_23_ + ',' + (class154 != null ? "{...}" : "null") + ',' + (class17 != null ? "{...}" : "null") + ',' + (class261 != null ? "{...}" : "null") + ',' + (NPCTypeList != null ? "{...}" : "null") + ',' + i_24_ + ')'));
        }
    }
    ...
    final void method433(Packet Packet, boolean bool) {
        ...
        if (i >= 0) {
            ...
            for (int i_54_ = 0; i_53_ > i_54_; i_54_++) {
                ...
                aClass356_711.method3483((byte) 120, i_55_, new IntNode(i_56_));
            }
            ...
            for (int i_58_ = 0; i_58_ < i_57_; i_58_++) {
                ...
                aClass356_711.method3483((byte) 119, i_59_, new StringNode(string));
            }
        }
    ...
    final void method436(int i, int i_61_, int i_62_) {
        anInt694++;
        if (aClass356_711 == null) {
            aClass356_711 = new IterableHashTable(16);
            aClass356_711.method3483((byte) 60, i_61_, new IntNode(i_62_));
        } else if (i < -38) {
            IntNode IntNode = ((IntNode) aClass356_711.method3480(i_61_, -6008));
            if (IntNode == null) aClass356_711.method3483((byte) 67, i_61_, new IntNode(i_62_));
            else IntNode.anInt6976 = i_62_;
        }
    }
    ...
    final void method439(int i, int i_66_, String string) {
        ...
        if (aClass356_711 == null) {
            aClass356_711 = new IterableHashTable(16);
            aClass356_711.method3483((byte) 86, i_66_, new StringNode(string));
        } else {
            StringNode StringNode = ((StringNode) aClass356_711.method3480(i_66_, -6008));
            if (StringNode == null) aClass356_711.method3483((byte) 73, i_66_, new StringNode(string));
            else StringNode.aString7211 = string;
        }
    }
