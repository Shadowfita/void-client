...
final class Class58 {
    ...
    static final int method532(int i, int i_0_, boolean bool, int i_1_) {
        anInt1061++;
        Class348_Sub13 class348_sub13 = Class258_Sub4.method1974((byte) -120, i_0_, bool);
    ...
    private final void method533(Class325 class325, int i) {
        aLong1057 |= class325.anInt4070 << anInt1058++ * Class325.anInt4081;
        anInt1063++;
        int i_5_ = 0 % ((28 - i) / 59);
    }
    ...
    static final void method535(int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, byte i_12_) {
        anInt1062++;
        int i_13_ = Class85.method831(Class38.anInt513, i_11_, Class132.anInt1910, 111);
        int i_14_ = Class85.method831(Class38.anInt513, i_7_, Class132.anInt1910, -104);
        if (i_12_ >= -62) method535(80, -63, -10, 41, -65, 39, (byte) -89);
        int i_15_ = Class85.method831(Class113.anInt1745, i, Class369.anInt4960, -79);
        int i_16_ = Class85.method831(Class113.anInt1745, i_9_, Class369.anInt4960, 92);
        int i_17_ = Class85.method831(Class38.anInt513, i_11_ + i_8_, Class132.anInt1910, 32);
        int i_18_ = Class85.method831(Class38.anInt513, -i_8_ + i_7_, Class132.anInt1910, 41);
        ...
        int i_21_ = Class85.method831(Class113.anInt1745, i_8_ + i, Class369.anInt4960, 121);
        int i_22_ = Class85.method831(Class113.anInt1745, -i_8_ + i_9_, Class369.anInt4960, -101);
