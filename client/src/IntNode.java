...
final class IntNode extends Node {
    ...
    static Js5Archive aClass45_6980;
    static int anInt6981;

    static final void method3027(byte i) {
        anInt6975++;
        if (Class316.aClass348_Sub51_3959.aClass239_Sub27_7261.method1840(-32350) == 0 && Class355.anInt4372 != Class167.anInt2204) Class348_Sub41.method3157(Class327.anInt4095, (byte) 123, ha.anInt4581, 11, false);
        else {
            Class348_Sub46.method3319(Class348_Sub8.aHa6654, (byte) -121);
            if (i != 33) method3028(-79);
            if (Class318_Sub1_Sub3_Sub5.anInt10395 != Class355.anInt4372) Class348_Sub40_Sub9.method3072((byte) -96);
        }
    }
