/* SceneEntity - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

abstract class SceneEntity extends Linkable {
    byte aByte6376;
    int x;
    static int anInt6378;
    SceneEntity aClass318_Sub1_6379;
    int anInt6380;
    byte plane;
    int anInt6382;
    ...
    abstract void method2380(ha var_ha, int i, boolean bool, SceneEntity class318_sub1_0_, int i_1_, byte i_2_, int i_3_);
