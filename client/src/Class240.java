...
final class Class240 implements Interface1 {
    ...
    static final void method1852(int i, int i_1_, int i_2_, int i_3_) {
        ...
        if (class357 != null) {
            ...
            if (class318_sub1_sub5 != null) {
                class318_sub1_sub5.aShort8781 = (short) ((class318_sub1_sub5.aShort8781) * i_3_ / (16 << Class362.anInt4459 - 7));
                class318_sub1_sub5.aShort8769 = (short) ((class318_sub1_sub5.aShort8769) * i_3_ / (16 << Class362.anInt4459 - 7));
            }
            if (class318_sub1_sub5_4_ != null) {
                class318_sub1_sub5_4_.aShort8781 = (short) ((class318_sub1_sub5_4_.aShort8781) * i_3_ / (16 << Class362.anInt4459 - 7));
                class318_sub1_sub5_4_.aShort8769 = (short) ((class318_sub1_sub5_4_.aShort8769) * i_3_ / (16 << Class362.anInt4459 - 7));
            }
        }
    }
    ...
    static final int method1854(int i, int i_5_, boolean bool, int i_6_) {
        ...
        anInt4681++;
        Class348_Sub13 class348_sub13 = Class258_Sub4.method1974((byte) 37, i_5_, bool);
    ...
    Class240(Class339 class339, Class125 class125) {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("ta.<init>(" + (class339 != null ? "{...}" : "null") + ',' + (class125 != null ? "{...}" : "null") + ')'));
        }
    }
}
