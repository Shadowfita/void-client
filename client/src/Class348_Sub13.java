...
final class Class348_Sub13 extends Node {
    ...
    static final void method2801(int i, int i_0_, int i_1_, int i_2_, int i_3_, Class318_Sub1_Sub3_Sub3 class318_sub1_sub3_sub3, byte i_4_) {
