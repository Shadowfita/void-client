/* BitPacket - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class BitPacket extends Packet {
    ...
    static final void method3411(int i, int i_13_, int i_14_) {
        anInt9761++;
        Class348_Sub42_Sub15 class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(i, (byte) 105, i_13_);//12
    ...
    static final int[][] method3413(int i, int i_15_, int i_16_, int i_17_, int i_18_, boolean bool, int i_19_, float f, boolean bool_20_) {
        ...
        NPCType.method797(i_18_, i_16_, (byte) 120);
    ...
    final void method3416(int i, Isaac Isaac) {
