...
final class Class369_Sub3_Sub1 extends Class369_Sub3 {
    ...
    static final Class105 method3577(int i, byte i_10_, Js5Archive Js5Archive) {
        anInt10176++;
        Class105 class105 = (Class105) Class345.aClass60_4273.method583(i, -68);
        int i_11_ = -86 / ((55 - i_10_) / 51);
        if (class105 == null) {
            if (Class286_Sub7.aBoolean6289) class105 = Class348_Sub8.aHa6654.method3691(Class207.method1512(Js5Archive, i), true);
            else class105 = Class258_Sub3.method1969(Js5Archive.method415((byte) 73, i), -5901);
