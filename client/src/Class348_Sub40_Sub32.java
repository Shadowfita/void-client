...
final class Class348_Sub40_Sub32 extends Class348_Sub40 {
    ...
    static final void method3134(int i) {
        ...
        if ((~Class286_Sub5.anInt6248) <= i) {
            ...
            if (Class286_Sub5.anInt6248 > 0) {
                ...
                Class348_Sub3.aFloat6586 = (Class239_Sub14.aClass190_5990.aFloat2545 - Js5Archive.aFloat670) * f_6_ + Js5Archive.aFloat670;
                ...
                Class187.anInt2500 = (((i_4_ * (0xff00 & Canvas_Sub1.anInt70) + (0xff00 & (Class239_Sub14.aClass190_5990.anInt2549)) * i_5_) & 0xff0000) + (~0xff00ff & (i_4_ * (0xff00ff & Canvas_Sub1.anInt70) - -(i_5_ * (0xff00ff & (Class239_Sub14.aClass190_5990.anInt2549)))))) >>> 8;
                ...
                if (Class239_Sub24.aClass299_6098 != (Class239_Sub14.aClass190_5990.aClass299_2541)) Class158.aClass299_4938 = (ReferenceCache.aHa1098.method3706(Class239_Sub24.aClass299_6098, (Class239_Sub14.aClass190_5990.aClass299_2541), f_6_, Class158.aClass299_4938));
            } else {
    ...
    final void method3049(Packet Packet, int i, int i_21_) {
        anInt9414++;
        if (i_21_ != 31015) aClass273_9415 = null;
        if (i == 0) this.aBoolean7045 = Packet.readUnsignedByte(255) == 1;
    }

    static final String method3136(byte i, Packet Packet) {
        anInt9416++;
        if (i != 64) aShortArray9423 = null;
        return Class373_Sub2.method3607(32767, Packet, -77);
    }
}
