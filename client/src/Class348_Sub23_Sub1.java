    ...
    final void method2964(byte i, OggPacket oggpacket) {
        ...
        if (this.anInt6868 < 3) {
            ...
            if (this.anInt6868 == 2) {
                ...
                aClass163_8994 = new Class163(aVorbisInfo9006.rate, Class22.anInt339);
                aClass348_Sub16_Sub2_8995 = new Class348_Sub16_Sub2(aVorbisInfo9006.channels);
            }
        } else {
            ...
            Class348_Sub42_Sub4 class348_sub42_sub4 = aClass348_Sub16_Sub2_8995.method2838(fs[0].length, aDouble9005, 1401320384);
            Class346.method2699(16383, (class348_sub42_sub4.aShortArrayArray9518), fs);
