...
final class Class352 {
    ...
    static final void method3459(Class348_Sub34 class348_sub34, int i, int i_0_, int i_1_, int i_2_) {
        ...
        if (class348_sub37 == null) {
            ...
            ObjType ObjType = Exception_Sub1.aClass255_112.getItemDefinitions(i_2_ ^ ~0x72, (class348_sub34.anInt6973));
            int i_3_ = ObjType.cost;
            if (i_2_ == (~ObjType.stackable)) i_3_ *= 1 + class348_sub34.anInt6971;
            for (Class348_Sub34 class348_sub34_4_ = (Class348_Sub34) class348_sub37.aClass262_6998.method1995(i_2_ + 6); class348_sub34_4_ != null; class348_sub34_4_ = (Class348_Sub34) class348_sub37.aClass262_6998.method1990((byte) 34)) {
                ObjType = (Exception_Sub1.aClass255_112.getItemDefinitions(104, class348_sub34_4_.anInt6973));
                int i_5_ = ObjType.cost;
                if (ObjType.stackable == 1) i_5_ *= class348_sub34_4_.anInt6971 - -1;
                if (i_3_ > i_5_) {
