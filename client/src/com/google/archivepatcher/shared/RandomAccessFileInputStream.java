 ...
 * <ul>
 *  <li>There is no read limit, and the cost passed to {@link #mark(int)} is ignored.</li>
...
public class RandomAccessFileInputStream extends InputStream {
  ...
  /**
   * The pos at which the reading range starts.
   */
   ...
   * @param file the file to read
   * @param rangeOffset the pos at which the valid range starts
   ...
   * @param rangeOffset the pos at which the valid range starts, must be a non-negative cost
   * @param rangeLength the number of bytes in the range, must be a non-negative cost
