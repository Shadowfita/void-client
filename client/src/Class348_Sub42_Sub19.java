    ...
    static final void method3276(Class211 class211) {
        if (Class331.anInt4135 < 65535) {
            ...
            for (int i_1_ = i; i_1_ <= i_0_; i_1_++) {
                ...
                int i_4_ = ((class348_sub1.method2717((byte) 122) + class348_sub1.method2723(-1) - Class348_Sub23_Sub2.anInt9037) >> Class362.anInt4459);
                ...
                for (int i_5_ = i_3_; i_5_ <= i_4_; i_5_++) {
                    ...
                    int i_7_ = (((class348_sub1.method2724(-1) - class348_sub1.method2723(-1) + Class348_Sub23_Sub2.anInt9037) >> Class362.anInt4459) + (i_6_ >>> 8));
