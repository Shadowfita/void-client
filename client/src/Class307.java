...
final class Class307 {
    ...
    static final Class252 method2300(Js5Archive Js5Archive, String string, boolean bool, byte i) {
        try {
            anInt3877++;
            int i_0_ = Js5Archive.method417(string, 0);
            if (i != -91) return null;
            if (i_0_ == -1) return new Class252(0);
            int[] is = Js5Archive.method396(i_0_, i ^ ~0x5a);
            Class252 class252 = new Class252(is.length);
            int i_1_ = 0;
            int i_2_ = 0;
            while (i_1_ < class252.anInt3241) {
                Packet Packet = new Packet(Js5Archive.method410(-1860, i_0_, is[i_2_++]));
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("wt.A(" + (Js5Archive != null ? "{...}" : "null") + ',' + (string != null ? "{...}" : "null") + ',' + bool + ',' + i + ')'));
        }
    }
