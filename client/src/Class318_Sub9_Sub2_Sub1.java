...
final class Class318_Sub9_Sub2_Sub1 extends Class318_Sub9_Sub2 {
    ...
    private final void method2521() {
        int i = (this.aClass318_Sub7_10419.aClass318_Sub10_6439.anInt6476);
    ...
    final void method2522(ha var_ha, long l) {
        ...
        if (i_1_ > 0 || i_1_ < -262144 || i < 0 || i >= Class318_Sub7.anInt6451 || i_0_ < 0 || i_0_ >= Class348_Sub41.anInt7054) method2520();
        else {
    ...
    final void method2523(Class318_Sub7 class318_sub7, int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, boolean bool, boolean bool_19_) {
        ...
        if (aShort10420 <= 0) method2520();
            ...
            if (class181.anInt2386 != 0) {
                if (aShort10418 - aShort10420 <= class181.anInt2373) {
                    int i_23_ = ((this.anInt8790 >> 8 & 0xff00) + (anInt10417 >> 16 & 0xff) + class181.anInt2426 * i);
                    int i_24_ = ((this.anInt8790 & 0xff00) + (anInt10417 >> 8 & 0xff) + class181.anInt2421 * i);
                    int i_25_ = ((this.anInt8790 << 8 & 0xff00) + (anInt10417 & 0xff) + class181.anInt2405 * i);
                    if (i_23_ < 0) i_23_ = 0;
                    ...
                    this.anInt8790 |= (((i_23_ & 0xff00) << 8) + (i_24_ & 0xff00) + ((i_25_ & 0xff00) >> 8));
                    anInt10417 &= ~0xffffff;
                    anInt10417 |= (((i_23_ & 0xff) << 16) + ((i_24_ & 0xff) << 8) + (i_25_ & 0xff));
                }
                if (aShort10418 - aShort10420 <= class181.anInt2381) {
                    int i_26_ = ((this.anInt8790 >> 16 & 0xff00) + (anInt10417 >> 24 & 0xff) + class181.anInt2416 * i);
                    if (i_26_ < 0) i_26_ = 0;
                    else if (i_26_ > 65535) i_26_ = 65535;
                    this.anInt8790 &= 0xffffff;
                    this.anInt8790 |= (i_26_ & 0xff00) << 16;
                    anInt10417 &= 0xffffff;
            ...
            if (class181.anInt2436 == 1) {
                int i_29_ = i_20_ - this.aClass318_Sub7_10419.aClass284_6444.anInt3673;
                int i_30_ = i_21_ - this.aClass318_Sub7_10419.aClass284_6444.anInt3667;
                int i_31_ = i_22_ - this.aClass318_Sub7_10419.aClass284_6444.anInt3671;
                int i_32_ = ((int) Math.sqrt(i_29_ * i_29_ + i_30_ * i_30_ + i_31_ * i_31_) >> 2);
                long l_33_ = class181.anInt2437 * i_32_ * i;
                anInt10421 -= (long) anInt10421 * l_33_ >> 18;
            } else if (class181.anInt2436 == 2) {
                int i_34_ = i_20_ - this.aClass318_Sub7_10419.aClass284_6444.anInt3673;
                int i_35_ = i_21_ - this.aClass318_Sub7_10419.aClass284_6444.anInt3667;
                int i_36_ = i_22_ - this.aClass318_Sub7_10419.aClass284_6444.anInt3671;
                int i_37_ = i_34_ * i_34_ + i_35_ * i_35_ + i_36_ * i_36_;
                long l_38_ = class181.anInt2437 * i_37_ * i;
            ...
            if (class181.anIntArray2402 != null) {
                ...
                for (Node class348_39_ = Node.next; class348_39_ != Node; class348_39_ = class348_39_.next) {
                    ...
                    if (class174.anInt2296 != 1) {
                        ...
                        for (int i_41_ = 0; (i_41_ < class181.anIntArray2402.length); i_41_++) {
                        ...
                        if (bool_40_) {
                            double d_42_ = i_20_ - (class348_sub42_sub20.anInt9712);
                            double d_43_ = i_21_ - (class348_sub42_sub20.anInt9706);
                            double d_44_ = i_22_ - (class348_sub42_sub20.anInt9710);
                            double d_45_ = (d_42_ * d_42_ + d_43_ * d_43_ + d_44_ * d_44_);
                            if (!(d_45_ > (double) (class174.aLong2301))) {
                                double d_46_ = Math.sqrt(d_45_);
                                if (d_46_ == 0.0) d_46_ = 1.0;
                                double d_47_ = (((d_42_ * (double) (class348_sub42_sub20.anInt9705)) + d_43_ * (double) class174.anInt2290 + (d_44_ * (double) (class348_sub42_sub20.anInt9707))) * 65535.0 / ((double) (class174.anInt2299) * d_46_));
                                if (!(d_47_ < (double) (class174.anInt2298))) {
                                    double d_48_ = 0.0;
                                    if (class174.anInt2289 == 1) d_48_ = (d_46_ / 16.0 * (double) (class174.anInt2304));
                                    else if (class174.anInt2289 == 2) d_48_ = (d_46_ / 16.0 * (d_46_ / 16.0) * (double) (class174.anInt2304));
                                    if (class174.anInt2292 == 0) {
                                        if (class174.anInt2297 == 0) {
                                            d += ((double) (class348_sub42_sub20.anInt9705) - d_48_) * (double) i;
                                            d_27_ += ((double) (class174.anInt2290) - d_48_) * (double) i;
                                            d_28_ += ((double) (class348_sub42_sub20.anInt9707) - d_48_) * (double) i;
                                            bool = true;
                                        } else {
                                            this.anInt8791 += ((double) (class348_sub42_sub20.anInt9705) - d_48_) * (double) i;
                                            this.anInt8796 += ((double) (class174.anInt2290) - d_48_) * (double) i;
                                            this.anInt8789 += ((double) (class348_sub42_sub20.anInt9707) - d_48_) * (double) i;
                                        }
                                    } else {
                                        double d_49_ = (d_42_ / d_46_ * (double) (class174.anInt2299));
                                        double d_50_ = (d_43_ / d_46_ * (double) (class174.anInt2299));
                                        double d_51_ = (d_44_ / d_46_ * (double) (class174.anInt2299));
                                        if (class174.anInt2297 == 0) {
                                            d += d_49_ * (double) i;
                                            ...
                                            this.anInt8791 += d_49_ * (double) i;
                                            this.anInt8796 += d_50_ * (double) i;
                                            this.anInt8789 += d_51_ * (double) i;
                                        }
                                    }
                                }
                            }
            ...
            if (class181.anIntArray2380 != null) {
                for (int i_52_ = 0; i_52_ < class181.anIntArray2380.length; i_52_++) {
                    Class348_Sub42_Sub20 class348_sub42_sub20 = ((Class348_Sub42_Sub20) (Class367_Sub11.aClass32_7415.method334(class181.anIntArray2380[i_52_], (byte) 121)));
                    while (class348_sub42_sub20 != null) {
                        ...
                        if (d_56_ > (double) class174.aLong2301) class348_sub42_sub20 = (Class348_Sub42_Sub20) Class367_Sub11.aClass32_7415.method336(true);
                        else {
                            ...
                            if (d_58_ < (double) class174.anInt2298) class348_sub42_sub20 = ((Class348_Sub42_Sub20) Class367_Sub11.aClass32_7415.method336(true));
                            else {
                                double d_59_ = 0.0;
                                if (class174.anInt2289 == 1) d_59_ = (d_57_ / 16.0 * (double) (class174.anInt2304));
                                else if (class174.anInt2289 == 2) d_59_ = (d_57_ / 16.0 * (d_57_ / 16.0) * (double) (class174.anInt2304));
                                if (class174.anInt2292 == 0) {
                                    if (class174.anInt2297 == 0) {
                                        d += ((double) (class348_sub42_sub20.anInt9705) - d_59_) * (double) i;
                                        d_27_ += ((double) (class174.anInt2290) - d_59_) * (double) i;
                                        d_28_ += ((double) (class348_sub42_sub20.anInt9707) - d_59_) * (double) i;
                                        bool = true;
                                    } else {
                                        this.anInt8791 += ((double) (class348_sub42_sub20.anInt9705) - d_59_) * (double) i;
                                        this.anInt8796 += ((double) (class174.anInt2290) - d_59_) * (double) i;
                                        this.anInt8789 += ((double) (class348_sub42_sub20.anInt9707) - d_59_) * (double) i;
                                    }
                                } else {
                                    double d_60_ = (d_53_ / d_57_ * (double) (class174.anInt2299));
                                    double d_61_ = (d_54_ / d_57_ * (double) (class174.anInt2299));
                                    double d_62_ = (d_55_ / d_57_ * (double) (class174.anInt2299));
                                    if (class174.anInt2297 == 0) {
                                        d += d_60_ * (double) i;
                                        ...
                                        this.anInt8791 += d_60_ * (double) i;
                                        this.anInt8796 += d_61_ * (double) i;
                                        this.anInt8789 += d_62_ * (double) i;
                                    }
                                }
                                class348_sub42_sub20 = ((Class348_Sub42_Sub20) Class367_Sub11.aClass32_7415.method336(true));
                            }
                        }
                    }
                }
            ...
            if (class181.anIntArray2395 != null) {
                ...
                for (int i_64_ = 0; i_64_ < class181.anIntArray2385.length; i_64_++) {
                    Class174 class174 = (Class19.aClass174Array311[class181.anIntArray2385[i_64_]]);
                    if (class174.anInt2297 == 0) {
                        d += class174.anInt2291 * i;
                        d_27_ += class174.anInt2290 * i;
                        d_28_ += class174.anInt2294 * i;
                        bool = true;
                    } else {
            ...
            this.anInt8791 += (((long) aShort10424 * (long) (anInt10421 << 2) >> 23) * (long) i);
            this.anInt8796 += (((long) aShort10423 * (long) (anInt10421 << 2) >> 23) * (long) i);
            this.anInt8789 += (((long) aShort10422 * (long) (anInt10421 << 2) >> 23) * (long) i);
        }
    }

    Class318_Sub9_Sub2_Sub1(Class318_Sub7 class318_sub7, int i, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_, boolean bool, boolean bool_75_) {
        this.aClass318_Sub7_10419 = class318_sub7;
        this.anInt8791 = i << 12;
