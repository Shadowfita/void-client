        ...
        if (i < -125) {
            for (int i_1_ = 0; i_0_ > i_1_; i_1_++) {
                if (StringNode.aByteArrayArray7212[i_1_] != null) {
                    ...
                    Packet Packet = new Packet(StringNode.aByteArrayArray7212[i_1_]);
                    int i_4_ = 0;
                    while (Packet.pos < StringNode.aByteArrayArray7212[i_1_].length) {
                        ...
                        NPCType NPCType = (Class189.aClass278_2529.method2079(Packet.readUnsignedShort(842397944), -1));
                        Class348_Sub22 class348_sub22 = ((Class348_Sub22) Class282.aClass356_3654.method3480(i_5_, -6008));
                        if (class348_sub22 == null && (NPCType.movementCapabilities & 0x1) > 0 && i_7_ == Class167.anInt2204 && i_10_ >= 0 && (Class367_Sub4.anInt7319 > i_10_ - -NPCType.anInt1399) && i_11_ >= 0 && (Class348_Sub40_Sub3.anInt9109 > i_11_ + NPCType.anInt1399)) {
                            Npc npc = new Npc();
                            npc.anInt10290 = i_5_;
                            ...
                            npc.method2448(NPCType, -2);
                            npc.method2434((byte) 120, npc.definition.anInt1399);
                            npc.anInt10310 = (npc.definition.yawSpeed << 3);
                            npc.method2435((byte) -108, (npc.definition.spawnDirection - -4 & ~0x631ffff8) << 11, true);
