...
final class Class30 {
    ...
    static final void method323(Js5Archive Js5Archive, Class297 class297, byte i) {
        try {
            Class348_Sub41.aString7048 = "";
            Class59_Sub1.aClass297_5297 = class297;
            anInt410++;
            Class167.aClass45_2208 = Js5Archive;
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("hw.A(" + (Js5Archive != null ? "{...}" : "null") + ',' + (class297 != null ? "{...}" : "null") + ',' + i + ')'));
        }
    }

    Class30(int i, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
        anInt408 = i_20_;
        anInt417 = i_19_;
